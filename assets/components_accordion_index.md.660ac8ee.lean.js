var S=Object.defineProperty;var I=Object.getOwnPropertySymbols;var P=Object.prototype.hasOwnProperty,$=Object.prototype.propertyIsEnumerable;var V=(s,e,a)=>e in s?S(s,e,{enumerable:!0,configurable:!0,writable:!0,value:a}):s[e]=a,T=(s,e)=>{for(var a in e||(e={}))P.call(e,a)&&V(s,a,e[a]);if(I)for(var a of I(e))$.call(e,a)&&V(s,a,e[a]);return s};import{_ as H,V as v,r as _,o as j,c as J,a as B,w as b,b as M,d as n,e as t}from"./app.d86bec19.js";const U={name:"component-doc",components:{"render-demo-0":function(){const{createElementVNode:s,resolveComponent:e,withCtx:a,createVNode:r,createCommentVNode:l,createTextVNode:i,openBlock:F,createElementBlock:u}=v,h={class:"basic-menu"},E=s("li",{class:"devui-accordion-item"},[s("div",{class:"devui-accordion-item-title devui-over-flow-ellipsis",style:{"{{ textIndent":"deepth * 20 + 'px' }}"}},"\u81EA\u5B9A\u4E49\u52A0\u8F7D...")],-1),f={class:"basic-option"},c=i(" Only one level-1 menu can be expanded. "),C={class:"basic-option"},m=i(" Embedded menu (no shadow) ");function k(o,D){const d=e("d-accordion"),O=e("d-switch");return F(),u("div",null,[s("div",h,[r(d,{data:o.menu,accordionType:o.accordionTypeEmbed?"embed":"normal",restrictOneOpen:o.restrictOneOpen,onItemClick:o.itemClick,onMenuToggle:o.menuToggle,loadingTemplate:!1},{loadingTemplate:a(({item:w,deepth:p})=>[E]),_:1},8,["data","accordionType","restrictOneOpen","onItemClick","onMenuToggle"])]),s("div",f,[r(O,{modelValue:o.restrictOneOpen,"onUpdate:modelValue":D[0]||(D[0]=w=>o.restrictOneOpen=w)},null,8,["modelValue"]),c,l("\u9650\u5236\u53EA\u80FD\u5C55\u5F00\u4E00\u4E2A\u4E00\u7EA7\u83DC\u5355")]),s("div",C,[r(O,{modelValue:o.accordionTypeEmbed,"onUpdate:modelValue":D[1]||(D[1]=w=>o.accordionTypeEmbed=w)},null,8,["modelValue"]),m,l("\u5185\u5D4C\u83DC\u5355\u5F62\u5F0F\uFF08\u65E0\u9634\u5F71\uFF09")])])}const{defineComponent:g,ref:y}=v,x=g({name:"accordion",setup(){const o=y(!1),D=y(!1);return{menu:y([{title:"Content 1",children:[{title:"Child Content 1"},{title:"Child Content 2"},{title:"Child Content "}]},{title:"Content 2\uFF08This is a long sentence for option display.\uFF09",children:[{title:"Child Content 1 (This is a long sentence for option display.)"},{title:"Child Content 2"},{title:"Child Content 3"}]},{title:"Content 3 (Default Open)",open:!0,children:[{title:"Child Content 1 (Disabled)",disabled:!0},{title:"Child Content 2 (Default Active)",active:!0},{title:"Child Content 3"}]},{title:"Content 4 (No Child)",children:[]},{title:"Content 5 (Disabled)",disabled:!0,children:[]},{title:"Content 6 (Dynamic Content)",needLoadChildren:!0,loading:!1,children:[]}]),restrictOneOpen:o,accordionTypeEmbed:D,itemClick:p=>{console.log("item click"+JSON.stringify(p))},menuToggle:p=>{console.log("menu toggle"+JSON.stringify(p)),p.open&&p.item.needLoadChildren&&(p.item.loading=!0,setTimeout(()=>{p.item.children=[{title:"Child Content 1"},{title:"Child Content 2"}],p.item.needLoadChildren=!1,p.item.loading=!1},2e3))}}}});return T({render:k},x)}(),"render-demo-1":function(){const{createCommentVNode:s,createTextVNode:e,createElementVNode:a,resolveComponent:r,createVNode:l,openBlock:i,createElementBlock:F}=v,u={class:"menu-container"},h={class:"menu-wrapper"},E=a("div",null,[e(" router link (recommended) "),s("\u8DEF\u7531\u94FE\u63A5\uFF08\u63A8\u8350\u4F7F\u7528\uFF09")],-1),f={class:"menu-wrapper"},c=a("div",null,[e(" original hyperlink (cross site scene) "),s("\u539F\u751F\u8D85\u94FE\u63A5\uFF08\u6D89\u53CA\u8DE8\u7AD9\u573A\u666F\u4F7F\u7528\uFF09")],-1),C={class:"menu-wrapper"},m=a("div",null,[e(" mix link (partial cross site scene) "),s("\u6DF7\u5408\u94FE\u63A5\uFF08\u90E8\u5206\u6D89\u53CA\u8DE8\u7AD9\u573A\u666F\u4F7F\u7528\uFF09")],-1);function k(o,D){const d=r("d-accordion");return i(),F("div",null,[a("div",u,[a("div",h,[E,l(d,{data:o.menu1,class:"menu",linkType:"routerLink"},null,8,["data"])]),a("div",f,[c,l(d,{data:o.menu2,class:"menu",linkType:"hrefLink"},null,8,["data"])]),a("div",C,[m,l(d,{data:o.menu3,class:"menu",linkType:"dependOnLinkTypeKey"},null,8,["data"])])])])}const{defineComponent:g,ref:y}=v,x=g({name:"accordion",setup(){const o=y([{title:"Basic",children:[{title:"Accordion",link:"/components/accordion/"},{title:"Anchor",link:"/components/anchor/"},{title:"Button",link:"/components/button/"}]},{title:"Advanced",children:[{title:"Data Table (disabled)",disabled:!0,link:"/components/datatable/"},{title:"Drag Drop (parameter example)",link:"/components/dragdrop/?query=foo#bar"}]},{title:"Others",children:[{title:"Icon Library",link:"/components/icon/"},{title:"Home Page",disabled:!0,link:"/"}]}]),D=y([{title:"Basic",children:[{title:"Alert",link:"/components/alert/",target:"_self"},{title:"Anchor",link:"/components/anchor/",target:"_self"},{title:"Accordion",link:"/components/accordion/",target:"_self"}]},{title:"Advanced",children:[{title:"Data Table (disabled)",disabled:!0,link:"/components/datatable/",target:"_self"},{title:"Drag Drop",link:"/components/dragdrop/",target:"_self"}]},{title:"Others",children:[{title:"Icon Library",link:"/components/icon/",target:"_self"},{title:"Home Page(open blank page)",link:"/",target:"_blank"}]}]),d=y([{title:"Basic",children:[{title:"Alert",link:"/components/alert/",linkType:"routerLink"},{title:"Anchor",link:"/components/anchor/",linkType:"routerLink"},{title:"Button",link:"/components/button/",linkType:"routerLink"}]},{title:"Advanced",children:[{title:"Data Table (disabled)",disabled:!0,link:"/components/datatable/",linkType:"routerLink"},{title:"Drag Drop",link:"/components/dragdrop/",linkType:"routerLink"}]},{title:"Others",children:[{title:"Icon Library",link:"/components/icon/",linkType:"routerLink"},{title:"Home Page(External link open in this window)",link:"/",linkType:"hrefLink"}]}]);return{menu1:o,menu2:D,menu3:d}}});return T({render:k},x)}(),"render-demo-2":function(){const{toDisplayString:s,openBlock:e,createElementBlock:a,createCommentVNode:r,createTextVNode:l,createElementVNode:i,resolveComponent:F,withCtx:u,createVNode:h}=v,E={class:"use-template-menu"},f={key:0,class:"use-template-badge"},c=["onClick"],C=l(" reset "),m={class:"use-template-info"},k=i("li",{class:"devui-accordion-item disabled"},[i("div",{class:"devui-accordion-item-title devui-over-flow-ellipsis disabled",style:{"{{ textIndent":"deepth * 20 + 'px' }}"}},[l(" Not available yet. Please wait. "),r("\u5C1A\u672A\u5F00\u653E\uFF0C\u656C\u8BF7\u671F\u5F85...")])],-1),g=i("li",{class:"devui-accordion-item"},[i("div",{class:"use-template-loading"},[i("span",{class:"use-template-circle-spinner"}),l(" loading... "),r("\u6B63\u5728\u7528\u529B\u5730\u52A0\u8F7D\u4E2D...")])],-1);function y(d,O){const w=F("d-accordion");return e(),a("div",null,[i("div",E,[h(w,{data:d.menu,accordionType:d.accordionTypeEmbed?"embed":"normal",restrictOneOpen:d.restrictOneOpen,onItemClick:d.itemClick,onMenuToggle:d.menuToggle},{menuItemTemplate:u(({item:p,deepth:q,parent:N})=>{var K;return[l(s(p.title)+" ",1),((K=p.children)==null?void 0:K.length)?(e(),a("span",f,s(p.children.length),1)):r("v-if",!0),p.needLoadChildren===!1?(e(),a("span",{key:1,class:"operation-clear",onClick:A=>d.clearChildrenData(A,p)},[C,r("\u91CD\u7F6E")],8,c)):r("v-if",!0)]}),itemTemplate:u(({item:p,deepth:q,parent:N})=>[l(s(p.title)+" ",1),i("span",m,"(Click Count: "+s(p.clicktimes||"0")+")",1)]),noContentTemplate:u(({deepth:p})=>[k]),loadingTemplate:u(({item:p})=>[g]),_:1},8,["data","accordionType","restrictOneOpen","onItemClick","onMenuToggle"])])])}const{defineComponent:x,ref:o}=v,D=x({name:"accordion",setup(){const d=o(!1),O=o(!1),w=o([{title:"Content 1",open:!0,children:[{title:"Child Content 1"},{title:"Child Content 2"}]},{title:"Content 2",children:[{title:"Child Content 1"},{title:"Child Content 2"},{title:"Child Content 3"},{title:"Child Content 4"}]},{title:"Content 3",children:[{title:"Child Content 1 (disabled)",disabled:!0},{title:"Child Content 2"},{title:"Child Content 3"}]},{title:"Content 4 (Custom No Data Template)",children:[]},{title:"Content 5 (Custom loading Template)",needLoadChildren:!0,loading:!1,children:[]}]),p=o([{title:"Child Content 1"},{title:"Child Content 2"},{title:"Child Content 3"},{title:"Child Content 4"},{title:"Child Content 5"},{title:"Child Content 6"},{title:"Child Content 7"}]);return{menu:w,restrictOneOpen:d,accordionTypeEmbed:O,itemClick:A=>{A.item.clicktimes=(A.item.clicktimes||0)+1},menuToggle:A=>{A.open&&A.item.needLoadChildren&&(A.item.loading=!0,setTimeout(()=>{A.item.children=p.value,A.item.needLoadChildren=!1,A.item.loading=!1},1e3))},clearChildrenData:(A,L)=>{A.stopPropagation(),L.children=[],L.needLoadChildren=!0,L.open=!1}}}});return T({render:y},D)}(),"render-demo-3":function(){const{toDisplayString:s,createElementVNode:e,resolveComponent:a,withCtx:r,createVNode:l,openBlock:i,createElementBlock:F}=v,u={class:"inner-template-menu"},h={class:"devui-accordion-submenu devui-accordion-show-animate inner-template-my-menu"};function E(m,k){const g=a("d-accordion");return i(),F("div",null,[e("div",u,[l(g,{data:m.menu,accordionType:m.accordionTypeEmbed?"embed":"normal",restrictOneOpen:m.restrictOneOpen},{innerListTemplate:r(({item:y,deepth:x})=>[e("div",h,s(y.content),1)]),_:1},8,["data","accordionType","restrictOneOpen"])])])}const{defineComponent:f,ref:c}=v,C=f({name:"accordion",setup(){const m=c(!1),k=c(!1);return{menu:c([{title:"Content 1",children:[],content:"Child Content of Content 1"},{title:"Content 2",children:[],content:"Child Content of Content 2"}]),restrictOneOpen:m,accordionTypeEmbed:k}}});return T({render:E},C)}(),"render-demo-4":function(){const{resolveComponent:s,createVNode:e,createElementVNode:a,createCommentVNode:r,createTextVNode:l,openBlock:i,createElementBlock:F}=v,u={class:"multi-child-menu"},h={class:"multi-child-option"},E=l(" auto expend active menu ");function f(k,g){const y=s("d-accordion"),x=s("d-switch");return i(),F("div",null,[a("div",u,[e(y,{data:k.menu,autoOpenActiveMenu:k.autoOpenActiveMenu},null,8,["data","autoOpenActiveMenu"])]),a("div",h,[e(x,{modelValue:k.autoOpenActiveMenu,"onUpdate:modelValue":g[0]||(g[0]=o=>k.autoOpenActiveMenu=o)},null,8,["modelValue"]),E,r("\u81EA\u52A8\u5C55\u5F00\u6FC0\u6D3B\u7684\u83DC\u5355")])])}const{defineComponent:c,ref:C}=v,m=c({name:"accordion",setup(){const k=C(!1);return{menu:C([{title:"Content 1 (as a leaf menu)"},{title:"Content 2 (as a parent menu, has children)",children:[{title:"Child Content 1"},{title:"Child Content 2"},{title:"Child Content 3"}]},{title:"Content 3 (as a parent menu, has children)",children:[{title:"Child Content 1 (has children)",children:[{title:"Child Content 1"},{title:"Child Content 2",active:!0},{title:"Child Content 3"}]},{title:"Child Content 2 (has children",children:[{title:"Child Content 1"},{title:"Child Content 2 (has children",children:[{title:"Child Content 1"},{title:"Child Content 2"},{title:"Child Content 3"}]},{title:"Child Content 3"}]},{title:"Child Content 2"},{title:"Child Content 3"}]},{title:"Content 4 (as a parent menu, has no child)",children:[]}]),autoOpenActiveMenu:k}}});return T({render:f},m)}(),"render-demo-5":function(){const{resolveComponent:s,createVNode:e,createElementVNode:a,openBlock:r,createElementBlock:l}=v,i={class:"change-key-menu"};function F(c,C){var k,g,y,x,o;const m=s("d-accordion");return r(),l("div",null,[a("div",i,[e(m,{data:c.menu,titleKey:(k=c.key)==null?void 0:k.titleKey,activeKey:(g=c.key)==null?void 0:g.activeKey,disabledKey:(y=c.key)==null?void 0:y.disabledKey,openKey:(x=c.key)==null?void 0:x.openKey,childrenKey:(o=c.key)==null?void 0:o.childrenKey},null,8,["data","titleKey","activeKey","disabledKey","openKey","childrenKey"])])])}const{defineComponent:u,reactive:h,ref:E}=v,f=u({name:"accordion",setup(){const c=h({titleKey:"value",activeKey:"$selected",disabledKey:"forbidden",openKey:"$show",childrenKey:"subs"});return{menu:E([{value:"Content 1"},{value:"Content 2 (expended)",$show:!0,subs:[{value:"Child Content 1 (disabled)",forbidden:!0},{value:"Child Content 2 (active)",$selected:!0},{value:"Child Content 3"}]}]),key:c}}});return T({render:F},f)}()}},dn='{"title":"Accordion \u624B\u98CE\u7434","description":"","frontmatter":{},"headers":[{"level":3,"title":"\u57FA\u672C\u7528\u6CD5","slug":"\u57FA\u672C\u7528\u6CD5"},{"level":3,"title":"\u4F7F\u7528\u5185\u7F6E\u8DEF\u7531\u548C\u94FE\u63A5\u7C7B\u578B","slug":"\u4F7F\u7528\u5185\u7F6E\u8DEF\u7531\u548C\u94FE\u63A5\u7C7B\u578B"},{"level":3,"title":"\u4F7F\u7528\u6A21\u677F","slug":"\u4F7F\u7528\u6A21\u677F"},{"level":3,"title":"\u590D\u5408\u5C42\u7EA7\u548C\u81EA\u52A8\u5C55\u5F00","slug":"\u590D\u5408\u5C42\u7EA7\u548C\u81EA\u52A8\u5C55\u5F00"},{"level":3,"title":"\u6539\u53D8\u952E\u503C","slug":"\u6539\u53D8\u952E\u503C"},{"level":3,"title":"Accordion \u53C2\u6570","slug":"accordion-\u53C2\u6570"},{"level":3,"title":"Accordion \u4E8B\u4EF6","slug":"accordion-\u4E8B\u4EF6"},{"level":3,"title":"Accordion \u7C7B\u578B\u5B9A\u4E49","slug":"accordion-\u7C7B\u578B\u5B9A\u4E49"},{"level":3,"title":"AccordionProps","slug":"accordionprops"},{"level":3,"title":"\u6A21\u677F\u53EF\u4EE5\u7528\u53D8\u91CF\u503C(\u4F7F\u7528\u65B9\u6CD5\u5982\u4E0B)","slug":"\u6A21\u677F\u53EF\u4EE5\u7528\u53D8\u91CF\u503C-\u4F7F\u7528\u65B9\u6CD5\u5982\u4E0B"},{"level":3,"title":"menuItemTemplate \u53EF\u7528\u53D8\u91CF\u503C","slug":"menuitemtemplate-\u53EF\u7528\u53D8\u91CF\u503C"},{"level":3,"title":"itemTemplate \u53EF\u7528\u53D8\u91CF\u503C","slug":"itemtemplate-\u53EF\u7528\u53D8\u91CF\u503C"},{"level":3,"title":"noContentTemplate \u53EF\u7528\u53D8\u91CF\u503C","slug":"nocontenttemplate-\u53EF\u7528\u53D8\u91CF\u503C"},{"level":3,"title":"loadingTemplate \u53EF\u7528\u53D8\u91CF\u503C","slug":"loadingtemplate-\u53EF\u7528\u53D8\u91CF\u503C"},{"level":3,"title":"innerListTemplate \u53EF\u7528\u53D8\u91CF\u503C","slug":"innerlisttemplate-\u53EF\u7528\u53D8\u91CF\u503C"}],"relativePath":"components/accordion/index.md","lastUpdated":1667463434879}',Y=M('<h1 id="accordion-\u624B\u98CE\u7434" tabindex="-1">Accordion \u624B\u98CE\u7434 <a class="header-anchor" href="#accordion-\u624B\u98CE\u7434" aria-hidden="true">#</a></h1><p>\u4E3A\u9875\u9762\u63D0\u4F9B\u5BFC\u822A\u7684\u7EC4\u4EF6\u3002</p><h4 id="\u4F55\u65F6\u4F7F\u7528" tabindex="-1">\u4F55\u65F6\u4F7F\u7528 <a class="header-anchor" href="#\u4F55\u65F6\u4F7F\u7528" aria-hidden="true">#</a></h4><p>\u9700\u8981\u901A\u8FC7\u5206\u7EC4\u7EC4\u7EC7\u83DC\u5355\u7684\u65F6\u5019\u4F7F\u7528\u3002</p><h3 id="\u57FA\u672C\u7528\u6CD5" tabindex="-1">\u57FA\u672C\u7528\u6CD5 <a class="header-anchor" href="#\u57FA\u672C\u7528\u6CD5" aria-hidden="true">#</a></h3><p>\u4F20\u5165\u83DC\u5355\uFF0C\u76D1\u542C\u542B\u5B50\u9879\u7684\u53EF\u5C55\u5F00\u83DC\u5355\u7684\u5F00\u5408\u4E8B\u4EF6(menuToggle)\u6216\u53EF\u70B9\u51FB\u83DC\u5355\u7684\u70B9\u51FB\u4E8B\u4EF6(itemClick)\u3002\u53EF\u5C55\u5F00\u83DC\u5355\u9ED8\u8BA4\u5C55\u5F00\u4F7F\u7528\u5C5E\u6027 open\uFF0C\u53EF\u70B9\u51FB\u83DC\u5355\u9ED8\u8BA4\u6FC0\u6D3B\u4F7F\u7528\u5C5E\u6027 active\uFF0C\u7981\u7528\u9879\u4F7F\u7528 disabled\u3002\u901A\u8FC7 restrictOneOpen \u8BBE\u7F6E\u662F\u5426\u9650\u5236\u53EA\u80FD\u5C55\u5F00\u4E00\u4E2A\u4E00\u7EA7\u83DC\u5355\u3002</p>',6),z=n("div",{class:"language-vue"},[n("pre",null,[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),t("template")]),n("span",{class:"token punctuation"},">")]),t(`
...
`)])])],-1),R=n("h3",{id:"\u4F7F\u7528\u5185\u7F6E\u8DEF\u7531\u548C\u94FE\u63A5\u7C7B\u578B",tabindex:"-1"},[t("\u4F7F\u7528\u5185\u7F6E\u8DEF\u7531\u548C\u94FE\u63A5\u7C7B\u578B "),n("a",{class:"header-anchor",href:"#\u4F7F\u7528\u5185\u7F6E\u8DEF\u7531\u548C\u94FE\u63A5\u7C7B\u578B","aria-hidden":"true"},"#")],-1),G=n("p",null,"\u901A\u8FC7\u8BBE\u7F6E linkType \u5207\u6362\u4E0D\u540C\u7684\u5185\u7F6E\u8DEF\u7531\u548C\u94FE\u63A5\u7C7B\u578B\uFF1A\u9ED8\u8BA4\u7C7B\u578B''\uFF1B\u8DEF\u7531\u7C7B\u578B'routerLink'\uFF1B\u5916\u94FE\u7C7B\u578B\uFF1A'hrefLink'\uFF1B\u57FA\u4E8E\u6570\u636E\u5224\u65AD\u8DEF\u7531\u6216\u94FE\u63A5\u7C7B\u578B\uFF1A'dependOnLinkTypeKey'\u3002",-1),Q=n("div",{class:"language-vue"},[n("pre",null,[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),t("template")]),n("span",{class:"token punctuation"},">")]),t(`
  `),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),t("div")]),t(),n("span",{class:"token attr-name"},"class"),n("span",{class:"token attr-value"},[n("span",{class:"token punctuation attr-equals"},"="),n("span",{class:"token punctuation"},'"'),t("menu-container"),n("span",{class:"token punctuation"},'"')]),n("span",{class:"token punctuation"},">")]),t(`
...
`),n("span",{class:"token selector"},".menu"),t(),n("span",{class:"token punctuation"},"{"),t(`
  `),n("span",{class:"token property"},"width"),n("span",{class:"token punctuation"},":"),t(" 200px"),n("span",{class:"token punctuation"},";"),t(`
`),n("span",{class:"token punctuation"},"}"),t(`
`),n("span",{class:"token selector"},".menu-container"),t(),n("span",{class:"token punctuation"},"{"),t(`
  `),n("span",{class:"token property"},"overflow"),n("span",{class:"token punctuation"},":"),t(" auto"),n("span",{class:"token punctuation"},";"),t(`
  `),n("span",{class:"token property"},"padding-left"),n("span",{class:"token punctuation"},":"),t(" 2px"),n("span",{class:"token punctuation"},";"),t(`
`),n("span",{class:"token punctuation"},"}"),t(`
...
`},{highlight:b(()=>[z]),default:b(()=>[B(F)]),_:1}),R,G,B(u,{sourceCode:`<template>
...
`},{highlight:b(()=>[Q]),default:b(()=>[B(h)]),_:1}),W,X,B(u,{sourceCode:`<template>
...
`},{highlight:b(()=>[Z]),default:b(()=>[B(E)]),_:1}),nn,B(u,{sourceCode:`<template>
...
`},{highlight:b(()=>[tn]),default:b(()=>[B(f)]),_:1}),an,sn,B(u,{sourceCode:`<template>
...
`},{highlight:b(()=>[en]),default:b(()=>[B(c)]),_:1}),on,pn,B(u,{sourceCode:`<template>
...
`},{highlight:b(()=>[cn]),default:b(()=>[B(C)]),_:1}),un])}var yn=H(U,[["render",ln]]);export{dn as __pageData,yn as default};
