...
</code></pre></div>`,9);function Z(o,s,a,i,F,f){const r=E("render-demo-0"),u=E("demo"),k=E("render-demo-1"),d=E("render-demo-2"),e=E("render-demo-3"),c=E("render-demo-4"),p=E("render-demo-5");return N(),V("div",null,[T,C(u,{sourceCode:`<template>
