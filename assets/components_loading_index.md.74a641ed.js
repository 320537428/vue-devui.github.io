var I=Object.defineProperty;var P=Object.getOwnPropertySymbols;var z=Object.prototype.hasOwnProperty,j=Object.prototype.propertyIsEnumerable;var M=(a,o,s)=>o in a?I(a,o,{enumerable:!0,configurable:!0,writable:!0,value:s}):a[o]=s,S=(a,o)=>{for(var s in o||(o={}))z.call(o,s)&&M(a,s,o[s]);if(P)for(var s of P(o))j.call(o,s)&&M(a,s,o[s]);return a};import{_ as O,V as b,r as T,c as Y,a as F,w,b as $,d as n,e as t,o as R}from"./app.86255cab.js";const U={name:"component-doc",components:{"render-demo-0":function(){const{createTextVNode:a,resolveComponent:o,withCtx:s,createVNode:y,createElementVNode:e,renderList:l,Fragment:d,openBlock:p,createElementBlock:i,toDisplayString:f,resolveDirective:v,withDirectives:x}=b,_=a("click me!"),E={backdrop:!0,"position-type":"relative",view:{top:"50%",left:"50%"},"z-index":100,style:{width:"100%","text-align":"left"}},A=e("thead",null,[e("tr",null,[e("th",null,"\u5E8F\u53F7"),e("th",null,"\u59D3\u540D"),e("th",null,"\u961F\u4F0D"),e("th",null,"\u64CD\u4F5C")])],-1),r=e("td",null,"\u5F20\u5BB6\u9F50",-1),g=e("td",null,"\u8DF3\u6C34",-1),m=e("td",null,"\u8DF3\u6C34\u961F",-1);function k(u,D){const L=o("d-button"),q=v("d-loading");return p(),i("div",null,[y(L,{onClick:u.fetchTableData,style:{"margin-top":"8px"}},{default:s(()=>[_]),_:1},8,["onClick"]),x((p(),i("table",E,[A,e("tbody",null,[(p(!0),i(d,null,l(u.datas,(N,V)=>(p(),i("tr",{key:V},[e("td",null,f(V),1),r,g,m]))),128))])])),[[q,u.loadingStatus]])])}const{defineComponent:h,ref:c,reactive:B}=b,C=h({setup(){const u=c(!1),D=B([]);return{datas:D,loadingStatus:u,fetchTableData:()=>{u.value=!0,setTimeout(()=>{D.push(1,2,3),u.value=!1},2e3)}}}});return S({render:k},C)}(),"render-demo-1":function(){const{createTextVNode:a,resolveComponent:o,withCtx:s,createVNode:y,resolveDirective:e,openBlock:l,createElementBlock:d,withDirectives:p}=b,i=a("click me!"),f={message:"One moment please...",style:{"margin-top":"20px",width:"100%",height:"80px",padding:"10px"}},x=[a(" loading will show here2 ")];function _(g,m){const k=o("d-button"),h=e("d-loading");return l(),d("div",null,[y(k,{onClick:g.fetchMutiplePromise,style:{"margin-top":"8px"}},{default:s(()=>[i]),_:1},8,["onClick"]),p((l(),d("div",f,x)),[[h,g.promises]])])}const{defineComponent:E,ref:A}=b,r=E({setup(){const g=A([]);return{promises:g,fetchMutiplePromise:()=>{let k=[];for(let h=0;h<3;h++)k.push(new Promise((c,B)=>{setTimeout(()=>{c(h)},(h+1)*1e3)}).then(c=>c));g.value=k}}}});return S({render:_},r)}(),"render-demo-2":function(){const{createTextVNode:a,resolveComponent:o,withCtx:s,createVNode:y,resolveDirective:e,openBlock:l,createBlock:d,withDirectives:p,createElementBlock:i}=b,f=a(" Loading Style 1 "),v=a(" Loading Style 2 "),x=a(" Loading Style 3 "),_=["loading-template-ref"],A=[a(" loading will show here1 ")];function r(c,B){const C=o("d-button"),u=e("d-loading");return l(),i("div",null,[y(C,{onClick:c.showLoading1,style:{"margin-right":"8px",display:"inline-block",width:"220px"}},{default:s(()=>[f]),_:1},8,["onClick"]),p((l(),d(C,{onClick:c.showLoading2,"loading-template-ref":c.temp2,style:{"margin-right":"8px",display:"inline-block",width:"220px"}},{default:s(()=>[v]),_:1},8,["onClick","loading-template-ref"])),[[u,c.isShowLoading2]]),p((l(),d(C,{variant:"text","loading-template-ref":c.temp3,style:{"margin-right":"8px",display:"inline-block",width:"220px"}},{default:s(()=>[x]),_:1},8,["loading-template-ref"])),[[u,!0]]),p((l(),i("div",{style:{height:"80px","line-height":"80px"},"loading-template-ref":c.temp1},A,8,_)),[[u,c.isShowLoading1]])])}const{defineComponent:g,ref:m,h:k}=b,h=g({setup(){const c=k("div",{className:"devui-infinity-loading"},k("i",{className:"icon-refresh"})),B=k("div",{className:"devui-circle-loading-container-2"},k("i",{className:"icon-refresh"})),C=k("div",{className:"devui-circle-loading-container-3"},k("i",{className:"icon-refresh"})),u=m(!1),D=()=>{u.value=new Promise(N=>{setTimeout(()=>{N(!0)},1e3)})},L=m(!1);return{temp1:c,temp2:B,temp3:C,isShowLoading1:u,isShowLoading2:L,showLoading1:D,showLoading2:()=>{L.value=new Promise(N=>{setTimeout(()=>{N(!0)},1e3)})}}}});return S({render:r},h)}(),"render-demo-3":function(){const{createTextVNode:a,resolveComponent:o,withCtx:s,createVNode:y,openBlock:e,createBlock:l,createCommentVNode:d,createElementVNode:p,createElementBlock:i}=b,f=a(" click me show full screen loading! "),v=a(" click me show loading in target! "),x=a(" click me close loading in target! "),_=p("div",{id:"me",style:{"margin-top":"20px",width:"100%",height:"60px",padding:"10px"}}," loading will show here3 ",-1);function E(r,g){const m=o("d-button");return e(),i("div",null,[y(m,{onClick:r.serviceToBody,style:{"margin-right":"8px",display:"inline-block",width:"220px"}},{default:s(()=>[f]),_:1},8,["onClick"]),r.isShow?(e(),l(m,{key:0,onClick:r.openTargetLoading,style:{"margin-right":"8px",display:"inline-block",width:"200px"}},{default:s(()=>[v]),_:1},8,["onClick"])):(e(),l(m,{key:1,onClick:r.closeTargetLoading,style:{"margin-right":"8px",display:"inline-block",width:"200px"}},{default:s(()=>[x]),_:1},8,["onClick"])),_])}return S({render:E},{data(){return{isShow:!0,resultTarget:null}},methods:{serviceToBody(){const r=this.$loadingService.open();setTimeout(()=>{r.loadingInstance.close()},2e3)},openTargetLoading(){this.resultTarget=this.$loadingService.open({target:document.querySelector("#me"),message:"One moment please...",positionType:"relative",zIndex:1}),this.isShow=!1},closeTargetLoading(){this.resultTarget.loadingInstance.close(),this.isShow=!0}}})}()}},cn='{"title":"Loading \u52A0\u8F7D\u63D0\u793A","description":"","frontmatter":{},"headers":[{"level":3,"title":"\u57FA\u672C\u7528\u6CD5","slug":"\u57FA\u672C\u7528\u6CD5"},{"level":3,"title":"\u591A promise","slug":"\u591A-promise"},{"level":3,"title":"\u81EA\u5B9A\u4E49\u6837\u5F0F","slug":"\u81EA\u5B9A\u4E49\u6837\u5F0F"},{"level":3,"title":"\u670D\u52A1\u65B9\u5F0F\u8C03\u7528","slug":"\u670D\u52A1\u65B9\u5F0F\u8C03\u7528"},{"level":3,"title":"Loading \u53C2\u6570","slug":"loading-\u53C2\u6570"}],"relativePath":"components/loading/index.md","lastUpdated":1650456022699}',G=$('<h1 id="loading-\u52A0\u8F7D\u63D0\u793A" tabindex="-1">Loading \u52A0\u8F7D\u63D0\u793A <a class="header-anchor" href="#loading-\u52A0\u8F7D\u63D0\u793A" aria-hidden="true">#</a></h1><p>\u63D0\u793A\u7528\u6237\u9875\u9762\u6B63\u5728\u6267\u884C\u6307\u4EE4\uFF0C\u9700\u8981\u7B49\u5F85\u3002</p><h4 id="\u4F55\u65F6\u4F7F\u7528" tabindex="-1">\u4F55\u65F6\u4F7F\u7528 <a class="header-anchor" href="#\u4F55\u65F6\u4F7F\u7528" aria-hidden="true">#</a></h4><p>\u5F53\u6267\u884C\u6307\u4EE4\u65F6\u95F4\u8F83\u957F\uFF08\u9700\u8981\u6570\u79D2\u4EE5\u4E0A\uFF09\u65F6\uFF0C\u5411\u7528\u6237\u5C55\u793A\u6B63\u5728\u6267\u884C\u7684\u72B6\u6001\u3002</p><h3 id="\u57FA\u672C\u7528\u6CD5" tabindex="-1">\u57FA\u672C\u7528\u6CD5 <a class="header-anchor" href="#\u57FA\u672C\u7528\u6CD5" aria-hidden="true">#</a></h3><p>\u5C55\u793A\u52A0\u8F7D\u8868\u683C\u6570\u636E\u7684\u573A\u666F\u4E2D\u7684\u57FA\u672C\u4F7F\u7528\u65B9\u6CD5\u3002</p>',6),H=n("div",{class:"language-vue"},[n("pre",null,[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),t("template")]),n("span",{class:"token punctuation"},">")]),t(`
...
<\/script>
`},{highlight:w(()=>[sn]),default:w(()=>[F(v)]),_:1}),an])}var un=O(U,[["render",en]]);export{cn as __pageData,un as default};
