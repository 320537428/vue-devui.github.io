...
`)])])],-1),j=n("h3",{id:"\u8BBE\u7F6E\u7981\u7528",tabindex:"-1"},[t("\u8BBE\u7F6E\u7981\u7528 "),n("a",{class:"header-anchor",href:"#\u8BBE\u7F6E\u7981\u7528","aria-hidden":"true"},"#")],-1),I=n("div",{class:"language-vue"},[n("pre",null,[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),t("template")]),n("span",{class:"token punctuation"},">")]),t(`
...
</code></pre></div>`,11);function z(u,p,r,k,d,f){const g=C("render-demo-0"),l=C("demo"),m=C("render-demo-1"),e=C("render-demo-2"),s=C("render-demo-3"),c=C("render-demo-4");return S(),V("div",null,[N,v(l,{sourceCode:`<template>
...
<\/script>
`},{highlight:E(()=>[P]),default:E(()=>[v(g)]),_:1}),j,v(l,{sourceCode:`<template>
  <d-row type="flex">
    <d-col :flex="4">
...
<\/script>
`},{highlight:E(()=>[I]),default:E(()=>[v(m)]),_:1}),M,v(l,{sourceCode:`<template>
...
<\/script>
`},{highlight:E(()=>[U]),default:E(()=>[v(c)]),_:1}),R])}var W=_(q,[["render",z]]);export{Q as __pageData,W as default};
