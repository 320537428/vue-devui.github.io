...
</code></pre></div><p>item indicates a data item.</p>`,20);function nn(c,s,o,g,m,y){const l=x("render-demo-0"),d=x("demo"),i=x("render-demo-1"),u=x("render-demo-2"),p=x("render-demo-3"),a=x("render-demo-4"),e=x("render-demo-5");return D(),L("div",null,[q,h(d,{sourceCode:`<template>
  <d-auto-complete
    :delay="1000"
    :source="source"
    v-model="value"
