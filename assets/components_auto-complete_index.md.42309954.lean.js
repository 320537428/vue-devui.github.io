var _=Object.defineProperty;var D=Object.getOwnPropertySymbols;var w=Object.prototype.hasOwnProperty,V=Object.prototype.propertyIsEnumerable;var x=(u,s,o)=>s in u?_(u,s,{enumerable:!0,configurable:!0,writable:!0,value:o}):u[s]=o,F=(u,s)=>{for(var o in s||(s={}))w.call(s,o)&&x(u,o,s[o]);if(D)for(var o of D(s))V.call(s,o)&&x(u,o,s[o]);return u};import{_ as T,V as y,r as v,c as P,b as E,w as C,a as S,d as n,e as t,o as L}from"./app.f9afb399.js";const R={name:"component-doc",components:{"render-demo-0":function(){const{resolveComponent:u,createVNode:s,openBlock:o,createElementBlock:g}=y;function m(i,p){const c=u("d-auto-complete");return o(),g("div",null,[s(c,{delay:1e3,source:i.source,modelValue:i.value,"onUpdate:modelValue":p[0]||(p[0]=a=>i.value=a),allowEmptyValueSearch:i.allowEmptyValueSearch,selectValue:i.selectValue,transInputFocusEmit:i.transInputFocusEmit,appendToBody:!0,appendToBodyDirections:i.appendToBodyDirections,dAutoCompleteWidth:450},null,8,["source","modelValue","allowEmptyValueSearch","selectValue","transInputFocusEmit","appendToBodyDirections"])])}const{defineComponent:f,ref:l}=y,d=f({setup(){const i=l(""),p=l(!0),c=l(["C#","C","C++","CPython","Java","JavaScript","Go","Python","Ruby","F#","TypeScript","SQL","LiveScript","CoffeeScript"]),a=()=>{console.log("selectValue")},e=()=>{console.log("transInputFocusEmit")},k=l({originX:"left",originY:"bottom",overlayX:"left",overlayY:"top"});return{value:i,source:c,allowEmptyValueSearch:p,transInputFocusEmit:e,selectValue:a,appendToBodyDirections:k}}});return F({render:m},d)}(),"render-demo-1":function(){const{resolveComponent:u,createVNode:s,withCtx:o,toDisplayString:g,createTextVNode:m,openBlock:f,createElementBlock:l}=y;function d(a,e){const k=u("d-auto-complete"),r=u("d-col"),A=u("d-button"),B=u("d-row");return f(),l("div",null,[s(B,{type:"flex",class:"docs-devui-row"},{default:o(()=>[s(r,{flex:4},{default:o(()=>[s(k,{source:a.source,modelValue:a.value,"onUpdate:modelValue":e[0]||(e[0]=h=>a.value=h),disabled:a.isDisabled},null,8,["source","modelValue","disabled"])]),_:1}),s(r,{flex:2},{default:o(()=>[s(A,{id:"primaryBtn",onClick:a.toggle,style:{"margin-left":"10px"}},{default:o(()=>[m(g(a.isDisabled?"Enable AutoComplete":"Disable AutoComplete"),1)]),_:1},8,["onClick"])]),_:1})]),_:1})])}const{defineComponent:i,ref:p}=y,c=i({setup(){const a=p(""),e=p(["C#","C","C++","CPython","Java","JavaScript","Go","Python","Ruby","F#","TypeScript","SQL","LiveScript","CoffeeScript"]),k=p(!1);function r(){k.value=!k.value}return{value:a,source:e,isDisabled:k,toggle:r}}});return F({render:d},c)}(),"render-demo-2":function(){const{toDisplayString:u,createElementVNode:s,resolveComponent:o,withCtx:g,createVNode:m,openBlock:f,createElementBlock:l}=y;function d(a,e){const k=o("d-auto-complete");return f(),l("div",null,[m(k,{modelValue:a.value,"onUpdate:modelValue":e[0]||(e[0]=r=>a.value=r),searchFn:a.searchFn,disabledKey:"disabled",isSearching:"",delay:1e3,formatter:a.formatter},{searchingTemplate:g(r=>[s("div",null,u(`searching: ${r}`),1)]),_:1},8,["modelValue","searchFn","formatter"])])}const{defineComponent:i,ref:p}=y,c=i({setup(){const a=p(""),e=p([{label:"C#",disabled:!1},{label:"C++",disabled:!1},{label:"CPython",disabled:!1},{label:"Java",disabled:!1},{label:"JavaScript",disabled:!1},{label:"Go",disabled:!1},{label:"Ruby",disabled:!1},{label:"F#",disabled:!1},{label:"TypeScript",disabled:!1},{label:"SQL",disabled:!0},{label:"LiveScript",disabled:!1},{label:"CoffeeScript",disabled:!1}]);return{value:a,searchFn:async A=>{let B=[];return await new Promise(h=>{setTimeout(()=>{h()},1e3)}),e.value.forEach(h=>{let b=h.label;b=b.toLowerCase(),b.startsWith(A)&&B.push(h)}),B},formatter:A=>A.label}}});return F({render:d},c)}(),"render-demo-3":function(){const{toDisplayString:u,createElementVNode:s,resolveComponent:o,withCtx:g,createVNode:m,openBlock:f,createElementBlock:l}=y;function d(a,e){const k=o("d-auto-complete");return f(),l("div",null,[m(k,{source:a.source,modelValue:a.value,"onUpdate:modelValue":e[0]||(e[0]=r=>a.value=r)},{itemTemplate:g(r=>[s("div",null," \u7B2C"+u(r.index)+"\u9879: "+u(r.item),1)]),noResultItemTemplate:g(r=>[s("div",null,u(`\u6CA1\u6709\u5339\u914D\u9879: ${r}`),1)]),_:1},8,["source","modelValue"])])}const{defineComponent:i,ref:p}=y,c=i({setup(){const a=p(""),e=p(["C#","C","C++","CPython","Java","JavaScript","Go","Python","Ruby","F#","TypeScript","SQL","LiveScript","CoffeeScript"]);return{value:a,source:e}}});return F({render:d},c)}(),"render-demo-4":function(){const{resolveComponent:u,createVNode:s,openBlock:o,createElementBlock:g}=y;function m(c,a){const e=u("d-auto-complete");return o(),g("div",null,[s(e,{source:c.source,modelValue:c.value,"onUpdate:modelValue":a[0]||(a[0]=k=>c.value=k),latestSource:c.latestSource},null,8,["source","modelValue","latestSource"])])}const{defineComponent:f,ref:l,toRefs:d,getCurrentInstance:i}=y,p=f({setup(){const c=l(""),a=l(["JavaScript","TypeScript"]),e=l(["C#","C","C++","CPython","Java","JavaScript","Go","Python","Ruby","F#","TypeScript","SQL","LiveScript","CoffeeScript"]);return{value:c,source:e,latestSource:a}}});return F({render:m},p)}(),"render-demo-5":function(){const{resolveComponent:u,createVNode:s,openBlock:o,createElementBlock:g}=y;function m(c,a){const e=u("d-auto-complete");return o(),g("div",null,[s(e,{ref:"autoCompleteRef",source:c.source,modelValue:c.value,"onUpdate:modelValue":a[0]||(a[0]=k=>c.value=k),enableLazyLoad:"","load-more":c.loadMore},null,8,["source","modelValue","load-more"])])}const{defineComponent:f,ref:l,toRefs:d,getCurrentInstance:i}=y,p=f({setup(){const c=l(""),a=l(["C#","C","C++","CPython","Java","JavaScript","Go","Python","Ruby","F#","TypeScript","SQL","LiveScript","CoffeeScript","C1","C2","C3","C4","C5","C6","C7"]),e=l(null);return{value:c,source:a,loadMore:()=>{setTimeout(()=>{var r;a.value.push("lazyData"+a.value.length),(r=e.value)==null||r.loadFinish()},3e3)},autoCompleteRef:e}}});return F({render:m},p)}()}},sn='{"title":"AutoComplete \u81EA\u52A8\u8865\u5168","description":"","frontmatter":{},"headers":[{"level":3,"title":"\u4F55\u65F6\u4F7F\u7528","slug":"\u4F55\u65F6\u4F7F\u7528"},{"level":3,"title":"\u57FA\u672C\u7528\u6CD5","slug":"\u57FA\u672C\u7528\u6CD5"},{"level":3,"title":"\u8BBE\u7F6E\u7981\u7528","slug":"\u8BBE\u7F6E\u7981\u7528"},{"level":3,"title":"\u81EA\u5B9A\u4E49\u6570\u636E\u5339\u914D\u65B9\u6CD5","slug":"\u81EA\u5B9A\u4E49\u6570\u636E\u5339\u914D\u65B9\u6CD5"},{"level":3,"title":"\u81EA\u5B9A\u4E49\u6A21\u677F\u5C55\u793A","slug":"\u81EA\u5B9A\u4E49\u6A21\u677F\u5C55\u793A"},{"level":3,"title":"\u6700\u8FD1\u8F93\u5165","slug":"\u6700\u8FD1\u8F93\u5165"},{"level":3,"title":"\u61D2\u52A0\u8F7D","slug":"\u61D2\u52A0\u8F7D"},{"level":3,"title":"d-auto-complete","slug":"d-auto-complete"},{"level":3,"title":"defaultSearchFn","slug":"defaultsearchfn"},{"level":3,"title":"defaultFormatter","slug":"defaultformatter"},{"level":3,"title":"defaultValueParse","slug":"defaultvalueparse"}],"relativePath":"components/auto-complete/index.md","lastUpdated":1641997813409}',J=S('<h1 id="autocomplete-\u81EA\u52A8\u8865\u5168" tabindex="-1">AutoComplete \u81EA\u52A8\u8865\u5168 <a class="header-anchor" href="#autocomplete-\u81EA\u52A8\u8865\u5168" aria-hidden="true">#</a></h1><p>\u8054\u60F3\u7528\u6237\u53EF\u80FD\u9700\u8981\u7684\u8F93\u5165\u7ED3\u679C\u3002</p><h3 id="\u4F55\u65F6\u4F7F\u7528" tabindex="-1">\u4F55\u65F6\u4F7F\u7528 <a class="header-anchor" href="#\u4F55\u65F6\u4F7F\u7528" aria-hidden="true">#</a></h3><p>\u5F53\u9700\u8981\u6839\u636E\u7528\u6237\u8F93\u5165\u7684\u90E8\u5206\u5B57\u7B26\u63A8\u65AD\u51FA\u4ED6\u53EF\u80FD\u60F3\u8981\u8F93\u5165\u7684\u5185\u5BB9\u65F6\u3002</p><h3 id="\u57FA\u672C\u7528\u6CD5" tabindex="-1">\u57FA\u672C\u7528\u6CD5 <a class="header-anchor" href="#\u57FA\u672C\u7528\u6CD5" aria-hidden="true">#</a></h3><p>\u901A\u8FC7 source \u8BBE\u7F6E\u81EA\u52A8\u5B8C\u6210\u7684\u6570\u636E\u6E90\u3002</p>',6),q=n("div",{class:"language-vue"},[n("pre",null,[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),t("template")]),n("span",{class:"token punctuation"},">")]),t(`
...
`)]),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"</"),t("style")]),n("span",{class:"token punctuation"},">")]),t(`
`)])])],-1),X=n("h3",{id:"\u6700\u8FD1\u8F93\u5165",tabindex:"-1"},[t("\u6700\u8FD1\u8F93\u5165 "),n("a",{class:"header-anchor",href:"#\u6700\u8FD1\u8F93\u5165","aria-hidden":"true"},"#")],-1),Y=n("p",null,"\u901A\u8FC7 latestSource \u8BBE\u7F6E\u6700\u8FD1\u8F93\u5165\u3002",-1),U=n("div",{class:"language-vue"},[n("pre",null,[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),t("template")]),n("span",{class:"token punctuation"},">")]),t(`
  `),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),t("d-auto-complete")]),t(`
    `),n("span",{class:"token attr-name"},":source"),n("span",{class:"token attr-value"},[n("span",{class:"token punctuation attr-equals"},"="),n("span",{class:"token punctuation"},'"'),t("source"),n("span",{class:"token punctuation"},'"')]),t(`
    `),n("span",{class:"token attr-name"},"v-model"),n("span",{class:"token attr-value"},[n("span",{class:"token punctuation attr-equals"},"="),n("span",{class:"token punctuation"},'"'),t("value"),n("span",{class:"token punctuation"},'"')]),t(`
...
</code></pre></div><p>item \u4E3A\u6570\u636E\u9879\u3002</p>`,15);function nn(u,s,o,g,m,f){const l=v("render-demo-0"),d=v("demo"),i=v("render-demo-1"),p=v("render-demo-2"),c=v("render-demo-3"),a=v("render-demo-4"),e=v("render-demo-5");return L(),P("div",null,[J,E(d,{sourceCode:`<template>
  <d-auto-complete
    :delay="1000"
    :source="source"
    v-model="value"
...
`},{highlight:C(()=>[q]),default:C(()=>[E(l)]),_:1}),I,N,E(d,{sourceCode:`<template>
...
`},{highlight:C(()=>[M]),default:C(()=>[E(p)]),_:1}),z,j,E(d,{sourceCode:`<template>
  <d-auto-complete
    :source="source"
    v-model="value"
  >
...
`},{highlight:C(()=>[W]),default:C(()=>[E(c)]),_:1}),X,Y,E(d,{sourceCode:`<template>
  <d-auto-complete
    :source="source"
    v-model="value"
