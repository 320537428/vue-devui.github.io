...
<\/script>
`},{highlight:v(()=>[H]),default:v(()=>[m(e)]),_:1}),$,m(o,{sourceCode:`<template>
...
<\/script>
`},{highlight:v(()=>[I]),default:v(()=>[m(l)]),_:1}),P,m(o,{sourceCode:`<template>
  <div>
    <d-rate
      v-model="value1"
      :read="true"
...
<\/script>
`},{highlight:v(()=>[S]),default:v(()=>[m(p)]),_:1}),T])}var K=x(b,[["render",R]]);export{J as __pageData,K as default};
