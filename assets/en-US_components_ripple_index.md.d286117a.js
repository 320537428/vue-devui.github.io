import{V}from"./framework.37dedfa0.js";import{_ as A,S,b as y,a1 as h,a3 as F,V as n,x as t,N as q,R as U}from"./plugin-vue_export-helper.02048804.js";import"./framework.43f3ce53.js";const z={name:"component-doc",components:{"render-demo-0":function(){const{createTextVNode:l,resolveDirective:e,openBlock:o,createElementBlock:a,withDirectives:u,createElementVNode:c,resolveComponent:p,withCtx:s,createVNode:i}=V,r={class:"ripple-button"},k={class:"ripple-htmlElement"},_=[l("HTML element with v-ripple")],b={class:"ripple-button"},f={class:"ripple-htmlElement"},g=[l("HTML element with v-ripple")];function w(I,T){const C=p("d-col"),m=p("d-row"),E=e("ripple");return o(),a("div",null,[i(m,{gutter:50},{default:s(()=>[i(C,{span:12},{default:s(()=>[c("div",r,[u((o(),a("div",k,_)),[[E,{color:"#5e7ce0",duration:300}]])])]),_:1}),i(C,{span:12},{default:s(()=>[c("div",b,[u((o(),a("div",f,g)),[[E,{duration:800}]])])]),_:1})]),_:1})])}return{render:w,...{}}}(),"render-demo-1":function(){const{renderList:l,Fragment:e,openBlock:o,createElementBlock:a,toDisplayString:u,createTextVNode:c,resolveDirective:p,withDirectives:s,normalizeStyle:i,createElementVNode:r,resolveComponent:k,withCtx:v,createVNode:_}=V,b={class:"ripple-changeTextColor"},f={class:"ripple-changeTextColor"};function d(w,x){const I=k("d-col"),T=k("d-row"),C=p("ripple");return o(),a("div",null,[_(T,null,{default:v(()=>[_(I,{span:12},{default:v(()=>[r("ul",null,[(o(),a(e,null,l([{color:"#409EFF",text:"Item with Primary ripple"},{color:"#67C23A",text:"Item with Success ripple"},{color:"#E6A23C",text:"Item with Warning ripple"},{color:"#F56C6C",text:"Item with Danger ripple"},{color:"#909399",text:"Item with Info ripple"}],m=>r("li",{style:i({color:m.color})},[s((o(),a("div",b,[c(u(m.text),1)])),[[C,{duration:300}]])],4)),64))])]),_:1}),_(I,{span:12},{default:v(()=>[r("ul",null,[(o(),a(e,null,l([{color:"#409EFF",text:"Item with Primary ripple"},{color:"#67C23A",text:"Item with Success ripple"},{color:"#E6A23C",text:"Item with Warning ripple"},{color:"#F56C6C",text:"Item with Danger ripple"},{color:"#909399",text:"Item with Info ripple"}],(m,E)=>r("li",{style:i({color:m.color})},[s((o(),a("div",f,[c(u(m.text),1)])),[[C,{duration:300,color:`${m.color.slice(0,4)}`}]])],4)),64))])]),_:1})]),_:1})])}return{render:d,...{}}}(),"render-demo-2":function(){const{createTextVNode:l,resolveComponent:e,resolveDirective:o,withCtx:a,openBlock:u,createBlock:c,withDirectives:p,createVNode:s,createElementBlock:i}=V,r=l("Text"),k=l("Text dark");function v(b,f){const d=e("d-button"),g=e("d-col"),w=e("d-row"),x=o("ripple");return u(),i("div",null,[s(w,null,{default:a(()=>[s(g,{span:6},{default:a(()=>[p((u(),c(d,{variant:"text",style:{"margin-right":"20px"}},{default:a(()=>[r]),_:1})),[[x,{duration:300}]])]),_:1}),s(g,{span:6},{default:a(()=>[p((u(),c(d,{variant:"text-dark",style:{"margin-right":"20px"}},{default:a(()=>[k]),_:1})),[[x,{duration:300}]])]),_:1}),s(g,{span:6},{default:a(()=>[p(s(d,{icon:"add",variant:"text-dark",title:"add"},null,512),[[x,{duration:300}]])]),_:1}),s(g,{span:6},{default:a(()=>[p(s(d,{icon:"delete",variant:"text-dark",title:"delete"},null,512),[[x,{duration:300}]])]),_:1})]),_:1})])}return{render:v,...{}}}(),"render-demo-3":function(){const{resolveComponent:l,createVNode:e,createTextVNode:o,createElementVNode:a,resolveDirective:u,withCtx:c,openBlock:p,createBlock:s,withDirectives:i,createElementBlock:r}=V,k=o(" DEVUI Course "),v=a("span",null,"DevUI",-1),_=o(" DEVUI is a free open-source and common solution for the front end of enterprise mid- and back-end products. Its design values are basedon... "),b={class:"card-block"},f=a("span",null,"12",-1),d={class:"card-block"},g=a("span",null,"8",-1),w={class:"card-block"},x=a("span",null,"8",-1);function I(C,m){const E=l("d-avatar"),D=l("d-icon"),N=l("d-card"),B=u("ripple");return p(),r("div",null,[i((p(),s(N,{class:"d-card",src:"https://devui.design/components/assets/image1.png"},{cardAvatar:c(()=>[e(E,{name:"DevUI"})]),cardTitle:c(()=>[k]),cardSubtitle:c(()=>[e(D,{name:"company-member"}),v]),cardContent:c(()=>[_]),cardActions:c(()=>[a("div",b,[e(D,{name:"like"}),f]),a("div",d,[e(D,{name:"star-o"}),g]),a("div",w,[e(D,{name:"message"}),x])]),_:1},8,["src"])),[[B,{duration:300}]])])}return{render:I,...{}}}()}},tn='{"title":"RippleDirective","description":"","frontmatter":{},"headers":[{"level":3,"title":"When to Use","slug":"when-to-use"},{"level":3,"title":"Custom color","slug":"custom-color"},{"level":3,"title":"Change the ripple color dynamically by changing the text color or the ripple color","slug":"change-the-ripple-color-dynamically-by-changing-the-text-color-or-the-ripple-color"},{"level":3,"title":"Ripple in components","slug":"ripple-in-components"},{"level":3,"title":"Some components provide the ripple prop that allows you to control the ripple effect.","slug":"some-components-provide-the-ripple-prop-that-allows-you-to-control-the-ripple-effect"},{"level":3,"title":"API","slug":"api"}],"relativePath":"en-US/components/ripple/index.md","lastUpdated":1658409114905}',L=F('<h1 id="rippledirective" tabindex="-1">RippleDirective <a class="header-anchor" href="#rippledirective" aria-hidden="true">#</a></h1><p><span color="#409EFF"><code>v-ripple</code></span>The v-ripple directive is used to show action from a user. It can be applied to any block level element.<span color="#409EFF"><code>tips: It can be applied to any block level element.</code></span></p><h3 id="when-to-use" tabindex="-1">When to Use <a class="header-anchor" href="#when-to-use" aria-hidden="true">#</a></h3>',3),P=n("div",null,[t("User can be use Basic ripple functionality can be enabled just by using v-ripple directive on a component or an HTML element "),n("span",{color:"#409EFF"},[n("code",null,"v-ripple")]),t("Basic ripple functionality "),n("span",{color:"#409EFF"},[n("code",null,"v-ripple")]),t(" Directive "),n("code",null,"v-ripple"),t(" Accept an object")],-1),W=n("div",{class:"language-vue"},[n("pre",null,[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),t("template")]),n("span",{class:"token punctuation"},">")]),t(`
...
`},{description:h(()=>[P]),highlight:h(()=>[W]),default:h(()=>[y(p)]),_:1}),H,M,y(s,{sourceCode:`<template>
  <d-row>
    <d-col :span="12">
      <ul>
        <li
