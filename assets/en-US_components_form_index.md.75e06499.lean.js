...
<span class="token punctuation">}</span>
  ...
  <span class="token function">resetField</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token operator">:</span> <span class="token keyword">void</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre></div>`,30);function Kn(p,o,s,t,M,b){const v=j("render-demo-0"),l=j("demo"),S=j("render-demo-1"),C=j("render-demo-2"),x=j("render-demo-3"),D=j("render-demo-4"),q=j("render-demo-5"),h=j("render-demo-6"),y=j("render-demo-7"),r=j("render-demo-8"),i=j("render-demo-9"),f=j("render-demo-10"),u=j("render-demo-11"),d=j("render-demo-12"),g=j("render-demo-13"),w=j("render-demo-14"),c=j("render-demo-15");return sn(),on("div",null,[pn,A(l,{sourceCode:`<template>
