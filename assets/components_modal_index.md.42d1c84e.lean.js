var M=Object.defineProperty;var S=Object.getOwnPropertySymbols;var I=Object.prototype.hasOwnProperty,j=Object.prototype.propertyIsEnumerable;var V=(o,u,a)=>u in o?M(o,u,{enumerable:!0,configurable:!0,writable:!0,value:a}):o[u]=a,y=(o,u)=>{for(var a in u||(u={}))I.call(u,a)&&V(o,a,u[a]);if(S)for(var a of S(u))j.call(u,a)&&V(o,a,u[a]);return o};import{_ as L,V as F,r as _,c as R,b as m,w as h,a as O,d as n,e as t,o as G}from"./app.14dd1803.js";const K={name:"component-doc",components:{"render-demo-0":function(){const{createTextVNode:o,resolveComponent:u,withCtx:a,createVNode:l,openBlock:i,createElementBlock:k}=F,r=o("\u6253\u5F00 modal");function p(c,v){const e=u("d-button");return i(),k("div",null,[l(e,{onClick:c.open},{default:a(()=>[r]),_:1},8,["onClick"])])}const{ref:C,defineComponent:d,inject:g,onMounted:E,h:s}=F,f=d({setup(){const c=g("DIALOG_SERVICE_TOKEN");return{open:()=>{const e=c.open({title:"Start Snapshot Version",content:()=>s("div",{},["Modal Content",s("div",{},["name: Tom"]),s("div",{},["age: 10"]),s("div",{},["address: Chengdu"])]),buttons:[{variant:"primary",text:"Ok",handler:()=>e.hide()},{variant:"common",text:"Cancel",handler:()=>e.hide()}]})}}}});return y({render:p},f)}(),"render-demo-1":function(){const{createElementVNode:o,openBlock:u,createElementBlock:a}=F,i=[o("div",null,"\u{1F477}\u65BD\u5DE5\u4E2D",-1)];function k(s,f){return u(),a("div",null,i)}const{ref:r,defineComponent:p,inject:C,onMounted:d,h:g}=F,E=p({setup(){}});return y({render:k},E)}(),"render-demo-2":function(){const{createTextVNode:o,resolveComponent:u,withCtx:a,createVNode:l,openBlock:i,createElementBlock:k}=F,r=o("click me!");function p(c,v){const e=u("d-button");return i(),k("div",null,[l(e,{variant:"common",onClick:c.open},{default:a(()=>[r]),_:1},8,["onClick"])])}const{ref:C,defineComponent:d,inject:g,onMounted:E,h:s}=F,f=d({setup(){const c=g("DIALOG_SERVICE_TOKEN"),v=()=>{const b=c.open({title:"Start Snapshot Version",content:()=>s("div",{},["Modal Content",s("div",{},["name: Tom"]),s("div",{},["age: 10"]),s("div",{},["address: Chengdu"])]),dialogtype:"standard",beforeHidden:e,backdropCloseable:!0,buttons:[{variant:"primary",text:"Save",handler:()=>b.hide()}]})},e=()=>new Promise(b=>{const w=c.open({width:"300px",maxHeight:"600px",title:"",content:()=>"Do you want to save the modification before closing the page?",backdropCloseable:!1,dialogtype:"warning",buttons:[{variant:"primary",text:"Save",handler(){w.hide(),b(!0)}},{variant:"common",text:"Cancel",handler(){w.hide(),b(!0)}}]})});return{open:v}}});return y({render:p},f)}(),"render-demo-3":function(){const{createTextVNode:o,resolveComponent:u,withCtx:a,createVNode:l,createElementVNode:i,openBlock:k,createElementBlock:r}=F,p={class:"btn-group"},C=o("success"),d=o("fail"),g=o("warning"),E=o("info");function s(B,x){const A=u("d-button");return k(),r("div",null,[i("div",p,[l(A,{variant:"common",onClick:x[0]||(x[0]=D=>B.open("success","\u6210\u529F","Delete [Git] repository successfully."))},{default:a(()=>[C]),_:1}),l(A,{variant:"common",onClick:x[1]||(x[1]=D=>B.open("failed","\u9519\u8BEF","It is failed. if you want to resolve it,please contact the supportor."))},{default:a(()=>[d]),_:1}),l(A,{variant:"common",onClick:x[2]||(x[2]=D=>B.open("warning","\u8B66\u544A","Leaving this page!"))},{default:a(()=>[g]),_:1}),l(A,{variant:"common",onClick:x[3]||(x[3]=D=>B.open("info","\u63D0\u793A","You signed in with another tab or window. Reload to refresh your session."))},{default:a(()=>[E]),_:1})])])}const{ref:f,defineComponent:c,inject:v,onMounted:e,h:b}=F,w=c({setup(){const B=v("DIALOG_SERVICE_TOKEN");return{open:(A,D,N)=>{const T=B.open({title:D,content:()=>b("span",{style:{fontSize:"12px"}},N),dialogType:A,backdropCloseable:!0,buttons:[{variant:"primary",text:"Save",handler:()=>T.hide()}]})}}}});return y({render:s},w)}(),"render-demo-4":function(){const{createTextVNode:o,resolveComponent:u,withCtx:a,createVNode:l,openBlock:i,createElementBlock:k}=F,r=o("\u6253\u5F00 modal");function p(c,v){const e=u("d-button");return i(),k("div",null,[l(e,{onClick:c.open},{default:a(()=>[r]),_:1},8,["onClick"])])}const{ref:C,defineComponent:d,inject:g,onMounted:E,h:s}=F,f=d({setup(){const c=g("DIALOG_SERVICE_TOKEN");return{open:()=>{const e=c.open({title:"Start Snapshot Version",content:()=>s("div",{onMouseover(){e.updateButtonOptions([{disabled:!0}])}},["Modal Content",s("div",{},["name: Tom"]),s("div",{},["age: 10"]),s("div",{},["address: Chengdu"])]),buttons:[{variant:"primary",text:"Ok",handler:()=>e.hide()},{variant:"common",text:"Cancel",handler:()=>e.hide()}]})}}}});return y({render:p},f)}(),"render-demo-5":function(){const{createTextVNode:o,resolveComponent:u,withCtx:a,createVNode:l,openBlock:i,createElementBlock:k}=F,r=o("\u6253\u5F00 modal");function p(c,v){const e=u("d-button");return i(),k("div",null,[l(e,{onClick:c.open},{default:a(()=>[r]),_:1},8,["onClick"])])}const{ref:C,defineComponent:d,inject:g,onMounted:E,h:s}=F,f=d({setup(){const c=g("DIALOG_SERVICE_TOKEN");return{open:()=>{const e=c.open({title:"Start Snapshot Version",content:()=>s("div",{onMouseover(){e.updateButtonOptions([{disabled:!0}])}},["Modal Content",s("div",{},["name: Tom"]),s("div",{},["age: 10"]),s("div",{},["address: Chengdu"])]),buttons:[{variant:"primary",text:"Ok",autofocus:!0,handler:()=>e.hide()},{variant:"common",text:"Cancel",handler:()=>e.hide()}]})}}}});return y({render:p},f)}(),"render-demo-6":function(){const{createTextVNode:o,resolveComponent:u,withCtx:a,createVNode:l,openBlock:i,createElementBlock:k}=F,r=o("\u6253\u5F00 modal");function p(c,v){const e=u("d-button");return i(),k("div",null,[l(e,{onClick:c.open},{default:a(()=>[r]),_:1},8,["onClick"])])}const{ref:C,defineComponent:d,inject:g,onMounted:E,h:s}=F,f=d({setup(){const c=g("DIALOG_SERVICE_TOKEN");return{open:()=>{const e=c.open({bodyScrollable:!1,title:"Start Snapshot Version",content:()=>s("div",{},["Modal Content",s("div",{},["name: Tom"]),s("div",{},["age: 10"]),s("div",{},["address: Chengdu"])]),buttons:[{variant:"primary",text:"Ok",handler:()=>e.hide()},{variant:"common",text:"Cancel",handler:()=>e.hide()}]})}}}});return y({render:p},f)}()}},dn='{"title":"Modal \u6A21\u6001\u5F39\u7A97","description":"","frontmatter":{},"headers":[{"level":3,"title":"\u4F55\u65F6\u4F7F\u7528","slug":"\u4F55\u65F6\u4F7F\u7528"},{"level":3,"title":"API","slug":"api"},{"level":3,"title":"Other","slug":"other"}],"relativePath":"components/modal/index.md","lastUpdated":1640619429521}',q=O('<h1 id="modal-\u6A21\u6001\u5F39\u7A97" tabindex="-1">Modal \u6A21\u6001\u5F39\u7A97 <a class="header-anchor" href="#modal-\u6A21\u6001\u5F39\u7A97" aria-hidden="true">#</a></h1><p>\u6A21\u6001\u5BF9\u8BDD\u6846\u3002</p><h3 id="\u4F55\u65F6\u4F7F\u7528" tabindex="-1">\u4F55\u65F6\u4F7F\u7528 <a class="header-anchor" href="#\u4F55\u65F6\u4F7F\u7528" aria-hidden="true">#</a></h3><p>1.\u9700\u8981\u7528\u6237\u5904\u7406\u4E8B\u52A1\uFF0C\u53C8\u4E0D\u5E0C\u671B\u8DF3\u8F6C\u9875\u9762\u4EE5\u81F4\u6253\u65AD\u5DE5\u4F5C\u6D41\u7A0B\u65F6\uFF0C\u53EF\u4EE5\u4F7F\u7528 Modal \u5728\u5F53\u524D\u9875\u9762\u6B63\u4E2D\u6253\u5F00\u4E00\u4E2A\u6D6E\u5C42\uFF0C\u627F\u8F7D\u76F8\u5E94\u7684\u64CD\u4F5C\u3002</p><p>2.\u5F39\u7A97\u8D77\u5230\u4E0E\u7528\u6237\u8FDB\u884C\u4EA4\u4E92\u7684\u4F5C\u7528\uFF0C\u7528\u6237\u53EF\u4EE5\u5728\u5BF9\u8BDD\u6846\u4E2D\u8F93\u5165\u4FE1\u606F\u3001\u9605\u8BFB\u63D0\u793A\u3001\u8BBE\u7F6E\u9009\u9879\u7B49\u64CD\u4F5C\u3002</p><h4 id="\u6807\u51C6\u5BF9\u8BDD\u6846" tabindex="-1">\u6807\u51C6\u5BF9\u8BDD\u6846 <a class="header-anchor" href="#\u6807\u51C6\u5BF9\u8BDD\u6846" aria-hidden="true">#</a></h4><p>\u4F7F\u7528dialogService\u53EF\u62D6\u62FD\u7684\u6807\u51C6\u5BF9\u8BDD\u6846\u3002</p>',7),H=n("div",{class:"language-vue"},[n("pre",null,[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),t("template")]),n("span",{class:"token punctuation"},">")]),t(`
    ...
    `),n("span",{class:"token keyword"},"const"),t(),n("span",{class:"token function-variable function"},"open"),t(),n("span",{class:"token operator"},"="),t(),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},")"),t(),n("span",{class:"token operator"},"=>"),t(),n("span",{class:"token punctuation"},"{"),t(`
      `),n("span",{class:"token keyword"},"const"),t(" result "),n("span",{class:"token operator"},"="),t(" modalservice"),n("span",{class:"token punctuation"},"."),n("span",{class:"token function"},"open"),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},"{"),t(`
        ...
        buttons`),n("span",{class:"token operator"},":"),t(),n("span",{class:"token punctuation"},"["),n("span",{class:"token punctuation"},"{"),t(`
          variant`),n("span",{class:"token operator"},":"),t(),n("span",{class:"token string"},"'primary'"),n("span",{class:"token punctuation"},","),t(`
        ...
        `),n("span",{class:"token punctuation"},"}"),n("span",{class:"token punctuation"},","),t(),n("span",{class:"token punctuation"},"{"),t(`
          variant`),n("span",{class:"token operator"},":"),t(),n("span",{class:"token string"},"'common'"),n("span",{class:"token punctuation"},","),t(`
