...
</code></pre></div>`,7);function en(e,o,t,s,l,p){const r=x("render-demo-0"),u=x("demo"),g=x("render-demo-1"),_=x("render-demo-2"),f=x("render-demo-3"),y=x("render-demo-4");return I(),H("div",null,[K,h(u,{sourceCode:`<template>
  <d-panel>
