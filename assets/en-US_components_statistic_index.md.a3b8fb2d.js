...
`},{highlight:m(()=>[P]),default:m(()=>[g(l)]),_:1}),j,H,g(c,{sourceCode:`<template>
  <d-row :gutter="16">
    <d-col :span="12">
      <d-card>
        <d-statistic
