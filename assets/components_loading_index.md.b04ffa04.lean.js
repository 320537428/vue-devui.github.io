import{V as b}from"./framework.37dedfa0.js";import{_ as P,S as M,b as F,a1 as x,a3 as V,V as n,x as t,N as S,R as $}from"./plugin-vue_export-helper.02048804.js";import"./framework.43f3ce53.js";const I={name:"component-doc",components:{"render-demo-0":function(){const{createTextVNode:o,resolveComponent:f,withCtx:i,createVNode:y,createElementVNode:s,renderList:c,Fragment:r,openBlock:a,createElementBlock:u,toDisplayString:h,resolveDirective:v,withDirectives:w}=b,_=o("click me!"),E={backdrop:!0,"position-type":"relative",view:{top:"50%",left:"50%"},"z-index":100,style:{width:"100%","text-align":"left"}},A=s("thead",null,[s("tr",null,[s("th",null,"\u5E8F\u53F7"),s("th",null,"\u59D3\u540D"),s("th",null,"\u961F\u4F0D"),s("th",null,"\u64CD\u4F5C")])],-1),k=s("td",null,"\u5F20\u5BB6\u9F50",-1),d=s("td",null,"\u8DF3\u6C34",-1),g=s("td",null,"\u8DF3\u6C34\u961F",-1);function l(p,D){const L=f("d-button"),N=v("d-loading");return a(),u("div",null,[y(L,{onClick:p.fetchTableData,style:{"margin-top":"8px"}},{default:i(()=>[_]),_:1},8,["onClick"]),w((a(),u("table",E,[A,s("tbody",null,[(a(!0),u(r,null,c(p.datas,(T,q)=>(a(),u("tr",{key:q},[s("td",null,h(q),1),k,d,g]))),128))])])),[[N,p.loadingStatus]])])}const{defineComponent:m,ref:e,reactive:B}=b,C=m({setup(){const p=e(!1),D=B([]);return{datas:D,loadingStatus:p,fetchTableData:()=>{p.value=!0,setTimeout(()=>{D.push(1,2,3),p.value=!1},2e3)}}}});return{render:l,...C}}(),"render-demo-1":function(){const{createTextVNode:o,resolveComponent:f,withCtx:i,createVNode:y,resolveDirective:s,openBlock:c,createElementBlock:r,withDirectives:a}=b,u=o("click me!"),h={message:"One moment please...",style:{"margin-top":"20px",width:"100%",height:"80px",padding:"10px"}},w=[o(" loading will show here2 ")];function _(d,g){const l=f("d-button"),m=s("d-loading");return c(),r("div",null,[y(l,{onClick:d.fetchMutiplePromise,style:{"margin-top":"8px"}},{default:i(()=>[u]),_:1},8,["onClick"]),a((c(),r("div",h,w)),[[m,d.promises]])])}const{defineComponent:E,ref:A}=b,k=E({setup(){const d=A([]);return{promises:d,fetchMutiplePromise:()=>{let l=[];for(let m=0;m<3;m++)l.push(new Promise((e,B)=>{setTimeout(()=>{e(m)},(m+1)*1e3)}).then(e=>e));d.value=l}}}});return{render:_,...k}}(),"render-demo-2":function(){const{createTextVNode:o,resolveComponent:f,withCtx:i,createVNode:y,resolveDirective:s,openBlock:c,createBlock:r,withDirectives:a,createElementBlock:u}=b,h=o(" Loading Style 1 "),v=o(" Loading Style 2 "),w=o(" Loading Style 3 "),_=["loading-template-ref"],A=[o(" loading will show here1 ")];function k(e,B){const C=f("d-button"),p=s("d-loading");return c(),u("div",null,[y(C,{onClick:e.showLoading1,style:{"margin-right":"8px",display:"inline-block",width:"220px"}},{default:i(()=>[h]),_:1},8,["onClick"]),a((c(),r(C,{onClick:e.showLoading2,"loading-template-ref":e.temp2,style:{"margin-right":"8px",display:"inline-block",width:"220px"}},{default:i(()=>[v]),_:1},8,["onClick","loading-template-ref"])),[[p,e.isShowLoading2]]),a((c(),r(C,{variant:"text","loading-template-ref":e.temp3,style:{"margin-right":"8px",display:"inline-block",width:"220px"}},{default:i(()=>[w]),_:1},8,["loading-template-ref"])),[[p,!0]]),a((c(),u("div",{style:{height:"80px","line-height":"80px"},"loading-template-ref":e.temp1},A,8,_)),[[p,e.isShowLoading1]])])}const{defineComponent:d,ref:g,h:l}=b,m=d({setup(){const e=l("div",{className:"devui-infinity-loading"},l("i",{className:"icon-refresh"})),B=l("div",{className:"devui-circle-loading-container-2"},l("i",{className:"icon-refresh"})),C=l("div",{className:"devui-circle-loading-container-3"},l("i",{className:"icon-refresh"})),p=g(!1),D=()=>{p.value=new Promise(T=>{setTimeout(()=>{T(!0)},1e3)})},L=g(!1);return{temp1:e,temp2:B,temp3:C,isShowLoading1:p,isShowLoading2:L,showLoading1:D,showLoading2:()=>{L.value=new Promise(T=>{setTimeout(()=>{T(!0)},1e3)})}}}});return{render:k,...m}}(),"render-demo-3":function(){const{createTextVNode:o,resolveComponent:f,withCtx:i,createVNode:y,openBlock:s,createBlock:c,createCommentVNode:r,createElementVNode:a,createElementBlock:u}=b,h=o(" click me show full screen loading! "),v=o(" click me show loading in target! "),w=o(" click me close loading in target! "),_=a("div",{id:"me",style:{"margin-top":"20px",width:"100%",height:"60px",padding:"10px"}}," loading will show here3 ",-1);function E(k,d){const g=f("d-button");return s(),u("div",null,[y(g,{onClick:k.serviceToBody,style:{"margin-right":"8px",display:"inline-block",width:"220px"}},{default:i(()=>[h]),_:1},8,["onClick"]),k.isShow?(s(),c(g,{key:0,onClick:k.openTargetLoading,style:{"margin-right":"8px",display:"inline-block",width:"200px"}},{default:i(()=>[v]),_:1},8,["onClick"])):(s(),c(g,{key:1,onClick:k.closeTargetLoading,style:{"margin-right":"8px",display:"inline-block",width:"200px"}},{default:i(()=>[w]),_:1},8,["onClick"])),_])}return{render:E,...{data(){return{isShow:!0,resultTarget:null}},methods:{serviceToBody(){const k=this.$loadingService.open();setTimeout(()=>{k.loadingInstance.close()},2e3)},openTargetLoading(){this.resultTarget=this.$loadingService.open({target:document.querySelector("#me"),message:"One moment please...",positionType:"relative",zIndex:1}),this.isShow=!1},closeTargetLoading(){this.resultTarget.loadingInstance.close(),this.isShow=!0}}}}}()}},sn='{"title":"Loading \u52A0\u8F7D\u63D0\u793A","description":"","frontmatter":{},"headers":[{"level":3,"title":"\u57FA\u672C\u7528\u6CD5","slug":"\u57FA\u672C\u7528\u6CD5"},{"level":3,"title":"\u591A promise","slug":"\u591A-promise"},{"level":3,"title":"\u81EA\u5B9A\u4E49\u6837\u5F0F","slug":"\u81EA\u5B9A\u4E49\u6837\u5F0F"},{"level":3,"title":"\u670D\u52A1\u65B9\u5F0F\u8C03\u7528","slug":"\u670D\u52A1\u65B9\u5F0F\u8C03\u7528"},{"level":3,"title":"Loading \u53C2\u6570","slug":"loading-\u53C2\u6570"}],"relativePath":"components/loading/index.md","lastUpdated":1658409114774}',z=V('<h1 id="loading-\u52A0\u8F7D\u63D0\u793A" tabindex="-1">Loading \u52A0\u8F7D\u63D0\u793A <a class="header-anchor" href="#loading-\u52A0\u8F7D\u63D0\u793A" aria-hidden="true">#</a></h1><p>\u63D0\u793A\u7528\u6237\u9875\u9762\u6B63\u5728\u6267\u884C\u6307\u4EE4\uFF0C\u9700\u8981\u7B49\u5F85\u3002</p><h4 id="\u4F55\u65F6\u4F7F\u7528" tabindex="-1">\u4F55\u65F6\u4F7F\u7528 <a class="header-anchor" href="#\u4F55\u65F6\u4F7F\u7528" aria-hidden="true">#</a></h4><p>\u5F53\u6267\u884C\u6307\u4EE4\u65F6\u95F4\u8F83\u957F\uFF08\u9700\u8981\u6570\u79D2\u4EE5\u4E0A\uFF09\u65F6\uFF0C\u5411\u7528\u6237\u5C55\u793A\u6B63\u5728\u6267\u884C\u7684\u72B6\u6001\u3002</p><h3 id="\u57FA\u672C\u7528\u6CD5" tabindex="-1">\u57FA\u672C\u7528\u6CD5 <a class="header-anchor" href="#\u57FA\u672C\u7528\u6CD5" aria-hidden="true">#</a></h3><p>\u5C55\u793A\u52A0\u8F7D\u8868\u683C\u6570\u636E\u7684\u573A\u666F\u4E2D\u7684\u57FA\u672C\u4F7F\u7528\u65B9\u6CD5\u3002</p>',6),j=n("div",{class:"language-vue"},[n("pre",null,[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),t("template")]),n("span",{class:"token punctuation"},">")]),t(`
...
`)])])],-1),O=n("h3",{id:"\u591A-promise",tabindex:"-1"},[t("\u591A promise "),n("a",{class:"header-anchor",href:"#\u591A-promise","aria-hidden":"true"},"#")],-1),Y=n("p",null,"\u652F\u6301\u591A\u4E2A promise\u3002",-1),R=n("div",{class:"language-vue"},[n("pre",null,[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),t("template")]),n("span",{class:"token punctuation"},">")]),t(`
...
`),n("span",{class:"token punctuation"},"}"),n("span",{class:"token punctuation"},")"),t(`
`)])]),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"</"),t("script")]),n("span",{class:"token punctuation"},">")]),t(`
`)])])],-1),U=n("h3",{id:"\u81EA\u5B9A\u4E49\u6837\u5F0F",tabindex:"-1"},[t("\u81EA\u5B9A\u4E49\u6837\u5F0F "),n("a",{class:"header-anchor",href:"#\u81EA\u5B9A\u4E49\u6837\u5F0F","aria-hidden":"true"},"#")],-1),G=n("p",null,"\u901A\u8FC7 templateRef \u81EA\u5B9A\u4E49 loading \u6837\u5F0F\u3002",-1),H=n("div",{class:"language-vue"},[n("pre",null,[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),t("template")]),n("span",{class:"token punctuation"},">")]),t(`
...
<\/script>
`},{highlight:x(()=>[j]),default:x(()=>[F(r)]),_:1}),O,Y,F(a,{sourceCode:`<template>
...
<\/script>
`},{highlight:x(()=>[R]),default:x(()=>[F(u)]),_:1}),U,G,F(a,{sourceCode:`<template>
...
`},{highlight:x(()=>[H]),default:x(()=>[F(h)]),_:1}),J,K,F(a,{sourceCode:`<template>
...
<\/script>
`},{highlight:x(()=>[Q]),default:x(()=>[F(v)]),_:1}),W])}var an=P(I,[["render",X]]);export{sn as __pageData,an as default};
