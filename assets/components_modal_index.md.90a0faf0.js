var M=Object.defineProperty;var S=Object.getOwnPropertySymbols;var I=Object.prototype.hasOwnProperty,j=Object.prototype.propertyIsEnumerable;var V=(o,u,a)=>u in o?M(o,u,{enumerable:!0,configurable:!0,writable:!0,value:a}):o[u]=a,x=(o,u)=>{for(var a in u||(u={}))I.call(u,a)&&V(o,a,u[a]);if(S)for(var a of S(u))j.call(u,a)&&V(o,a,u[a]);return o};import{_ as L,V as F,r as _,c as R,b as m,w as y,a as O,d as n,e as t,o as G}from"./app.be069916.js";const K={name:"component-doc",components:{"render-demo-0":function(){const{createTextVNode:o,resolveComponent:u,withCtx:a,createVNode:l,openBlock:i,createElementBlock:r}=F,k=o("\u6253\u5F00 modal");function p(c,f){const e=u("d-button");return i(),r("div",null,[l(e,{onClick:c.open},{default:a(()=>[k]),_:1},8,["onClick"])])}const{ref:E,defineComponent:d,inject:g,onMounted:v,h:s}=F,h=d({setup(){const c=g("DIALOG_SERVICE_TOKEN");return{open:()=>{const e=c.open({title:"Start Snapshot Version",content:()=>s("div",{},["Modal Content",s("div",{},["name: Tom"]),s("div",{},["age: 10"]),s("div",{},["address: Chengdu"])]),buttons:[{variant:"primary",text:"Ok",handler:()=>e.hide()},{variant:"common",text:"Cancel",handler:()=>e.hide()}]})}}}});return x({render:p},h)}(),"render-demo-1":function(){const{createElementVNode:o,openBlock:u,createElementBlock:a}=F,i=[o("div",null,"\u{1F477}\u65BD\u5DE5\u4E2D",-1)];function r(s,h){return u(),a("div",null,i)}const{ref:k,defineComponent:p,inject:E,onMounted:d,h:g}=F,v=p({setup(){}});return x({render:r},v)}(),"render-demo-2":function(){const{createTextVNode:o,resolveComponent:u,withCtx:a,createVNode:l,openBlock:i,createElementBlock:r}=F,k=o("click me!");function p(c,f){const e=u("d-button");return i(),r("div",null,[l(e,{variant:"common",onClick:c.open},{default:a(()=>[k]),_:1},8,["onClick"])])}const{ref:E,defineComponent:d,inject:g,onMounted:v,h:s}=F,h=d({setup(){const c=g("DIALOG_SERVICE_TOKEN"),f=()=>{const b=c.open({title:"Start Snapshot Version",content:()=>s("div",{},["Modal Content",s("div",{},["name: Tom"]),s("div",{},["age: 10"]),s("div",{},["address: Chengdu"])]),dialogtype:"standard",beforeHidden:e,backdropCloseable:!0,buttons:[{variant:"primary",text:"Save",handler:()=>b.hide()}]})},e=()=>new Promise(b=>{const w=c.open({width:"300px",maxHeight:"600px",title:"",content:()=>"Do you want to save the modification before closing the page?",backdropCloseable:!1,dialogtype:"warning",buttons:[{variant:"primary",text:"Save",handler(){w.hide(),b(!0)}},{variant:"common",text:"Cancel",handler(){w.hide(),b(!0)}}]})});return{open:f}}});return x({render:p},h)}(),"render-demo-3":function(){const{createTextVNode:o,resolveComponent:u,withCtx:a,createVNode:l,createElementVNode:i,openBlock:r,createElementBlock:k}=F,p={class:"btn-group"},E=o("success"),d=o("fail"),g=o("warning"),v=o("info");function s(B,C){const A=u("d-button");return r(),k("div",null,[i("div",p,[l(A,{variant:"common",onClick:C[0]||(C[0]=D=>B.open("success","\u6210\u529F","Delete [Git] repository successfully."))},{default:a(()=>[E]),_:1}),l(A,{variant:"common",onClick:C[1]||(C[1]=D=>B.open("failed","\u9519\u8BEF","It is failed. if you want to resolve it,please contact the supportor."))},{default:a(()=>[d]),_:1}),l(A,{variant:"common",onClick:C[2]||(C[2]=D=>B.open("warning","\u8B66\u544A","Leaving this page!"))},{default:a(()=>[g]),_:1}),l(A,{variant:"common",onClick:C[3]||(C[3]=D=>B.open("info","\u63D0\u793A","You signed in with another tab or window. Reload to refresh your session."))},{default:a(()=>[v]),_:1})])])}const{ref:h,defineComponent:c,inject:f,onMounted:e,h:b}=F,w=c({setup(){const B=f("DIALOG_SERVICE_TOKEN");return{open:(A,D,N)=>{const T=B.open({title:D,content:()=>b("span",{style:{fontSize:"12px"}},N),dialogType:A,backdropCloseable:!0,buttons:[{variant:"primary",text:"Save",handler:()=>T.hide()}]})}}}});return x({render:s},w)}(),"render-demo-4":function(){const{createTextVNode:o,resolveComponent:u,withCtx:a,createVNode:l,openBlock:i,createElementBlock:r}=F,k=o("\u6253\u5F00 modal");function p(c,f){const e=u("d-button");return i(),r("div",null,[l(e,{onClick:c.open},{default:a(()=>[k]),_:1},8,["onClick"])])}const{ref:E,defineComponent:d,inject:g,onMounted:v,h:s}=F,h=d({setup(){const c=g("DIALOG_SERVICE_TOKEN");return{open:()=>{const e=c.open({title:"Start Snapshot Version",content:()=>s("div",{onMouseover(){e.updateButtonOptions([{disabled:!0}])}},["Modal Content",s("div",{},["name: Tom"]),s("div",{},["age: 10"]),s("div",{},["address: Chengdu"])]),buttons:[{variant:"primary",text:"Ok",handler:()=>e.hide()},{variant:"common",text:"Cancel",handler:()=>e.hide()}]})}}}});return x({render:p},h)}(),"render-demo-5":function(){const{createTextVNode:o,resolveComponent:u,withCtx:a,createVNode:l,openBlock:i,createElementBlock:r}=F,k=o("\u6253\u5F00 modal");function p(c,f){const e=u("d-button");return i(),r("div",null,[l(e,{onClick:c.open},{default:a(()=>[k]),_:1},8,["onClick"])])}const{ref:E,defineComponent:d,inject:g,onMounted:v,h:s}=F,h=d({setup(){const c=g("DIALOG_SERVICE_TOKEN");return{open:()=>{const e=c.open({title:"Start Snapshot Version",content:()=>s("div",{onMouseover(){e.updateButtonOptions([{disabled:!0}])}},["Modal Content",s("div",{},["name: Tom"]),s("div",{},["age: 10"]),s("div",{},["address: Chengdu"])]),buttons:[{variant:"primary",text:"Ok",autofocus:!0,handler:()=>e.hide()},{variant:"common",text:"Cancel",handler:()=>e.hide()}]})}}}});return x({render:p},h)}(),"render-demo-6":function(){const{createTextVNode:o,resolveComponent:u,withCtx:a,createVNode:l,openBlock:i,createElementBlock:r}=F,k=o("\u6253\u5F00 modal");function p(c,f){const e=u("d-button");return i(),r("div",null,[l(e,{onClick:c.open},{default:a(()=>[k]),_:1},8,["onClick"])])}const{ref:E,defineComponent:d,inject:g,onMounted:v,h:s}=F,h=d({setup(){const c=g("DIALOG_SERVICE_TOKEN");return{open:()=>{const e=c.open({bodyScrollable:!1,title:"Start Snapshot Version",content:()=>s("div",{},["Modal Content",s("div",{},["name: Tom"]),s("div",{},["age: 10"]),s("div",{},["address: Chengdu"])]),buttons:[{variant:"primary",text:"Ok",handler:()=>e.hide()},{variant:"common",text:"Cancel",handler:()=>e.hide()}]})}}}});return x({render:p},h)}()}},dn='{"title":"Modal \u6A21\u6001\u5F39\u7A97","description":"","frontmatter":{},"headers":[{"level":3,"title":"\u4F55\u65F6\u4F7F\u7528","slug":"\u4F55\u65F6\u4F7F\u7528"},{"level":3,"title":"API","slug":"api"},{"level":3,"title":"Other","slug":"other"}],"relativePath":"components/modal/index.md","lastUpdated":1645442229749}',q=O('<h1 id="modal-\u6A21\u6001\u5F39\u7A97" tabindex="-1">Modal \u6A21\u6001\u5F39\u7A97 <a class="header-anchor" href="#modal-\u6A21\u6001\u5F39\u7A97" aria-hidden="true">#</a></h1><p>\u6A21\u6001\u5BF9\u8BDD\u6846\u3002</p><h3 id="\u4F55\u65F6\u4F7F\u7528" tabindex="-1">\u4F55\u65F6\u4F7F\u7528 <a class="header-anchor" href="#\u4F55\u65F6\u4F7F\u7528" aria-hidden="true">#</a></h3><p>1.\u9700\u8981\u7528\u6237\u5904\u7406\u4E8B\u52A1\uFF0C\u53C8\u4E0D\u5E0C\u671B\u8DF3\u8F6C\u9875\u9762\u4EE5\u81F4\u6253\u65AD\u5DE5\u4F5C\u6D41\u7A0B\u65F6\uFF0C\u53EF\u4EE5\u4F7F\u7528 Modal \u5728\u5F53\u524D\u9875\u9762\u6B63\u4E2D\u6253\u5F00\u4E00\u4E2A\u6D6E\u5C42\uFF0C\u627F\u8F7D\u76F8\u5E94\u7684\u64CD\u4F5C\u3002</p><p>2.\u5F39\u7A97\u8D77\u5230\u4E0E\u7528\u6237\u8FDB\u884C\u4EA4\u4E92\u7684\u4F5C\u7528\uFF0C\u7528\u6237\u53EF\u4EE5\u5728\u5BF9\u8BDD\u6846\u4E2D\u8F93\u5165\u4FE1\u606F\u3001\u9605\u8BFB\u63D0\u793A\u3001\u8BBE\u7F6E\u9009\u9879\u7B49\u64CD\u4F5C\u3002</p><h4 id="\u6807\u51C6\u5BF9\u8BDD\u6846" tabindex="-1">\u6807\u51C6\u5BF9\u8BDD\u6846 <a class="header-anchor" href="#\u6807\u51C6\u5BF9\u8BDD\u6846" aria-hidden="true">#</a></h4><p>\u4F7F\u7528dialogService\u53EF\u62D6\u62FD\u7684\u6807\u51C6\u5BF9\u8BDD\u6846\u3002</p>',7),H=n("div",{class:"language-vue"},[n("pre",null,[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),t("template")]),n("span",{class:"token punctuation"},">")]),t(`
  ...
  `),n("span",{class:"token function"},"setup"),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},")"),t(),n("span",{class:"token punctuation"},"{"),t(`
    ...
    `),n("span",{class:"token keyword"},"const"),t(),n("span",{class:"token function-variable function"},"open"),t(),n("span",{class:"token operator"},"="),t(),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},")"),t(),n("span",{class:"token operator"},"=>"),t(),n("span",{class:"token punctuation"},"{"),t(`
      `),n("span",{class:"token keyword"},"const"),t(" result "),n("span",{class:"token operator"},"="),t(" modalservice"),n("span",{class:"token punctuation"},"."),n("span",{class:"token function"},"open"),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},"{"),t(`
        ...
        `),n("span",{class:"token punctuation"},")"),n("span",{class:"token punctuation"},","),t(`
        `),n("span",{class:"token literal-property property"},"buttons"),n("span",{class:"token operator"},":"),t(),n("span",{class:"token punctuation"},"["),n("span",{class:"token punctuation"},"{"),t(`
          `),n("span",{class:"token literal-property property"},"variant"),n("span",{class:"token operator"},":"),t(),n("span",{class:"token string"},"'primary'"),n("span",{class:"token punctuation"},","),t(`
          `),n("span",{class:"token literal-property property"},"text"),n("span",{class:"token operator"},":"),t(),n("span",{class:"token string"},"'Ok'"),n("span",{class:"token punctuation"},","),t(`
        ...
        `),n("span",{class:"token punctuation"},"}"),n("span",{class:"token punctuation"},","),t(),n("span",{class:"token punctuation"},"{"),t(`
          `),n("span",{class:"token literal-property property"},"variant"),n("span",{class:"token operator"},":"),t(),n("span",{class:"token string"},"'common'"),n("span",{class:"token punctuation"},","),t(`
          `),n("span",{class:"token literal-property property"},"text"),n("span",{class:"token operator"},":"),t(),n("span",{class:"token string"},"'Cancel'"),n("span",{class:"token punctuation"},","),t(`
          `),n("span",{class:"token function-variable function"},"handler"),n("span",{class:"token operator"},":"),t(),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},")"),t(),n("span",{class:"token operator"},"=>"),t(" result"),n("span",{class:"token punctuation"},"."),n("span",{class:"token function"},"hide"),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},")"),t(`
        `),n("span",{class:"token punctuation"},"}"),n("span",{class:"token punctuation"},"]"),t(`
      `),n("span",{class:"token punctuation"},"}"),n("span",{class:"token punctuation"},")"),n("span",{class:"token punctuation"},";"),t(`
...
`)])])],-1),Y=n("h4",{id:"\u62E6\u622A\u5BF9\u8BDD\u6846\u5173\u95ED",tabindex:"-1"},[t("\u62E6\u622A\u5BF9\u8BDD\u6846\u5173\u95ED "),n("a",{class:"header-anchor",href:"#\u62E6\u622A\u5BF9\u8BDD\u6846\u5173\u95ED","aria-hidden":"true"},"#")],-1),X=n("p",null,"\u901A\u8FC7 beforeHidden \u8BBE\u7F6E\u5728\u5173\u95ED\u5F39\u51FA\u6846\u65F6\u7684\u62E6\u622A\u65B9\u6CD5\u3002",-1),Z=n("div",{class:"language-vue"},[n("pre",null,[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),t("template")]),n("span",{class:"token punctuation"},">")]),t(`
  `),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),t("d-button")]),t(),n("span",{class:"token attr-name"},"variant"),n("span",{class:"token attr-value"},[n("span",{class:"token punctuation attr-equals"},"="),n("span",{class:"token punctuation"},'"'),t("common"),n("span",{class:"token punctuation"},'"')]),t(),n("span",{class:"token attr-name"},"@click"),n("span",{class:"token attr-value"},[n("span",{class:"token punctuation attr-equals"},"="),n("span",{class:"token punctuation"},'"'),t("open"),n("span",{class:"token punctuation"},'"')]),n("span",{class:"token punctuation"},">")]),t("click me!"),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"</"),t("d-button")]),n("span",{class:"token punctuation"},">")]),t(`
`),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"</"),t("template")]),n("span",{class:"token punctuation"},">")]),t(`
`),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),t("script")]),n("span",{class:"token punctuation"},">")]),n("span",{class:"token script"},[n("span",{class:"token language-javascript"},[t(`
`),n("span",{class:"token keyword"},"import"),t(),n("span",{class:"token punctuation"},"{"),t("ref"),n("span",{class:"token punctuation"},","),t(" defineComponent"),n("span",{class:"token punctuation"},","),t(" inject"),n("span",{class:"token punctuation"},","),t(" onMounted"),n("span",{class:"token punctuation"},","),t(" h"),n("span",{class:"token punctuation"},"}"),t(),n("span",{class:"token keyword"},"from"),t(),n("span",{class:"token string"},"'vue'"),n("span",{class:"token punctuation"},";"),t(`
`),n("span",{class:"token keyword"},"export"),t(),n("span",{class:"token keyword"},"default"),t(),n("span",{class:"token function"},"defineComponent"),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},"{"),t(`
    ...
    `),n("span",{class:"token keyword"},"const"),t(),n("span",{class:"token function-variable function"},"open"),t(),n("span",{class:"token operator"},"="),t(),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},")"),t(),n("span",{class:"token operator"},"=>"),t(),n("span",{class:"token punctuation"},"{"),t(`
      `),n("span",{class:"token keyword"},"const"),t(" result "),n("span",{class:"token operator"},"="),t(" dialogService"),n("span",{class:"token punctuation"},"."),n("span",{class:"token function"},"open"),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},"{"),t(`
        ...
        `),n("span",{class:"token function-variable function"},"content"),n("span",{class:"token operator"},":"),t(),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},")"),t(),n("span",{class:"token operator"},"=>"),t(),n("span",{class:"token punctuation"},"("),t(`
          ...
          `),n("span",{class:"token punctuation"},"]"),n("span",{class:"token punctuation"},")"),t(`
        `),n("span",{class:"token punctuation"},")"),n("span",{class:"token punctuation"},","),t(`
        `),n("span",{class:"token literal-property property"},"dialogtype"),n("span",{class:"token operator"},":"),t(),n("span",{class:"token string"},"'standard'"),n("span",{class:"token punctuation"},","),t(`
        `),n("span",{class:"token literal-property property"},"beforeHidden"),n("span",{class:"token operator"},":"),t(" beforeHidden"),n("span",{class:"token punctuation"},","),t(`
        `),n("span",{class:"token literal-property property"},"backdropCloseable"),n("span",{class:"token operator"},":"),t(),n("span",{class:"token boolean"},"true"),n("span",{class:"token punctuation"},","),t(`
        `),n("span",{class:"token literal-property property"},"buttons"),n("span",{class:"token operator"},":"),t(),n("span",{class:"token punctuation"},"["),n("span",{class:"token punctuation"},"{"),t(`
          `),n("span",{class:"token literal-property property"},"variant"),n("span",{class:"token operator"},":"),t(),n("span",{class:"token string"},"'primary'"),n("span",{class:"token punctuation"},","),t(`
          `),n("span",{class:"token literal-property property"},"text"),n("span",{class:"token operator"},":"),t(),n("span",{class:"token string"},"'Save'"),n("span",{class:"token punctuation"},","),t(`
          `),n("span",{class:"token function-variable function"},"handler"),n("span",{class:"token operator"},":"),t(),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},")"),t(),n("span",{class:"token operator"},"=>"),t(" result"),n("span",{class:"token punctuation"},"."),n("span",{class:"token function"},"hide"),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},")"),n("span",{class:"token punctuation"},","),t(`
        `),n("span",{class:"token punctuation"},"}"),n("span",{class:"token punctuation"},"]"),t(`
      `),n("span",{class:"token punctuation"},"}"),n("span",{class:"token punctuation"},")"),n("span",{class:"token punctuation"},";"),t(`
    `),n("span",{class:"token punctuation"},"}"),t(`
    ...
    `),n("span",{class:"token keyword"},"const"),t(),n("span",{class:"token function-variable function"},"beforeHidden"),t(),n("span",{class:"token operator"},"="),t(),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},")"),t(),n("span",{class:"token operator"},"=>"),t(),n("span",{class:"token punctuation"},"{"),t(`
      `),n("span",{class:"token keyword"},"return"),t(),n("span",{class:"token keyword"},"new"),t(),n("span",{class:"token class-name"},"Promise"),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},"("),n("span",{class:"token parameter"},"resolve"),n("span",{class:"token punctuation"},")"),t(),n("span",{class:"token operator"},"=>"),t(),n("span",{class:"token punctuation"},"{"),t(`
        `),n("span",{class:"token keyword"},"const"),t(" results "),n("span",{class:"token operator"},"="),t(" dialogService"),n("span",{class:"token punctuation"},"."),n("span",{class:"token function"},"open"),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},"{"),t(`
          `),n("span",{class:"token literal-property property"},"width"),n("span",{class:"token operator"},":"),t(),n("span",{class:"token string"},"'300px'"),n("span",{class:"token punctuation"},","),t(`
          `),n("span",{class:"token literal-property property"},"maxHeight"),n("span",{class:"token operator"},":"),t(),n("span",{class:"token string"},"'600px'"),n("span",{class:"token punctuation"},","),t(`
          ...
          `),n("span",{class:"token literal-property property"},"backdropCloseable"),n("span",{class:"token operator"},":"),t(),n("span",{class:"token boolean"},"false"),n("span",{class:"token punctuation"},","),t(`
          `),n("span",{class:"token literal-property property"},"dialogtype"),n("span",{class:"token operator"},":"),t(),n("span",{class:"token string"},"'warning'"),n("span",{class:"token punctuation"},","),t(`
          `),n("span",{class:"token literal-property property"},"buttons"),n("span",{class:"token operator"},":"),t(),n("span",{class:"token punctuation"},"["),n("span",{class:"token punctuation"},"{"),t(`
            `),n("span",{class:"token literal-property property"},"variant"),n("span",{class:"token operator"},":"),t(),n("span",{class:"token string"},"'primary'"),n("span",{class:"token punctuation"},","),t(`
            `),n("span",{class:"token literal-property property"},"text"),n("span",{class:"token operator"},":"),t(),n("span",{class:"token string"},"'Save'"),n("span",{class:"token punctuation"},","),t(`
...
`)])])],-1),U=n("h4",{id:"\u4FE1\u606F\u63D0\u793A",tabindex:"-1"},[t("\u4FE1\u606F\u63D0\u793A "),n("a",{class:"header-anchor",href:"#\u4FE1\u606F\u63D0\u793A","aria-hidden":"true"},"#")],-1),J=n("p",null,"\u5404\u79CD\u7C7B\u578B\u7684\u4FE1\u606F\u63D0\u793A\u6846\u3002",-1),Q=n("div",{class:"language-vue"},[n("pre",null,[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),t("template")]),n("span",{class:"token punctuation"},">")]),t(`
  `),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),t("div")]),t(),n("span",{class:"token attr-name"},"class"),n("span",{class:"token attr-value"},[n("span",{class:"token punctuation attr-equals"},"="),n("span",{class:"token punctuation"},'"'),t("btn-group"),n("span",{class:"token punctuation"},'"')]),n("span",{class:"token punctuation"},">")]),t(`
    `),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),t("d-button")]),t(),n("span",{class:"token attr-name"},"variant"),n("span",{class:"token attr-value"},[n("span",{class:"token punctuation attr-equals"},"="),n("span",{class:"token punctuation"},'"'),t("common"),n("span",{class:"token punctuation"},'"')]),t(),n("span",{class:"token attr-name"},"@click"),n("span",{class:"token attr-value"},[n("span",{class:"token punctuation attr-equals"},"="),n("span",{class:"token punctuation"},'"'),t("open("),n("span",{class:"token punctuation"},"'"),t("success"),n("span",{class:"token punctuation"},"'"),t(", "),n("span",{class:"token punctuation"},"'"),t("\u6210\u529F"),n("span",{class:"token punctuation"},"'"),t(", "),n("span",{class:"token punctuation"},"'"),t("Delete [Git] repository successfully."),n("span",{class:"token punctuation"},"'"),t(")"),n("span",{class:"token punctuation"},'"')]),n("span",{class:"token punctuation"},">")]),t("success"),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"</"),t("d-button")]),n("span",{class:"token punctuation"},">")]),t(`
    `),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),t("d-button")]),t(),n("span",{class:"token attr-name"},"variant"),n("span",{class:"token attr-value"},[n("span",{class:"token punctuation attr-equals"},"="),n("span",{class:"token punctuation"},'"'),t("common"),n("span",{class:"token punctuation"},'"')]),t(),n("span",{class:"token attr-name"},"@click"),n("span",{class:"token attr-value"},[n("span",{class:"token punctuation attr-equals"},"="),n("span",{class:"token punctuation"},'"'),t("open("),n("span",{class:"token punctuation"},"'"),t("failed"),n("span",{class:"token punctuation"},"'"),t(", "),n("span",{class:"token punctuation"},"'"),t("\u9519\u8BEF"),n("span",{class:"token punctuation"},"'"),t(", "),n("span",{class:"token punctuation"},"'"),t("It is failed. if you want to resolve it,please contact the supportor."),n("span",{class:"token punctuation"},"'"),t(")"),n("span",{class:"token punctuation"},'"')]),n("span",{class:"token punctuation"},">")]),t("fail"),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"</"),t("d-button")]),n("span",{class:"token punctuation"},">")]),t(`
    `),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),t("d-button")]),t(),n("span",{class:"token attr-name"},"variant"),n("span",{class:"token attr-value"},[n("span",{class:"token punctuation attr-equals"},"="),n("span",{class:"token punctuation"},'"'),t("common"),n("span",{class:"token punctuation"},'"')]),t(),n("span",{class:"token attr-name"},"@click"),n("span",{class:"token attr-value"},[n("span",{class:"token punctuation attr-equals"},"="),n("span",{class:"token punctuation"},'"'),t("open("),n("span",{class:"token punctuation"},"'"),t("warning"),n("span",{class:"token punctuation"},"'"),t(", "),n("span",{class:"token punctuation"},"'"),t("\u8B66\u544A"),n("span",{class:"token punctuation"},"'"),t(", "),n("span",{class:"token punctuation"},"'"),t("Leaving this page!"),n("span",{class:"token punctuation"},"'"),t(")"),n("span",{class:"token punctuation"},'"')]),n("span",{class:"token punctuation"},">")]),t("warning"),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"</"),t("d-button")]),n("span",{class:"token punctuation"},">")]),t(`
    `),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),t("d-button")]),t(),n("span",{class:"token attr-name"},"variant"),n("span",{class:"token attr-value"},[n("span",{class:"token punctuation attr-equals"},"="),n("span",{class:"token punctuation"},'"'),t("common"),n("span",{class:"token punctuation"},'"')]),t(),n("span",{class:"token attr-name"},"@click"),n("span",{class:"token attr-value"},[n("span",{class:"token punctuation attr-equals"},"="),n("span",{class:"token punctuation"},'"'),t("open("),n("span",{class:"token punctuation"},"'"),t("info"),n("span",{class:"token punctuation"},"'"),t(", "),n("span",{class:"token punctuation"},"'"),t("\u63D0\u793A"),n("span",{class:"token punctuation"},"'"),t(", "),n("span",{class:"token punctuation"},"'"),t("You signed in with another tab or window. Reload to refresh your session."),n("span",{class:"token punctuation"},"'"),t(")"),n("span",{class:"token punctuation"},'"')]),n("span",{class:"token punctuation"},">")]),t("info"),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"</"),t("d-button")]),n("span",{class:"token punctuation"},">")]),t(`
  ...
  `),n("span",{class:"token function"},"setup"),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},")"),t(),n("span",{class:"token punctuation"},"{"),t(`
    ...
    `),n("span",{class:"token keyword"},"const"),t(),n("span",{class:"token function-variable function"},"open"),t(),n("span",{class:"token operator"},"="),t(),n("span",{class:"token punctuation"},"("),n("span",{class:"token parameter"},[t("type"),n("span",{class:"token punctuation"},","),t(" title"),n("span",{class:"token punctuation"},","),t(" content")]),n("span",{class:"token punctuation"},")"),t(),n("span",{class:"token operator"},"=>"),t(),n("span",{class:"token punctuation"},"{"),t(`
      `),n("span",{class:"token keyword"},"const"),t(" result "),n("span",{class:"token operator"},"="),t(" dialogService"),n("span",{class:"token punctuation"},"."),n("span",{class:"token function"},"open"),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},"{"),t(`
        ...
        `),n("span",{class:"token function-variable function"},"content"),n("span",{class:"token operator"},":"),t(),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},")"),t(),n("span",{class:"token operator"},"=>"),t(),n("span",{class:"token function"},"h"),n("span",{class:"token punctuation"},"("),n("span",{class:"token string"},"'span'"),n("span",{class:"token punctuation"},","),t(),n("span",{class:"token punctuation"},"{"),n("span",{class:"token literal-property property"},"style"),n("span",{class:"token operator"},":"),t(),n("span",{class:"token punctuation"},"{"),n("span",{class:"token literal-property property"},"fontSize"),n("span",{class:"token operator"},":"),t(),n("span",{class:"token string"},"'12px'"),n("span",{class:"token punctuation"},"}"),t(),n("span",{class:"token punctuation"},"}"),n("span",{class:"token punctuation"},","),t(" content"),n("span",{class:"token punctuation"},")"),n("span",{class:"token punctuation"},","),t(`
        `),n("span",{class:"token literal-property property"},"dialogType"),n("span",{class:"token operator"},":"),t(" type"),n("span",{class:"token punctuation"},","),t(`
        `),n("span",{class:"token literal-property property"},"backdropCloseable"),n("span",{class:"token operator"},":"),t(),n("span",{class:"token boolean"},"true"),n("span",{class:"token punctuation"},","),t(`
        `),n("span",{class:"token literal-property property"},"buttons"),n("span",{class:"token operator"},":"),t(),n("span",{class:"token punctuation"},"["),n("span",{class:"token punctuation"},"{"),t(`
          `),n("span",{class:"token literal-property property"},"variant"),n("span",{class:"token operator"},":"),t(),n("span",{class:"token string"},"'primary'"),n("span",{class:"token punctuation"},","),t(`
          `),n("span",{class:"token literal-property property"},"text"),n("span",{class:"token operator"},":"),t(),n("span",{class:"token string"},"'Save'"),n("span",{class:"token punctuation"},","),t(`
        ...
        `),n("span",{class:"token function-variable function"},"content"),n("span",{class:"token operator"},":"),t(),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},")"),t(),n("span",{class:"token operator"},"=>"),t(),n("span",{class:"token punctuation"},"("),t(`
          `),n("span",{class:"token function"},"h"),n("span",{class:"token punctuation"},"("),n("span",{class:"token string"},"'div'"),n("span",{class:"token punctuation"},","),t(),n("span",{class:"token punctuation"},"{"),t(`
            `),n("span",{class:"token function"},"onMouseover"),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},")"),t(),n("span",{class:"token punctuation"},"{"),t(`
              result`),n("span",{class:"token punctuation"},"."),n("span",{class:"token function"},"updateButtonOptions"),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},"["),n("span",{class:"token punctuation"},"{"),n("span",{class:"token literal-property property"},"disabled"),n("span",{class:"token operator"},":"),t(),n("span",{class:"token boolean"},"true"),n("span",{class:"token punctuation"},"}"),n("span",{class:"token punctuation"},"]"),n("span",{class:"token punctuation"},")"),n("span",{class:"token punctuation"},";"),t(`
            `),n("span",{class:"token punctuation"},"}"),t(`
          `),n("span",{class:"token punctuation"},"}"),n("span",{class:"token punctuation"},","),t(),n("span",{class:"token punctuation"},"["),t(`
            `),n("span",{class:"token string"},"'Modal Content'"),n("span",{class:"token punctuation"},","),t(`
            `),n("span",{class:"token function"},"h"),n("span",{class:"token punctuation"},"("),n("span",{class:"token string"},"'div'"),n("span",{class:"token punctuation"},","),t(),n("span",{class:"token punctuation"},"{"),n("span",{class:"token punctuation"},"}"),n("span",{class:"token punctuation"},","),t(),n("span",{class:"token punctuation"},"["),n("span",{class:"token string"},"'name: Tom'"),n("span",{class:"token punctuation"},"]"),n("span",{class:"token punctuation"},")"),n("span",{class:"token punctuation"},","),t(`
    ...
    `),n("span",{class:"token keyword"},"const"),t(),n("span",{class:"token function-variable function"},"open"),t(),n("span",{class:"token operator"},"="),t(),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},")"),t(),n("span",{class:"token operator"},"=>"),t(),n("span",{class:"token punctuation"},"{"),t(`
      `),n("span",{class:"token keyword"},"const"),t(" result "),n("span",{class:"token operator"},"="),t(" modalservice"),n("span",{class:"token punctuation"},"."),n("span",{class:"token function"},"open"),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},"{"),t(`
        ...
        `),n("span",{class:"token literal-property property"},"buttons"),n("span",{class:"token operator"},":"),t(),n("span",{class:"token punctuation"},"["),n("span",{class:"token punctuation"},"{"),t(`
          `),n("span",{class:"token literal-property property"},"variant"),n("span",{class:"token operator"},":"),t(),n("span",{class:"token string"},"'primary'"),n("span",{class:"token punctuation"},","),t(`
          `),n("span",{class:"token literal-property property"},"text"),n("span",{class:"token operator"},":"),t(),n("span",{class:"token string"},"'Ok'"),n("span",{class:"token punctuation"},","),t(`
          `),n("span",{class:"token literal-property property"},"autofocus"),n("span",{class:"token operator"},":"),t(),n("span",{class:"token boolean"},"true"),n("span",{class:"token punctuation"},","),t(`
          `),n("span",{class:"token function-variable function"},"handler"),n("span",{class:"token operator"},":"),t(),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},")"),t(),n("span",{class:"token operator"},"=>"),t(" result"),n("span",{class:"token punctuation"},"."),n("span",{class:"token function"},"hide"),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},")"),n("span",{class:"token punctuation"},","),t(`
        `),n("span",{class:"token punctuation"},"}"),n("span",{class:"token punctuation"},","),t(),n("span",{class:"token punctuation"},"{"),t(`
          `),n("span",{class:"token literal-property property"},"variant"),n("span",{class:"token operator"},":"),t(),n("span",{class:"token string"},"'common'"),n("span",{class:"token punctuation"},","),t(`
          `),n("span",{class:"token literal-property property"},"text"),n("span",{class:"token operator"},":"),t(),n("span",{class:"token string"},"'Cancel'"),n("span",{class:"token punctuation"},","),t(`
...
`),n("span",{class:"token keyword"},"export"),t(),n("span",{class:"token keyword"},"default"),t(),n("span",{class:"token function"},"defineComponent"),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},"{"),t(`
  `),n("span",{class:"token function"},"setup"),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},")"),t(),n("span",{class:"token punctuation"},"{"),t(`
    ...
    `),n("span",{class:"token keyword"},"const"),t(),n("span",{class:"token function-variable function"},"open"),t(),n("span",{class:"token operator"},"="),t(),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},")"),t(),n("span",{class:"token operator"},"=>"),t(),n("span",{class:"token punctuation"},"{"),t(`
      `),n("span",{class:"token keyword"},"const"),t(" result "),n("span",{class:"token operator"},"="),t(" modalservice"),n("span",{class:"token punctuation"},"."),n("span",{class:"token function"},"open"),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},"{"),t(`
        `),n("span",{class:"token literal-property property"},"bodyScrollable"),n("span",{class:"token operator"},":"),t(),n("span",{class:"token boolean"},"false"),n("span",{class:"token punctuation"},","),t(`
        `),n("span",{class:"token literal-property property"},"title"),n("span",{class:"token operator"},":"),t(),n("span",{class:"token string"},"'Start Snapshot Version'"),n("span",{class:"token punctuation"},","),t(`
        `),n("span",{class:"token function-variable function"},"content"),n("span",{class:"token operator"},":"),t(),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},")"),t(),n("span",{class:"token operator"},"=>"),t(),n("span",{class:"token punctuation"},"("),t(`
          `),n("span",{class:"token function"},"h"),n("span",{class:"token punctuation"},"("),n("span",{class:"token string"},"'div'"),n("span",{class:"token punctuation"},","),t(),n("span",{class:"token punctuation"},"{"),n("span",{class:"token punctuation"},"}"),n("span",{class:"token punctuation"},","),t(),n("span",{class:"token punctuation"},"["),t(`
            `),n("span",{class:"token string"},"'Modal Content'"),n("span",{class:"token punctuation"},","),t(`
...
<\/script>
`},{highlight:y(()=>[H]),default:y(()=>[m(k)]),_:1}),P,$,m(p,{sourceCode:`<template>
  <div>\u{1F477}\u65BD\u5DE5\u4E2D</div>
</template>
<script>
import {ref, defineComponent, inject, onMounted, h} from 'vue';
...
`},{highlight:y(()=>[z]),default:y(()=>[m(E)]),_:1}),Y,X,m(p,{sourceCode:`<template>
...
`},{highlight:y(()=>[Z]),default:y(()=>[m(d)]),_:1}),U,J,m(p,{sourceCode:`<template>
  <div class="btn-group">
...
`},{highlight:y(()=>[Q]),default:y(()=>[m(g)]),_:1}),W,nn,m(p,{sourceCode:`<template>
  <d-button @click="open">\u6253\u5F00 modal</d-button>
</template>
<script>
import {ref, defineComponent, inject, onMounted, h} from 'vue';
...
<\/script>
`},{highlight:y(()=>[tn]),default:y(()=>[m(v)]),_:1}),sn,an,m(p,{sourceCode:`<template>
  <d-button @click="open">\u6253\u5F00 modal</d-button>
</template>
<script>
import {ref, defineComponent, inject, onMounted, h} from 'vue';
...
<\/script>
`},{highlight:y(()=>[en]),default:y(()=>[m(s)]),_:1}),on,un,m(p,{sourceCode:`<template>
  <d-button @click="open">\u6253\u5F00 modal</d-button>
</template>
<script>
import {ref, defineComponent, inject, onMounted, h} from 'vue';
...
<\/script>
`},{highlight:y(()=>[cn]),default:y(()=>[m(h)]),_:1}),pn])}var gn=L(K,[["render",ln]]);export{dn as __pageData,gn as default};
