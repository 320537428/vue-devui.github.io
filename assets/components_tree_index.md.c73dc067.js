var Z=Object.defineProperty;var q=Object.getOwnPropertySymbols;var T=Object.prototype.hasOwnProperty,R=Object.prototype.propertyIsEnumerable;var S=(e,t,s)=>t in e?Z(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s,_=(e,t)=>{for(var s in t||(t={}))T.call(t,s)&&S(e,s,t[s]);if(q)for(var s of q(t))R.call(t,s)&&S(e,s,t[s]);return e};import{_ as I,V as f,r as C,c as $,a as y,w as c,b as M,d as n,e as a,o as j}from"./app.437ddac7.js";const U={name:"component-doc",components:{"render-demo-0":function(){const{resolveComponent:e,createVNode:t,openBlock:s,createElementBlock:d}=f;function g(p,u){const r=e("d-tree");return s(),d("div",null,[t(r,{data:p.data},null,8,["data"])])}const{defineComponent:k,ref:l}=f,o=k({setup(){return{data:l([{label:"Parent node 1",children:[{label:"Parent node 1-1",children:[{label:"Leaf node 1-1-1"}]},{label:"Leaf node 1-2"}]},{label:"Leaf node 2"}])}}});return _({render:g},o)}(),"render-demo-1":function(){const{createElementVNode:e,resolveComponent:t,createVNode:s,renderList:d,Fragment:g,openBlock:k,createElementBlock:l,toDisplayString:o,createTextVNode:p,withCtx:u,createBlock:r,createCommentVNode:m}=f,F={class:"flex flex-row",style:{height:"28px"}},x={class:"flex items-center mr-xl"},V=e("span",{class:"inline-block mr-xs"},"\u5F00\u542F\u52FE\u9009",-1);function w(i,L){const b=t("d-switch"),h=t("d-radio"),B=t("d-radio-group"),N=t("d-tree");return k(),l("div",null,[e("div",F,[e("label",x,[V,s(b,{modelValue:i.openCheck,"onUpdate:modelValue":L[0]||(L[0]=v=>i.openCheck=v)},null,8,["modelValue"])]),i.openCheck?(k(),r(B,{key:0,modelValue:i.currentStrategy,"onUpdate:modelValue":L[1]||(L[1]=v=>i.currentStrategy=v),direction:"row"},{default:u(()=>[(k(!0),l(g,null,d(i.checkStrategy,v=>(k(),r(h,{key:v,value:v},{default:u(()=>[p(o(v),1)]),_:2},1032,["value"]))),128))]),_:1},8,["modelValue"])):m("v-if",!0)]),s(N,{data:i.data,check:i.currentStrategy},null,8,["data","check"])])}const{defineComponent:D,ref:E,watch:P}=f,A=D({setup(){const i=E(!0),L=E(["both","downward","upward","none"]),b=E("both"),h=E([{label:"Parent node 1",children:[{label:"Parent node 1-1",children:[{label:"Leaf node 1-1-1"},{label:"Leaf node 1-1-2"}]},{label:"Leaf node 1-2"}]},{label:"Leaf node 2"}]);return P(i,B=>{B===!1?b.value=!1:(b.value="both",h.value=[{label:"Parent node 1",children:[{label:"Parent node 1-1",children:[{label:"Leaf node 1-1-1"},{label:"Leaf node 1-1-2"}]},{label:"Leaf node 1-2"}]},{label:"Leaf node 2"}])}),{data:h,openCheck:i,checkStrategy:L,currentStrategy:b}}});return _({render:w},A)}(),"render-demo-2":function(){const{resolveComponent:e,createVNode:t,openBlock:s,createElementBlock:d}=f;function g(p,u){const r=e("d-tree");return s(),d("div",null,[t(r,{data:p.data,check:""},null,8,["data"])])}const{defineComponent:k,ref:l}=f,o=k({setup(){return{data:l([{label:"Parent node 1",expanded:!0,children:[{label:"Parent node 1-1",children:[{label:"Leaf node 1-1-1"}]},{label:"Leaf node 1-2",checked:!0}]},{label:"Leaf node 2",selected:!0}])}}});return _({render:g},o)}(),"render-demo-3":function(){const{resolveComponent:e,createVNode:t,openBlock:s,createElementBlock:d}=f;function g(p,u){const r=e("d-tree");return s(),d("div",null,[t(r,{data:p.data,check:""},null,8,["data"])])}const{defineComponent:k,ref:l}=f,o=k({setup(){return{data:l([{label:"Parent node 1",expanded:!0,children:[{label:"Parent node 1-1",disableToggle:!0,disableSelect:!0,disableCheck:!0,children:[{label:"Leaf node 1-1-1"}]},{label:"Leaf node 1-2",disableCheck:!0}]},{label:"Leaf node 2",disableSelect:!0}])}}});return _({render:g},o)}(),"render-demo-4":function(){const{createElementVNode:e,openBlock:t,createElementBlock:s,toDisplayString:d,createTextVNode:g,createCommentVNode:k,normalizeStyle:l,resolveComponent:o,withCtx:p,createVNode:u}=f,r={style:{"margin-right":"8px"},viewBox:"0 0 16 16",width:"16",height:"16"},m=["d"],F={key:0,class:"devui-tree-node__indent"},x=["onClick"],w=[e("path",{d:"M204.58705 951.162088 204.58705 72.836889 819.41295 511.998977Z",fill:"#8a8e99"},null,-1)];function D(i,L){const b=o("d-tree");return t(),s("div",null,[u(b,{data:i.data},{content:p(({nodeData:h})=>[(t(),s("svg",r,[e("path",{d:`${h.isLeaf?"M13,6 L9,6 L9,5 L9,2 L3,2 L3,14 L13,14 L13,6 Z M12.5857864,5 L10,2.41421356 L10,5 L12.5857864,5 Z M2,1 L10,1 L14,5 L14,15 L2,15 L2,1 Z":h.expanded?"M16,6 L14,14 L2,14 L0,6 L16,6 Z M14.7192236,7 L1.28077641,7 L2.78077641,13 L13.2192236,13 L14.7192236,7 Z M6,1 L8,3 L15,3 L15,5 L14,5 L14,4 L7.58578644,4 L5.58578644,2 L2,2 L2,5 L1,5 L1,1 L6,1 Z":"M14,6 L14,5 L7.58578644,5 L5.58578644,3 L2,3 L2,6 L14,6 Z M14,7 L2,7 L2,13 L14,13 L14,7 Z M1,2 L6,2 L8,4 L15,4 L15,14 L1,14 L1,2 Z"}`,"stroke-width":"1",fill:"#8a8e99"},null,8,m)])),g(" "+d(h.label),1)]),icon:p(({nodeData:h,toggleNode:B})=>[h.isLeaf?(t(),s("span",F)):(t(),s("span",{key:1,onClick:N=>{N.stopPropagation(),B(h)}},[(t(),s("svg",{style:l({transform:h.expanded?"rotate(90deg)":"",marginLeft:"-2.5px",marginRight:"14.5px",cursor:"pointer"}),viewBox:"0 0 1024 1024",width:"12",height:"12"},w,4))],8,x))]),_:1},8,["data"])])}const{defineComponent:E,ref:P}=f,A=E({setup(){return{data:P([{label:"Parent node 1",children:[{label:"Parent node 1-1",children:[{label:"Leaf node 1-1-1"}]},{label:"Leaf node 1-2"}]},{label:"Leaf node 2"}])}}});return _({render:D},A)}(),"render-demo-5":function(){const{resolveComponent:e,createVNode:t,openBlock:s,createElementBlock:d}=f;function g(u,r){const m=e("d-tree");return s(),d("div",null,[t(m,{data:u.data,ref:"treeRef"},null,8,["data"])])}const{defineComponent:k,ref:l,onMounted:o}=f,p=k({setup(){const u=l(null),r=l([{label:"Parent node 1",children:[{label:"Parent node 1-1",children:[{label:"Parent node 1-1-1",children:[{label:"Parent node 1-1-1-1"}]}]}]},{label:"Parent node 2",children:[{label:"Parent node 2-1",children:[{label:"Leaf node 2-1-1"},{label:"Leaf node 2-1-2"}]}]},{label:"Parent node 3",children:[{label:"Leaf node 3-1",children:[{label:"Leaf node 3-1-1",children:[{label:"Leaf node 3-1-1-1"}]}]},{label:"Leaf node 3-2"}]}]);return o(()=>{u.value.treeFactory.mergeTreeNodes(),u.value.treeFactory.expandAllNodes()}),{data:r,treeRef:u}}});return _({render:g},p)}()}},kn='{"title":"Tree \u6811","description":"","frontmatter":{},"headers":[{"level":3,"title":"\u57FA\u672C\u7528\u6CD5","slug":"\u57FA\u672C\u7528\u6CD5"},{"level":3,"title":"\u53EF\u52FE\u9009","slug":"\u53EF\u52FE\u9009"},{"level":3,"title":"\u9ED8\u8BA4\u72B6\u6001","slug":"\u9ED8\u8BA4\u72B6\u6001"},{"level":3,"title":"\u7981\u7528\u72B6\u6001","slug":"\u7981\u7528\u72B6\u6001"},{"level":3,"title":"\u81EA\u5B9A\u4E49\u56FE\u6807","slug":"\u81EA\u5B9A\u4E49\u56FE\u6807"},{"level":3,"title":"\u8282\u70B9\u5408\u5E76","slug":"\u8282\u70B9\u5408\u5E76"},{"level":3,"title":"Tree \u53C2\u6570","slug":"tree-\u53C2\u6570"},{"level":3,"title":"Tree \u63D2\u69FD","slug":"tree-\u63D2\u69FD"},{"level":3,"title":"TreeNode \u53C2\u6570","slug":"treenode-\u53C2\u6570"},{"level":3,"title":"Tree \u7C7B\u578B\u5B9A\u4E49","slug":"tree-\u7C7B\u578B\u5B9A\u4E49"}],"relativePath":"components/tree/index.md","lastUpdated":1654151003174}',z=M('<h1 id="tree-\u6811" tabindex="-1">Tree \u6811 <a class="header-anchor" href="#tree-\u6811" aria-hidden="true">#</a></h1><p>\u4E00\u79CD\u5448\u73B0\u5D4C\u5957\u7ED3\u6784\u7684\u7EC4\u4EF6\u3002</p><h4 id="\u4F55\u65F6\u4F7F\u7528" tabindex="-1">\u4F55\u65F6\u4F7F\u7528 <a class="header-anchor" href="#\u4F55\u65F6\u4F7F\u7528" aria-hidden="true">#</a></h4><p>\u6587\u4EF6\u5939\u3001\u7EC4\u7EC7\u67B6\u6784\u3001\u751F\u7269\u5206\u7C7B\u3001\u56FD\u5BB6\u5730\u533A\u7B49\u7B49\uFF0C\u4E16\u95F4\u4E07\u7269\u7684\u5927\u591A\u6570\u7ED3\u6784\u90FD\u662F\u6811\u5F62\u7ED3\u6784\u3002\u4F7F\u7528\u6811\u7EC4\u4EF6\u53EF\u4EE5\u5B8C\u6574\u5C55\u73B0\u5176\u4E2D\u7684\u5C42\u7EA7\u5173\u7CFB\uFF0C\u5E76\u5177\u6709\u5C55\u5F00/\u6536\u8D77\u3001\u9009\u62E9\u7B49\u4EA4\u4E92\u529F\u80FD\u3002</p><h3 id="\u57FA\u672C\u7528\u6CD5" tabindex="-1">\u57FA\u672C\u7528\u6CD5 <a class="header-anchor" href="#\u57FA\u672C\u7528\u6CD5" aria-hidden="true">#</a></h3>',5),G=n("div",null,"\u5C55\u793A\u5D4C\u5957\u6811\u5F62\u7ED3\u6784\u7684\u5448\u73B0\u3001\u8FDE\u63A5\u7EBF\u3001\u5C55\u5F00/\u6536\u8D77\u3001\u70B9\u51FB\u9009\u62E9\u7B49\u529F\u80FD\u3002",-1),H=n("div",{class:"language-vue"},[n("pre",null,[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),a("template")]),n("span",{class:"token punctuation"},">")]),a(`
...
</code></pre></div>`,11);function ln(e,t,s,d,g,k){const l=C("render-demo-0"),o=C("demo"),p=C("render-demo-1"),u=C("render-demo-2"),r=C("render-demo-3"),m=C("render-demo-4"),F=C("render-demo-5");return j(),$("div",null,[z,y(o,{sourceCode:`<template>
...
<\/script>
`},{description:c(()=>[W]),highlight:c(()=>[X]),default:c(()=>[y(u)]),_:1}),Y,y(o,{sourceCode:`<template>
  <d-tree :data="data" check></d-tree>
</template>
...
<\/script>
`},{description:c(()=>[nn]),highlight:c(()=>[an]),default:c(()=>[y(r)]),_:1}),tn,y(o,{sourceCode:`<template>
  <d-tree :data="data">
