...
</code></pre></div>`,11);function Q(a,o,s,e,m,v){const d=x("render-demo-0"),k=x("demo"),g=x("render-demo-1"),h=x("render-demo-2"),r=x("render-demo-3");return P(),q("div",null,[L,T,R,j,$,f(k,{sourceCode:`<template>
  <section>
