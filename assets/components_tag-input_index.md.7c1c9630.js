...
<\/script>
`},{highlight:m(()=>[A]),default:m(()=>[E(o)]),_:1}),L,E(u,{sourceCode:`<template>
  <d-tag-input
    v-model:tags="state.tags"
    v-model:suggestionList="state.suggestionList"
    :disabled="true"
...
<\/script>
`},{highlight:m(()=>[b]),default:m(()=>[E(s)]),_:1}),V])}var U=C(v,[["render",w]]);export{N as __pageData,U as default};
