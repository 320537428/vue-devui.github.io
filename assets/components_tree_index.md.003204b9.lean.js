...
</code></pre></div>`,13);function yn(p,t,c,i,h,d){const k=B("render-demo-0"),s=B("demo"),r=B("render-demo-1"),e=B("render-demo-2"),l=B("render-demo-3"),v=B("render-demo-4"),o=B("render-demo-5"),g=B("render-demo-6"),m=B("render-demo-7"),F=B("render-demo-8"),E=B("render-demo-9");return R(),T("div",null,[Z,f(s,{sourceCode:`<template>
