...
</code></pre></div>`,11);function ln(e,t,s,d,g,r){const l=C("render-demo-0"),o=C("demo"),p=C("render-demo-1"),k=C("render-demo-2"),u=C("render-demo-3"),m=C("render-demo-4"),E=C("render-demo-5");return j(),$("div",null,[z,y(o,{sourceCode:`<template>
...
<\/script>
`},{highlight:c(()=>[pn]),default:c(()=>[y(E)]),_:1}),cn])}var dn=I(U,[["render",ln]]);export{kn as __pageData,dn as default};
