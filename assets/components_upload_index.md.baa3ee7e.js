...
<span class="token punctuation">}</span>
</code></pre></div>`,11);function rn(u,e,s,i,f,l){const E=C("render-demo-0"),a=C("demo"),o=C("render-demo-1"),p=C("render-demo-2"),k=C("render-demo-3"),B=C("render-demo-4"),A=C("render-demo-5");return K(),M("div",null,[R,m(a,{sourceCode:`<template>
