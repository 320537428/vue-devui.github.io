...
`)])])],-1),G=n("h3",{id:"type",tabindex:"-1"},[a("Type "),n("a",{class:"header-anchor",href:"#type","aria-hidden":"true"},"#")],-1),H=n("p",null,"Panels have six types: default, primary, success, danger, warning, info.",-1),M=n("div",{class:"language-vue"},[n("pre",null,[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),a("template")]),n("span",{class:"token punctuation"},">")]),a(`
  ...
  `),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"</"),a("d-panel")]),n("span",{class:"token punctuation"},">")]),a(`
`),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"</"),a("template")]),n("span",{class:"token punctuation"},">")]),a(`
`)])])],-1),Y=n("h3",{id:"prevent-collapse",tabindex:"-1"},[a("Prevent Collapse "),n("a",{class:"header-anchor",href:"#prevent-collapse","aria-hidden":"true"},"#")],-1),J=n("p",null,[a("if you dont want panel to fold. You can use "),n("code",null,"beforeToggle"),a(" properties")],-1),K=n("p",null,"If beforeToggle return False. The Panel will can not to fold. But Unaffected when unfolded",-1),R=n("div",{class:"language-vue"},[n("pre",null,[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),a("template")]),n("span",{class:"token punctuation"},">")]),a(`
...
</code></pre></div>`,4);function on(e,p,s,t,o,k){const d=B("render-demo-0"),u=B("demo"),g=B("render-demo-1"),h=B("render-demo-2"),f=B("render-demo-3"),_=B("render-demo-4");return F(),z("div",null,[A,w(u,{sourceCode:`<template>
...
<\/script>
`},{highlight:T(()=>[Q]),default:T(()=>[w(d)]),_:1}),G,H,w(u,{sourceCode:`<template>
...
`},{highlight:T(()=>[M]),default:T(()=>[w(g)]),_:1}),Y,J,K,w(u,{sourceCode:`<template>
  <d-panel
    type="primary"
...
<\/script>
`},{highlight:T(()=>[R]),default:T(()=>[w(h)]),_:1}),X,w(u,{sourceCode:`<template>
  <d-panel
    type="primary"
    :before-toggle="beforeToggle"
    :is-collapsed="false"
