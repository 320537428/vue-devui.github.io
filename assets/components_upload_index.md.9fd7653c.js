var W=Object.defineProperty;var J=Object.getOwnPropertySymbols;var X=Object.prototype.hasOwnProperty,Y=Object.prototype.propertyIsEnumerable;var K=(c,u,t)=>u in c?W(c,u,{enumerable:!0,configurable:!0,writable:!0,value:t}):c[u]=t,x=(c,u)=>{for(var t in u||(u={}))X.call(u,t)&&K(c,t,u[t]);if(J)for(var t of J(u))Y.call(u,t)&&K(c,t,u[t]);return c};import{_ as Z,r as q,c as nn,b as y,w as b,a as Q,d as n,e as a,o as an,V as A}from"./app.36ea4c54.js";const sn={name:"component-doc",components:{"render-demo-0":function(){const{resolveComponent:c,createVNode:u,openBlock:t,createElementBlock:m}=A;function g(p,s){const o=c("d-upload");return t(),m("div",null,[u(o,{"upload-options":p.uploadOptions,"uploaded-files":p.uploadedFiles,"onUpdate:uploaded-files":s[0]||(s[0]=k=>p.uploadedFiles=k)},null,8,["upload-options","uploaded-files"])])}const{reactive:F,ref:l}=A;return x({render:g},{setup(){const p={name:"tom",age:11},s=l([]),o=F({uri:"http://localhost:4000/files/upload",headers:{},additionalParameter:p,maximumSize:.5,method:"POST",fileFieldName:"file",responseType:"json"});return{uploadedFiles:s,uploadOptions:o}}})}(),"render-demo-1":function(){const{resolveComponent:c,createVNode:u,openBlock:t,createElementBlock:m}=A;function g(p,s){const o=c("d-upload");return t(),m("div",null,[u(o,{"upload-options":p.uploadOptions,"uploaded-files":p.uploadedFiles,"onUpdate:uploaded-files":s[0]||(s[0]=k=>p.uploadedFiles=k),multiple:""},null,8,["upload-options","uploaded-files"])])}const{reactive:F,ref:l}=A;return x({render:g},{setup(){const p={name:"tom",age:11},s=l([]),o=F({uri:"http://localhost:4000/files/upload",headers:{},additionalParameter:p,maximumSize:2.5,method:"POST",fileFieldName:"file",responseType:"json"});return{uploadedFiles:s,uploadOptions:o}}})}(),"render-demo-2":function(){const{resolveComponent:c,createVNode:u,createTextVNode:t,withCtx:m,createElementVNode:g,openBlock:F,createElementBlock:l}=A,e={style:{"margin-top":"8px"}},p=t("Upload");function s(d,r){const D=c("d-upload"),U=c("d-button");return F(),l("div",null,[u(D,{ref:"uploadRef",accept:".png,.zip","enable-drop":!0,"upload-options":d.uploadOptions,"uploaded-files":d.uploadedFiles,"onUpdate:uploaded-files":r[0]||(r[0]=P=>d.uploadedFiles=P),"placeholder-text":"Drag files","without-btn":!0,"before-upload":d.beforeUpload,"on-success":d.onSuccess,"on-error":d.onError,onFileDrop:d.fileDrop,onFileOver:d.fileOver},null,8,["upload-options","uploaded-files","before-upload","on-success","on-error","onFileDrop","onFileOver"]),g("div",e,[u(U,{onClick:d.submit},{default:m(()=>[p]),_:1},8,["onClick"])])])}const{reactive:o,ref:k}=A;return x({render:s},{setup(){const d={name:"tom",age:11},r=k(null),D=k([]),U=o({uri:"http://localhost:4000/files/upload",headers:{},additionalParameter:d,maximumSize:.5,method:"POST",fileFieldName:"file",responseType:"json"});return{uploadedFiles:D,uploadOptions:U,uploadedFiles:D,beforeUpload:_=>(console.log("beforeUpload",_),!0),onSuccess:_=>{console.log("success",_)},onError:_=>{console.log(_)},fileDrop:_=>{console.log("fileDrop",_)},fileOver:_=>{console.log("fileOver",_)},uploadRef:r,submit:()=>{r.value.fileUpload()}}}})}(),"render-demo-3":function(){const{resolveComponent:c,createVNode:u,openBlock:t,createElementBlock:m}=A;function g(p,s){const o=c("d-upload");return t(),m("div",null,[u(o,{"upload-options":p.uploadOptions,"uploaded-files":p.uploadedFiles,"onUpdate:uploaded-files":s[0]||(s[0]=k=>p.uploadedFiles=k),"placeholder-text":"Upload","before-upload":p.beforeUpload,"on-success":p.onSuccess,"on-error":p.onError,disabled:!0},null,8,["upload-options","uploaded-files","before-upload","on-success","on-error"])])}const{reactive:F,ref:l}=A;return x({render:g},{setup(){const p={name:"tom",age:11},s=l([]),o=F({uri:"/upload",headers:{},additionalParameter:p,maximumSize:.5,method:"POST",fileFieldName:"dFile",withCredentials:!0,responseType:"json"});return{uploadedFiles:s,uploadOptions:o,beforeUpload:r=>(console.log(r),!0),onSuccess:r=>{console.log("success",r)},onError:r=>{console.log(r)}}}})}(),"render-demo-4":function(){const{resolveComponent:c,createVNode:u,openBlock:t,createElementBlock:m}=A;function g(s,o){const k=c("d-upload");return t(),m("div",null,[u(k,{accept:".xls,.xlsx,.pages,.mp3,.png","upload-options":s.uploadOptions,"uploaded-files":s.uploadedFiles,"onUpdate:uploaded-files":o[0]||(o[0]=w=>s.uploadedFiles=w),"placeholder-text":"\u9009\u62E9\u6587\u4EF6","on-success":s.onSuccess1,"on-error":s.onError,onDeleteUploadedFile:s.deleteUploadedFile,showTip:!0,uploadedFiles:s.uploadedFiles,"onUpdate:uploadedFiles":o[1]||(o[1]=w=>s.uploadedFiles=w),"auto-upload":!0,"before-upload":s.beforeUpload,multiple:""},null,8,["upload-options","uploaded-files","on-success","on-error","onDeleteUploadedFile","uploadedFiles","before-upload"])])}const{reactive:F,ref:l,watch:e}=A;return x({render:g},{setup(){const s={name:"tom",age:11},o=l([]),k=F({uri:"http://localhost:4000/files/upload",method:"post",additionalParameter:s,maximumSize:20,checkSameName:!0}),w=U=>{console.log("success",U,o)},d=U=>{console.log(U)},r=U=>{console.log("deleteUploadedFile ",U)},D=()=>(console.log("beforeUpload"),!0);return e(o,U=>{console.log("uploadedFiles ",U)}),{uploadedFiles:o,uploadOptions:k,onSuccess1:w,onError:d,deleteUploadedFile:r,beforeUpload:D}}})}(),"render-demo-5":function(){const{resolveComponent:c,createVNode:u,openBlock:t,createElementBlock:m}=A;function g(p,s){const o=c("d-upload");return t(),m("div",null,[u(o,{"upload-options":p.uploadOptions,"uploaded-files":p.uploadedFiles,"onUpdate:uploaded-files":s[0]||(s[0]=k=>p.uploadedFiles=k),"placeholder-text":"Upload","on-success":p.onSuccess,"on-error":p.onError,beforeUpload:p.beforeUpload},null,8,["upload-options","uploaded-files","on-success","on-error","beforeUpload"])])}const{reactive:F,ref:l}=A;return x({render:g},{setup(){const p={name:"tom",age:11},s=l([]),o=F({uri:"http://localhost:4000/files/upload",headers:{},additionalParameter:p,maximumSize:.5,method:"POST",fileFieldName:"file",responseType:"json"});return{uploadedFiles:s,uploadOptions:o,beforeUpload:r=>{if(!(!r||!r.length))return r[0].uploadOptions.uri="/upload2",console.log(r),!0},onSuccess:r=>{console.log("success",r)},onError:r=>{console.log(r)}}}})}(),"render-demo-6":function(){const{createTextVNode:c,resolveComponent:u,withCtx:t,createVNode:m,renderList:g,Fragment:F,openBlock:l,createElementBlock:e,toDisplayString:p,createElementVNode:s,createCommentVNode:o,createBlock:k}=A,w=c("\u9009\u53D6\u6587\u4EF6"),d={key:0,class:"table preload-files"},r={width:"50%"},D={width:"25%"},U={key:0},P={key:1},T={key:2},N={key:3},V=c(" Delete "),z={key:0,class:"table uploaded-files"},j={width:"50%"},_=s("td",{width:"25%"},[s("span",null,"Uploaded")],-1),$=c(" Delete ");function H(C,f){const S=u("d-button"),O=u("d-upload");return l(),e("div",null,[m(O,{accept:".png","upload-options":C.uploadOptions,"uploaded-files":C.uploadedFiles,"onUpdate:uploaded-files":f[0]||(f[0]=E=>C.uploadedFiles=E),"placeholder-text":"Upload","on-success":C.onSuccess,"on-error":C.onError,beforeUpload:C.beforeUpload,showTip:!0},{preloadFiles:t(E=>[E.fileUploaders.length>0?(l(),e("table",d,[(l(!0),e(F,null,g(E.fileUploaders,(h,v)=>(l(),e("tr",{key:v,class:"row"},[s("td",r,[s("span",null,p(h.file.name),1)]),s("td",D,[h.status===C.UploadStatus.preLoad?(l(),e("span",U,"preLoad")):o("v-if",!0),h.status===C.UploadStatus.uploading?(l(),e("span",P,"Uploading}")):o("v-if",!0),h.status===C.UploadStatus.uploaded?(l(),e("span",T,"Uploaded")):o("v-if",!0),h.status===C.UploadStatus.failed?(l(),e("span",N,"Upload Failed")):o("v-if",!0)]),s("td",null,[h.status!==C.UploadStatus.uploaded?(l(),k(S,{key:0,size:"xs",disabled:h.status===C.UploadStatus.uploading,onClick:i=>E.deleteFile(i)},{default:t(()=>[V]),_:2},1032,["disabled","onClick"])):o("v-if",!0)])]))),128))])):o("v-if",!0)]),uploadedFiles:t(E=>[E.uploadedFiles.length>0?(l(),e("table",z,[s("tbody",null,[(l(!0),e(F,null,g(E.uploadedFiles,(h,v)=>(l(),e("tr",{key:v,class:"row"},[s("td",j,[s("span",null,p(h.name),1)]),_,s("td",null,[m(S,{size:"xs",onClick:i=>E.deleteFile(h)},{default:t(()=>[$]),_:2},1032,["onClick"])])]))),128))])])):o("v-if",!0)]),default:t(()=>[m(S,null,{default:t(()=>[w]),_:1})]),_:1},8,["upload-options","uploaded-files","on-success","on-error","beforeUpload"])])}const{reactive:M,ref:L,watch:R}=A;return x({render:H},{setup(){const C={name:"tom",age:11},f=L({preLoad:0,uploading:1,uploaded:2,failed:3}),S=L([]),O=M({uri:"http://localhost:4000/files/upload",headers:{},additionalParameter:C,maximumSize:.5,method:"POST",fileFieldName:"file",responseType:"json"}),E=i=>(console.log(i),!0),h=i=>{console.log("success",i)},v=i=>{console.log(i)};return R(S,(i,B)=>{console.log("uploadedFiles",{newValue:i,oldValue:B})}),{uploadedFiles:S,uploadOptions:O,beforeUpload:E,onSuccess:h,onError:v,UploadStatus:f}}})}(),"render-demo-7":function(){const{resolveComponent:c,createVNode:u,createElementVNode:t,createTextVNode:m,renderList:g,Fragment:F,openBlock:l,createElementBlock:e,toDisplayString:p,createCommentVNode:s,withCtx:o,createBlock:k}=A,w={class:"upload-trigger"},d=t("div",{style:{marginTop:"20px"}},[m(" \u5C06\u6587\u4EF6\u62D6\u5230\u6B64\u5904\uFF0C\u6216 "),t("span",{class:"link"},"\u70B9\u51FB\u4E0A\u4F20")],-1),r={key:0,class:"table preload-files"},D={width:"50%"},U={width:"25%"},P={key:0},T={key:1},N={key:2},V={key:3},z=m(" Delete "),j={key:0,class:"table uploaded-files"},_={width:"50%"},$=t("td",{width:"25%"},[t("span",null,"Uploaded")],-1),H=m(" Delete ");function M(f,S){const O=c("d-icon"),E=c("d-button"),h=c("d-upload");return l(),e("div",null,[u(h,{accept:".png","upload-options":f.uploadOptions,"uploaded-files":f.uploadedFiles,"onUpdate:uploaded-files":S[0]||(S[0]=v=>f.uploadedFiles=v),"placeholder-text":"Upload","on-success":f.onSuccess,"on-error":f.onError,beforeUpload:f.beforeUpload,showTip:!0,withoutBtn:!0,class:"upload-demo",autoUpload:!0,"enable-drop":!0},{preloadFiles:o(v=>[v.fileUploaders.length>0?(l(),e("table",r,[(l(!0),e(F,null,g(v.fileUploaders,(i,B)=>(l(),e("tr",{key:B,class:"row"},[t("td",D,[t("span",null,p(i.file.name),1)]),t("td",U,[i.status===f.UploadStatus.preLoad?(l(),e("span",P,"preLoad")):s("v-if",!0),i.status===f.UploadStatus.uploading?(l(),e("span",T,"Uploading")):s("v-if",!0),i.status===f.UploadStatus.uploaded?(l(),e("span",N,"Uploaded")):s("v-if",!0),i.status===f.UploadStatus.failed?(l(),e("span",V,"Upload Failed")):s("v-if",!0)]),t("td",null,[i.status!==f.UploadStatus.uploaded?(l(),k(E,{key:0,size:"xs",disabled:i.status===f.UploadStatus.uploading,onClick:I=>v.deleteFile(I)},{default:o(()=>[z]),_:2},1032,["disabled","onClick"])):s("v-if",!0)])]))),128))])):s("v-if",!0)]),uploadedFiles:o(v=>[v.uploadedFiles.length>0?(l(),e("table",j,[t("tbody",null,[(l(!0),e(F,null,g(v.uploadedFiles,(i,B)=>(l(),e("tr",{key:B,class:"row"},[t("td",_,[t("span",null,p(i.name),1)]),$,t("td",null,[u(E,{size:"xs",onClick:I=>v.deleteFile(i)},{default:o(()=>[H]),_:2},1032,["onClick"])])]))),128))])])):s("v-if",!0)]),default:o(()=>[t("div",w,[t("div",null,[u(O,{name:"upload",size:"24px"})]),d])]),_:1},8,["upload-options","uploaded-files","on-success","on-error","beforeUpload"])])}const{reactive:L,ref:R,watch:G}=A;return x({render:M},{setup(){const f={name:"tom",age:11},S=R({preLoad:0,uploading:1,uploaded:2,failed:3}),O=R([{name:"food.jpeg",url:"https://devui.design/home"},{name:"food2.jpeg",url:"https://devui.design/home"}]),E=L({uri:"http://localhost:4000/files/upload",headers:{},additionalParameter:f,maximumSize:.5,method:"POST",fileFieldName:"file",responseType:"json"}),h=B=>(console.log(B),!0),v=B=>{console.log("success",B)},i=B=>{console.log(B)};return G(O,(B,I)=>{console.log("uploadedFiles",{newValue:B,oldValue:I})}),{uploadedFiles:O,uploadOptions:E,beforeUpload:h,onSuccess:v,onError:i,UploadStatus:S}}})}()}},_n='{"title":"Upload \u4E0A\u4F20","description":"","frontmatter":{},"headers":[{"level":3,"title":"\u4F55\u65F6\u4F7F\u7528","slug":"\u4F55\u65F6\u4F7F\u7528"},{"level":3,"title":"\u57FA\u672C\u7528\u6CD5","slug":"\u57FA\u672C\u7528\u6CD5"},{"level":3,"title":"\u81EA\u52A8\u4E0A\u4F20","slug":"\u81EA\u52A8\u4E0A\u4F20"},{"level":3,"title":"\u52A8\u6001\u4E0A\u4F20\u53C2\u6570","slug":"\u52A8\u6001\u4E0A\u4F20\u53C2\u6570"},{"level":3,"title":"\u4EFB\u610F\u533A\u57DF\u4E0A\u4F20","slug":"\u4EFB\u610F\u533A\u57DF\u4E0A\u4F20"},{"level":3,"title":"API","slug":"api"},{"level":3,"title":"slot","slug":"slot"},{"level":3,"title":"\u63A5\u53E3 & \u7C7B\u578B\u5B9A\u4E49","slug":"\u63A5\u53E3-\u7C7B\u578B\u5B9A\u4E49"},{"level":3,"title":"IUploadOptions","slug":"iuploadoptions"}],"relativePath":"components/upload/index.md","lastUpdated":1646724462148}',tn=Q('<h1 id="upload-\u4E0A\u4F20" tabindex="-1">Upload \u4E0A\u4F20 <a class="header-anchor" href="#upload-\u4E0A\u4F20" aria-hidden="true">#</a></h1><p>\u6587\u4EF6\u4E0A\u4F20\u7EC4\u4EF6\u3002</p><h3 id="\u4F55\u65F6\u4F7F\u7528" tabindex="-1">\u4F55\u65F6\u4F7F\u7528 <a class="header-anchor" href="#\u4F55\u65F6\u4F7F\u7528" aria-hidden="true">#</a></h3><p>\u5F53\u9700\u8981\u5C06\u6587\u4EF6\u4E0A\u4F20\u5230\u540E\u7AEF\u670D\u52A1\u5668\u65F6\u3002</p><h3 id="\u57FA\u672C\u7528\u6CD5" tabindex="-1">\u57FA\u672C\u7528\u6CD5 <a class="header-anchor" href="#\u57FA\u672C\u7528\u6CD5" aria-hidden="true">#</a></h3><p>\u5355\u6587\u4EF6\u4E0A\u4F20\u3001\u591A\u6587\u4EF6\u4E0A\u4F20\u3001\u62D6\u52A8\u6587\u4EF6\u4E0A\u4F20\u3001\u7981\u6B62\u4E0A\u4F20\u3002</p><h4>Basic Usage</h4>',7),on=n("div",{class:"language-vue"},[n("pre",null,[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),a("template")]),n("span",{class:"token punctuation"},">")]),a(`
...
`),n("span",{class:"token keyword"},"export"),a(),n("span",{class:"token keyword"},"default"),a(),n("span",{class:"token punctuation"},"{"),a(`
  `),n("span",{class:"token function"},"setup"),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},")"),a(),n("span",{class:"token punctuation"},"{"),a(`
    `),n("span",{class:"token keyword"},"const"),a(" additionalParameter "),n("span",{class:"token operator"},"="),a(),n("span",{class:"token punctuation"},"{"),a(),n("span",{class:"token literal-property property"},"name"),n("span",{class:"token operator"},":"),a(),n("span",{class:"token string"},"'tom'"),n("span",{class:"token punctuation"},","),a(),n("span",{class:"token literal-property property"},"age"),n("span",{class:"token operator"},":"),a(),n("span",{class:"token number"},"11"),a(),n("span",{class:"token punctuation"},"}"),a(`
    ...
    `),n("span",{class:"token keyword"},"const"),a(" uploadOptions "),n("span",{class:"token operator"},"="),a(),n("span",{class:"token function"},"reactive"),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},"{"),a(`
      `),n("span",{class:"token literal-property property"},"uri"),n("span",{class:"token operator"},":"),a(),n("span",{class:"token string"},"'http://localhost:4000/files/upload'"),n("span",{class:"token punctuation"},","),a(`
      `),n("span",{class:"token literal-property property"},"headers"),n("span",{class:"token operator"},":"),a(),n("span",{class:"token punctuation"},"{"),n("span",{class:"token punctuation"},"}"),n("span",{class:"token punctuation"},","),a(`
      additionalParameter`),n("span",{class:"token punctuation"},","),a(`
      `),n("span",{class:"token literal-property property"},"maximumSize"),n("span",{class:"token operator"},":"),a(),n("span",{class:"token number"},"0.5"),n("span",{class:"token punctuation"},","),a(`
      ...
      `),n("span",{class:"token literal-property property"},"fileFieldName"),n("span",{class:"token operator"},":"),a(),n("span",{class:"token string"},"'file'"),n("span",{class:"token punctuation"},","),a(`
      `),n("span",{class:"token literal-property property"},"responseType"),n("span",{class:"token operator"},":"),a(),n("span",{class:"token string"},"'json'"),a(`
...
`),n("span",{class:"token keyword"},"export"),a(),n("span",{class:"token keyword"},"default"),a(),n("span",{class:"token punctuation"},"{"),a(`
  `),n("span",{class:"token function"},"setup"),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},")"),a(),n("span",{class:"token punctuation"},"{"),a(`
    ...
    `),n("span",{class:"token keyword"},"const"),a(" uploadOptions "),n("span",{class:"token operator"},"="),a(),n("span",{class:"token function"},"reactive"),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},"{"),a(`
      ...
      `),n("span",{class:"token literal-property property"},"headers"),n("span",{class:"token operator"},":"),a(),n("span",{class:"token punctuation"},"{"),n("span",{class:"token punctuation"},"}"),n("span",{class:"token punctuation"},","),a(`
      additionalParameter`),n("span",{class:"token punctuation"},","),a(`
      `),n("span",{class:"token literal-property property"},"maximumSize"),n("span",{class:"token operator"},":"),a(),n("span",{class:"token number"},"2.5"),n("span",{class:"token punctuation"},","),a(`
      `),n("span",{class:"token literal-property property"},"method"),n("span",{class:"token operator"},":"),a(),n("span",{class:"token string"},"'POST'"),n("span",{class:"token punctuation"},","),a(`
      `),n("span",{class:"token literal-property property"},"fileFieldName"),n("span",{class:"token operator"},":"),a(),n("span",{class:"token string"},"'file'"),n("span",{class:"token punctuation"},","),a(`
      `),n("span",{class:"token literal-property property"},"responseType"),n("span",{class:"token operator"},":"),a(),n("span",{class:"token string"},"'json'"),a(`
    `),n("span",{class:"token punctuation"},"}"),n("span",{class:"token punctuation"},")"),a(`
...
`),n("span",{class:"token punctuation"},"}"),a(`
`)])]),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"</"),a("script")]),n("span",{class:"token punctuation"},">")]),a(`
`)])])],-1),ln=n("h4",null,"Dragdrop",-1),un=n("div",{class:"language-vue"},[n("pre",null,[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),a("template")]),n("span",{class:"token punctuation"},">")]),a(`
...
`),n("span",{class:"token keyword"},"export"),a(),n("span",{class:"token keyword"},"default"),a(),n("span",{class:"token punctuation"},"{"),a(`
  `),n("span",{class:"token function"},"setup"),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},")"),a(),n("span",{class:"token punctuation"},"{"),a(`
    ...
    `),n("span",{class:"token keyword"},"const"),a(" uploadedFiles "),n("span",{class:"token operator"},"="),a(),n("span",{class:"token function"},"ref"),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},"["),n("span",{class:"token punctuation"},"]"),n("span",{class:"token punctuation"},")"),a(`
    `),n("span",{class:"token keyword"},"const"),a(" uploadOptions "),n("span",{class:"token operator"},"="),a(),n("span",{class:"token function"},"reactive"),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},"{"),a(`
      `),n("span",{class:"token literal-property property"},"uri"),n("span",{class:"token operator"},":"),a(),n("span",{class:"token string"},"'/upload'"),n("span",{class:"token punctuation"},","),a(`
      `),n("span",{class:"token literal-property property"},"headers"),n("span",{class:"token operator"},":"),a(),n("span",{class:"token punctuation"},"{"),n("span",{class:"token punctuation"},"}"),n("span",{class:"token punctuation"},","),a(`
      additionalParameter`),n("span",{class:"token punctuation"},","),a(`
      `),n("span",{class:"token literal-property property"},"maximumSize"),n("span",{class:"token operator"},":"),a(),n("span",{class:"token number"},"0.5"),n("span",{class:"token punctuation"},","),a(`
      `),n("span",{class:"token literal-property property"},"method"),n("span",{class:"token operator"},":"),a(),n("span",{class:"token string"},"'POST'"),n("span",{class:"token punctuation"},","),a(`
      `),n("span",{class:"token literal-property property"},"fileFieldName"),n("span",{class:"token operator"},":"),a(),n("span",{class:"token string"},"'dFile'"),n("span",{class:"token punctuation"},","),a(`
      `),n("span",{class:"token literal-property property"},"withCredentials"),n("span",{class:"token operator"},":"),a(),n("span",{class:"token boolean"},"true"),n("span",{class:"token punctuation"},","),a(`
      `),n("span",{class:"token literal-property property"},"responseType"),n("span",{class:"token operator"},":"),a(),n("span",{class:"token string"},"'json'"),a(`
    `),n("span",{class:"token punctuation"},"}"),n("span",{class:"token punctuation"},")"),a(`
    `),n("span",{class:"token keyword"},"const"),a(),n("span",{class:"token function-variable function"},"beforeUpload"),a(),n("span",{class:"token operator"},"="),a(),n("span",{class:"token punctuation"},"("),n("span",{class:"token parameter"},"file"),n("span",{class:"token punctuation"},")"),a(),n("span",{class:"token operator"},"=>"),a(),n("span",{class:"token punctuation"},"{"),a(`
...
`),n("span",{class:"token keyword"},"export"),a(),n("span",{class:"token keyword"},"default"),a(),n("span",{class:"token punctuation"},"{"),a(`
  `),n("span",{class:"token function"},"setup"),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},")"),a(),n("span",{class:"token punctuation"},"{"),a(`
    ...
    `),n("span",{class:"token keyword"},"const"),a(" uploadOptions "),n("span",{class:"token operator"},"="),a(),n("span",{class:"token function"},"reactive"),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},"{"),a(`
      `),n("span",{class:"token literal-property property"},"uri"),n("span",{class:"token operator"},":"),a(),n("span",{class:"token string"},"'http://localhost:4000/files/upload'"),n("span",{class:"token punctuation"},","),a(`
      `),n("span",{class:"token literal-property property"},"method"),n("span",{class:"token operator"},":"),a(),n("span",{class:"token string"},"'post'"),n("span",{class:"token punctuation"},","),a(`
      `),n("span",{class:"token literal-property property"},"additionalParameter"),n("span",{class:"token operator"},":"),a(" additionalParameter"),n("span",{class:"token punctuation"},","),a(`
      `),n("span",{class:"token literal-property property"},"maximumSize"),n("span",{class:"token operator"},":"),a(),n("span",{class:"token number"},"20"),n("span",{class:"token punctuation"},","),a(`
      `),n("span",{class:"token literal-property property"},"checkSameName"),n("span",{class:"token operator"},":"),a(),n("span",{class:"token boolean"},"true"),a(`
    `),n("span",{class:"token punctuation"},"}"),n("span",{class:"token punctuation"},")"),a(`
...
`)])])],-1),vn=n("h3",{id:"\u4EFB\u610F\u533A\u57DF\u4E0A\u4F20",tabindex:"-1"},[a("\u4EFB\u610F\u533A\u57DF\u4E0A\u4F20 "),n("a",{class:"header-anchor",href:"#\u4EFB\u610F\u533A\u57DF\u4E0A\u4F20","aria-hidden":"true"},"#")],-1),En=n("p",null,"\u7528\u6237\u53EF\u901A\u8FC7\u9ED8\u8BA4 slot \u652F\u6301\u6587\u4EF6\u4EFB\u610F\u533A\u57DF\u4E0A\u4F20\u3002",-1),hn=n("div",{class:"language-vue"},[n("pre",null,[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),a("template")]),n("span",{class:"token punctuation"},">")]),a(`
  `),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),a("d-upload")]),a(`
    ...
    `),n("span",{class:"token attr-name"},":showTip"),n("span",{class:"token attr-value"},[n("span",{class:"token punctuation attr-equals"},"="),n("span",{class:"token punctuation"},'"'),a("true"),n("span",{class:"token punctuation"},'"')]),a(`
  `),n("span",{class:"token punctuation"},">")]),a(`
    `),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),a("d-button")]),n("span",{class:"token punctuation"},">")]),a("\u9009\u53D6\u6587\u4EF6"),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"</"),a("d-button")]),n("span",{class:"token punctuation"},">")]),a(`
...
`),n("span",{class:"token keyword"},"export"),a(),n("span",{class:"token keyword"},"default"),a(),n("span",{class:"token punctuation"},"{"),a(`
  `),n("span",{class:"token function"},"setup"),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},")"),a(),n("span",{class:"token punctuation"},"{"),a(`
    ...
    `),n("span",{class:"token keyword"},"const"),a(" UploadStatus "),n("span",{class:"token operator"},"="),a(),n("span",{class:"token function"},"ref"),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},"{"),a(`
      `),n("span",{class:"token literal-property property"},"preLoad"),n("span",{class:"token operator"},":"),a(),n("span",{class:"token number"},"0"),n("span",{class:"token punctuation"},","),a(`
      `),n("span",{class:"token literal-property property"},"uploading"),n("span",{class:"token operator"},":"),a(),n("span",{class:"token number"},"1"),n("span",{class:"token punctuation"},","),a(`
      `),n("span",{class:"token literal-property property"},"uploaded"),n("span",{class:"token operator"},":"),a(),n("span",{class:"token number"},"2"),n("span",{class:"token punctuation"},","),a(`
      `),n("span",{class:"token literal-property property"},"failed"),n("span",{class:"token operator"},":"),a(),n("span",{class:"token number"},"3"),a(`
    `),n("span",{class:"token punctuation"},"}"),n("span",{class:"token punctuation"},")"),a(`
    `),n("span",{class:"token keyword"},"const"),a(" uploadedFiles "),n("span",{class:"token operator"},"="),a(),n("span",{class:"token function"},"ref"),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},"["),n("span",{class:"token punctuation"},"]"),n("span",{class:"token punctuation"},")"),a(`
    `),n("span",{class:"token keyword"},"const"),a(" uploadOptions "),n("span",{class:"token operator"},"="),a(),n("span",{class:"token function"},"reactive"),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},"{"),a(`
      `),n("span",{class:"token literal-property property"},"uri"),n("span",{class:"token operator"},":"),a(),n("span",{class:"token string"},"'http://localhost:4000/files/upload'"),n("span",{class:"token punctuation"},","),a(`
...
`),n("span",{class:"token punctuation"},"}"),a(`
`)])]),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"</"),a("script")]),n("span",{class:"token punctuation"},">")]),a(`
`)])])],-1),yn=n("p",null,"\u81EA\u5B9A\u4E49\u9ED8\u8BA4 slot\uFF0C\u521D\u59CB\u663E\u793A\u5DF2\u4E0A\u4F20\u6587\u4EF6\u3002",-1),bn=n("div",{class:"language-vue"},[n("pre",null,[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),a("template")]),n("span",{class:"token punctuation"},">")]),a(`
  `),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),a("d-upload")]),a(`
    `),n("span",{class:"token attr-name"},"accept"),n("span",{class:"token attr-value"},[n("span",{class:"token punctuation attr-equals"},"="),n("span",{class:"token punctuation"},'"'),a(".png"),n("span",{class:"token punctuation"},'"')]),a(`
    `),n("span",{class:"token attr-name"},":upload-options"),n("span",{class:"token attr-value"},[n("span",{class:"token punctuation attr-equals"},"="),n("span",{class:"token punctuation"},'"'),a("uploadOptions"),n("span",{class:"token punctuation"},'"')]),a(`
    `),n("span",{class:"token attr-name"},[n("span",{class:"token namespace"},"v-model:"),a("uploaded-files")]),n("span",{class:"token attr-value"},[n("span",{class:"token punctuation attr-equals"},"="),n("span",{class:"token punctuation"},'"'),a("uploadedFiles"),n("span",{class:"token punctuation"},'"')]),a(`
  ...
  `),n("span",{class:"token function"},"setup"),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},")"),a(),n("span",{class:"token punctuation"},"{"),a(`
    ...
    `),n("span",{class:"token keyword"},"const"),a(" uploadedFiles "),n("span",{class:"token operator"},"="),a(),n("span",{class:"token function"},"ref"),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},"["),a(`
      `),n("span",{class:"token punctuation"},"{"),a(`
        ...
        `),n("span",{class:"token literal-property property"},"url"),n("span",{class:"token operator"},":"),a(),n("span",{class:"token string"},"'https://devui.design/home'"),a(`
      `),n("span",{class:"token punctuation"},"}"),n("span",{class:"token punctuation"},","),a(`
      `),n("span",{class:"token punctuation"},"{"),a(`
...
</code></pre></div>`,10);function Un(c,u,t,m,g,F){const l=q("render-demo-0"),e=q("demo"),p=q("render-demo-1"),s=q("render-demo-2"),o=q("render-demo-3"),k=q("render-demo-4"),w=q("render-demo-5"),d=q("render-demo-6"),r=q("render-demo-7");return an(),nn("div",null,[tn,y(e,{sourceCode:`<template>
...
<\/script>
`},{highlight:b(()=>[on]),default:b(()=>[y(l)]),_:1}),en,y(e,{sourceCode:`<template>
...
<\/script>
`},{highlight:b(()=>[pn]),default:b(()=>[y(p)]),_:1}),ln,y(e,{sourceCode:`<template>
  <d-upload
    ref="uploadRef"
    accept=".png,.zip"
    :enable-drop="true"
...
<\/script>
`},{highlight:b(()=>[un]),default:b(()=>[y(s)]),_:1}),cn,y(e,{sourceCode:`<template>
  <d-upload
    :upload-options="uploadOptions"
    v-model:uploaded-files="uploadedFiles"
...
<\/script>
`},{highlight:b(()=>[rn]),default:b(()=>[y(o)]),_:1}),kn,dn,y(e,{sourceCode:`<template>
  <d-upload
...
<\/script>
`},{highlight:b(()=>[mn]),default:b(()=>[y(k)]),_:1}),fn,gn,y(e,{sourceCode:`<template>
  <d-upload
    :upload-options="uploadOptions"
    v-model:uploaded-files="uploadedFiles"
    placeholder-text="Upload"
...
<\/script>
`},{highlight:b(()=>[Fn]),default:b(()=>[y(w)]),_:1}),vn,En,y(e,{sourceCode:`<template>
  <d-upload
    accept=".png"
    :upload-options="uploadOptions"
    v-model:uploaded-files="uploadedFiles"
...
<\/script>
`},{highlight:b(()=>[hn]),default:b(()=>[y(d)]),_:1}),yn,y(e,{sourceCode:`<template>
  <d-upload
    accept=".png"
    :upload-options="uploadOptions"
    v-model:uploaded-files="uploadedFiles"
...
`},{highlight:b(()=>[bn]),default:b(()=>[y(r)]),_:1}),An])}var Bn=Z(sn,[["render",Un]]);export{_n as __pageData,Bn as default};
