import{V as y}from"./framework.3495a366.js";import{_ as T,f as _,G as I,H as P,b as f,a1 as u,a3 as q,I as n,k as a}from"./plugin-vue_export-helper.ebedbb15.js";import"./framework.d333a127.js";const R={name:"component-doc",components:{"render-demo-0":function(){const{resolveComponent:p,createVNode:s,openBlock:c,createElementBlock:i}=y;function h(r,e){const l=p("d-tree");return c(),i("div",null,[s(l,{data:r.data},null,8,["data"])])}const{defineComponent:d,ref:k}=y,t=d({setup(){return{data:k([{label:"Parent node 1",children:[{label:"Parent node 1-1",children:[{label:"Leaf node 1-1-1"}]},{label:"Leaf node 1-2"}]},{label:"Leaf node 2"}])}}});return{render:h,...t}}(),"render-demo-1":function(){const{resolveComponent:p,createVNode:s,openBlock:c,createElementBlock:i}=y;function h(r,e){const l=p("d-tree");return c(),i("div",null,[s(l,{data:r.data,onLazyLoad:r.lazyLoad},null,8,["data","onLazyLoad"])])}const{defineComponent:d,ref:k}=y,t=d({setup(){return{data:k([{label:"Parent node 1",children:[{label:"Parent node 1-1 - dynamic loading",isLeaf:!1},{label:"Leaf node 1-2"}]},{label:"Leaf node 2 - dynamic loading",isLeaf:!1}]),lazyLoad:(l,v)=>{setTimeout(()=>{v({treeItems:[{label:"child node 1",expanded:!0,children:[{label:"child node 1-1"},{label:"child node 1-2"}]},{label:"child node 2",children:[{label:"child node 2-1"}]}],node:l})},500)}}}});return{render:h,...t}}(),"render-demo-2":function(){const{createElementVNode:p,resolveComponent:s,createVNode:c,renderList:i,Fragment:h,openBlock:d,createElementBlock:k,toDisplayString:t,createTextVNode:r,withCtx:e,createBlock:l,createCommentVNode:v}=y,o={class:"flex flex-row",style:{height:"28px"}},g={class:"flex items-center mr-xl"},m=p("span",{class:"inline-block mr-xs"},"\u5F00\u542F\u52FE\u9009",-1);function E(b,w){const S=s("d-switch"),B=s("d-radio"),N=s("d-radio-group"),V=s("d-tree");return d(),k("div",null,[p("div",o,[p("label",g,[m,c(S,{modelValue:b.openCheck,"onUpdate:modelValue":w[0]||(w[0]=D=>b.openCheck=D)},null,8,["modelValue"])]),b.openCheck?(d(),l(N,{key:0,modelValue:b.currentStrategy,"onUpdate:modelValue":w[1]||(w[1]=D=>b.currentStrategy=D),direction:"row"},{default:e(()=>[(d(!0),k(h,null,i(b.checkStrategy,D=>(d(),l(B,{key:D,value:D},{default:e(()=>[r(t(D),1)]),_:2},1032,["value"]))),128))]),_:1},8,["modelValue"])):v("v-if",!0)]),c(V,{data:b.data,check:b.currentStrategy,onToggleChange:b.toggleChange,onCheckChange:b.checkChange,onSelectChange:b.selectChange,onNodeClick:b.nodeClick},null,8,["data","check","onToggleChange","onCheckChange","onSelectChange","onNodeClick"])])}const{defineComponent:C,ref:L,watch:F}=y,A=C({setup(){const b=L(!0),w=L(["both","downward","upward","none"]),S=L("both"),B=L([{label:"Parent node 1",children:[{label:"Parent node 1-1",children:[{label:"Leaf node 1-1-1"},{label:"Leaf node 1-1-2"}]},{label:"Leaf node 1-2"}]},{label:"Leaf node 2"}]);return F(b,x=>{x===!1?S.value=!1:(S.value="both",B.value=[{label:"Parent node 1",children:[{label:"Parent node 1-1",children:[{label:"Leaf node 1-1-1"},{label:"Leaf node 1-1-2"}]},{label:"Leaf node 1-2"}]},{label:"Leaf node 2"}])}),{data:B,openCheck:b,checkStrategy:w,currentStrategy:S,toggleChange:x=>{console.log("toggleChange node:",x)},checkChange:x=>{console.log("checkChange node:",x)},selectChange:x=>{console.log("selectChange node:",x)},nodeClick:x=>{console.log("nodeClick node:",x)}}}});return{render:E,...A}}(),"render-demo-3":function(){const{resolveComponent:p,createVNode:s,openBlock:c,createElementBlock:i}=y;function h(r,e){const l=p("d-tree");return c(),i("div",null,[s(l,{data:r.data,check:""},null,8,["data"])])}const{defineComponent:d,ref:k}=y,t=d({setup(){return{data:k([{label:"Parent node 1",expanded:!0,children:[{label:"Parent node 1-1",children:[{label:"Leaf node 1-1-1"}]},{label:"Leaf node 1-2",checked:!0}]},{label:"Leaf node 2",selected:!0}])}}});return{render:h,...t}}(),"render-demo-4":function(){const{resolveComponent:p,createVNode:s,openBlock:c,createElementBlock:i}=y;function h(r,e){const l=p("d-tree");return c(),i("div",null,[s(l,{data:r.data,check:""},null,8,["data"])])}const{defineComponent:d,ref:k}=y,t=d({setup(){return{data:k([{label:"Parent node 1",expanded:!0,children:[{label:"Parent node 1-1",disableToggle:!0,disableSelect:!0,disableCheck:!0,children:[{label:"Leaf node 1-1-1"}]},{label:"Leaf node 1-2",disableCheck:!0}]},{label:"Leaf node 2",disableSelect:!0}])}}});return{render:h,...t}}(),"render-demo-5":function(){const{createElementVNode:p,openBlock:s,createElementBlock:c,toDisplayString:i,createTextVNode:h,createCommentVNode:d,normalizeStyle:k,resolveComponent:t,withCtx:r,createVNode:e}=y,l={style:{"margin-right":"8px"},viewBox:"0 0 16 16",width:"16",height:"16"},v=["d"],o={key:0,class:"devui-tree-node__indent"},g=["onClick"],E=[p("path",{d:"M204.58705 951.162088 204.58705 72.836889 819.41295 511.998977Z",fill:"#8a8e99"},null,-1)];function C(b,w){const S=t("d-tree");return s(),c("div",null,[e(S,{data:b.data},{content:r(({nodeData:B})=>[(s(),c("svg",l,[p("path",{d:`${B.isLeaf?"M13,6 L9,6 L9,5 L9,2 L3,2 L3,14 L13,14 L13,6 Z M12.5857864,5 L10,2.41421356 L10,5 L12.5857864,5 Z M2,1 L10,1 L14,5 L14,15 L2,15 L2,1 Z":B.expanded?"M16,6 L14,14 L2,14 L0,6 L16,6 Z M14.7192236,7 L1.28077641,7 L2.78077641,13 L13.2192236,13 L14.7192236,7 Z M6,1 L8,3 L15,3 L15,5 L14,5 L14,4 L7.58578644,4 L5.58578644,2 L2,2 L2,5 L1,5 L1,1 L6,1 Z":"M14,6 L14,5 L7.58578644,5 L5.58578644,3 L2,3 L2,6 L14,6 Z M14,7 L2,7 L2,13 L14,13 L14,7 Z M1,2 L6,2 L8,4 L15,4 L15,14 L1,14 L1,2 Z"}`,"stroke-width":"1",fill:"#8a8e99"},null,8,v)])),h(" "+i(B.label),1)]),icon:r(({nodeData:B,toggleNode:N})=>[B.isLeaf?(s(),c("span",o)):(s(),c("span",{key:1,onClick:V=>{V.stopPropagation(),N(B)}},[(s(),c("svg",{style:k({transform:B.expanded?"rotate(90deg)":"",marginLeft:"-2.5px",marginRight:"14.5px",cursor:"pointer"}),viewBox:"0 0 1024 1024",width:"12",height:"12"},E,4))],8,g))]),_:1},8,["data"])])}const{defineComponent:L,ref:F}=y,A=L({setup(){return{data:F([{label:"Parent node 1",children:[{label:"Parent node 1-1",children:[{label:"Leaf node 1-1-1"}]},{label:"Leaf node 1-2"}]},{label:"Leaf node 2"}])}}});return{render:C,...A}}(),"render-demo-6":function(){const{resolveComponent:p,createVNode:s,openBlock:c,createElementBlock:i}=y;function h(e,l){const v=p("d-tree");return c(),i("div",null,[s(v,{data:e.data,ref:"treeRef"},null,8,["data"])])}const{defineComponent:d,ref:k,onMounted:t}=y,r=d({setup(){const e=k(null),l=k([{label:"Parent node 1",children:[{label:"Parent node 1-1",children:[{label:"Parent node 1-1-1",children:[{label:"Parent node 1-1-1-1"}]}]}]},{label:"Parent node 2",children:[{label:"Parent node 2-1",children:[{label:"Leaf node 2-1-1"},{label:"Leaf node 2-1-2"}]}]},{label:"Parent node 3",children:[{label:"Leaf node 3-1",children:[{label:"Leaf node 3-1-1",children:[{label:"Leaf node 3-1-1-1"}]}]},{label:"Leaf node 3-2"}]}]);return t(()=>{e.value.treeFactory.mergeTreeNodes(),e.value.treeFactory.expandAllNodes()}),{data:l,treeRef:e}}});return{render:h,...r}}(),"render-demo-7":function(){const{resolveComponent:p,createVNode:s,createTextVNode:c,withCtx:i,openBlock:h,createElementBlock:d}=y,k=c("Add"),t=c("Delete");function r(o,g){const m=p("d-tree"),E=p("d-button");return h(),d("div",null,[s(m,{data:o.data,ref:"treeRef",operate:"",onSelectChange:o.selectChange},null,8,["data","onSelectChange"]),s(E,{variant:"solid",size:"sm",onClick:o.addNode},{default:i(()=>[k]),_:1},8,["onClick"]),s(E,{size:"sm",class:"ml-xs",onClick:o.deleteNode},{default:i(()=>[t]),_:1},8,["onClick"])])}const{defineComponent:e,ref:l}=y,v=e({setup(){const o=l(),g=l(),m=l([{label:"Parent node 1",id:"node-1",children:[{label:"Parent node 1-1",id:"node-1-1",children:[{label:"Leaf node 1-1-1",id:"node-1-1-1"}]},{label:"Leaf node 1-2",id:"node-1-2"}]},{label:"Leaf node 2",id:"node-2"}]);return{treeRef:o,data:m,addNode:()=>{!g.value||o.value.treeFactory.insertBefore(g.value,{label:"\u65B0\u8282\u70B9"})},deleteNode:()=>{!g.value||o.value.treeFactory.removeNode(g.value)},selectChange:F=>{g.value=F}}}});return{render:r,...v}}(),"render-demo-8":function(){const{resolveComponent:p,createVNode:s,withCtx:c,createElementVNode:i,openBlock:h,createElementBlock:d}=y,k={class:"ml8"},t={class:"ml8"};function r(o,g){const m=p("d-search"),E=p("d-icon"),C=p("d-tooltip"),L=p("d-row"),F=p("d-tree");return h(),d("div",null,[s(m,{class:"mb10",style:{width:"300px"},"is-keyup-search":"",placeholder:"search your node...",delay:1e3,onSearch:o.onSearch},null,8,["onSearch"]),s(m,{class:"mb10",style:{width:"300px"},"is-keyup-search":"",placeholder:"filter your node...",delay:1e3,onSearch:o.onSearch1},null,8,["onSearch"]),s(L,{class:"mb10",align:"middle"},{default:c(()=>[s(m,{style:{width:"300px"},"is-keyup-search":"",placeholder:"filter your node by custom key...",delay:1e3,onSearch:o.onSearch2},null,8,["onSearch"]),i("span",k,[s(C,{position:"top",content:"\u4F7F\u7528\u81EA\u5B9A\u4E49\u7684\u5C5E\u6027\u641C\u7D22\u5339\u914D\u6811\u8282\u70B9"},{default:c(()=>[s(E,{name:"help"})]),_:1})])]),_:1}),s(L,{class:"mb10",align:"middle"},{default:c(()=>[s(m,{style:{width:"300px"},"is-keyup-search":"",placeholder:"filter your node by Regex...",delay:1e3,onSearch:o.onSearch3},null,8,["onSearch"]),i("span",t,[s(C,{position:"top",content:"\u4F7F\u7528\u6B63\u5219\u8868\u8FBE\u5F0F\u9650\u5B9A\u641C\u7D22\u8303\u56F4"},{default:c(()=>[s(E,{name:"help"})]),_:1})])]),_:1}),s(F,{ref:"treeRef",data:o.data},null,8,["data"])])}const{defineComponent:e,ref:l}=y,v=e({setup(){const o=l(),g=l([{label:"parent node 1",customSearchValue:"a"},{label:"parent node 2",customSearchValue:"b",children:[{label:"child node 2-1",customSearchValue:"c",children:[{label:"child node 2-1-1",customSearchValue:"d"},{label:"child node 2-1-2",customSearchValue:"e"}]},{label:"child node 2-2",customSearchValue:"f",children:[{label:"child node 2-2-1",customSearchValue:"g"},{label:"child node 2-2-2",customSearchValue:"h"}]}]},{label:"parent node 3",customSearchValue:"i",children:[{label:"child node 3-1",customSearchValue:"j"},{label:"child node 3-2",customSearchValue:"k"}]},{label:"parent node 4",customSearchValue:"l",children:[{label:"child node 4-1",customSearchValue:"m"},{label:"child node 4-2",customSearchValue:"n"}]},{label:"parent node 5",customSearchValue:"o",children:[{label:"child node 5-1",customSearchValue:"p"},{label:"child node 5-2",customSearchValue:"q"}]}]);return{treeRef:o,data:g,onSearch:F=>{o.value.treeFactory.searchTree(F,{isFilter:!1})},onSearch1:F=>{o.value.treeFactory.searchTree(F,{isFilter:!0})},onSearch2:F=>{o.value.treeFactory.searchTree(F,{isFilter:!0,matchKey:"customSearchValue"})},onSearch3:F=>{const A=new RegExp("^"+F+"[sS]*");o.value.treeFactory.searchTree(F,{isFilter:!0,pattern:A})}}}});return{render:r,...v}}(),"render-demo-9":function(){const{resolveComponent:p,createVNode:s,openBlock:c,createElementBlock:i}=y;function h(e,l){const v=p("d-search"),o=p("d-tree");return c(),i("div",null,[s(v,{class:"mb10",style:{width:"300px"},"is-keyup-search":"",placeholder:"search your node...",delay:1e3,onSearch:e.onSearch},null,8,["onSearch"]),s(v,{class:"mb10",style:{width:"300px"},"is-keyup-search":"",placeholder:"filter your node...",delay:1e3,onSearch:e.onSearch1},null,8,["onSearch"]),s(o,{data:e.data,height:300,ref:"treeRef"},null,8,["data"])])}const{defineComponent:d,ref:k,onMounted:t}=y,r=d({setup(){const e=k(null),l=k([...Array.from({length:100}).map((g,m)=>({label:"Parent node "+m,children:m%2===0?Array.from({length:10}).map((E,C)=>({label:"Leaf node "+m+"-"+C})):void 0}))]);return t(()=>{e.value.treeFactory.expandAllNodes()}),{data:l,treeRef:e,onSearch:g=>{e.value.treeFactory.searchTree(g,{isFilter:!1})},onSearch1:g=>{e.value.treeFactory.searchTree(g,{isFilter:!0})}}}});return{render:h,...r}}()}},Fn='{"title":"Tree \u6811","description":"","frontmatter":{},"headers":[{"level":3,"title":"\u57FA\u672C\u7528\u6CD5","slug":"\u57FA\u672C\u7528\u6CD5"},{"level":3,"title":"\u8282\u70B9\u61D2\u52A0\u8F7D","slug":"\u8282\u70B9\u61D2\u52A0\u8F7D"},{"level":3,"title":"\u53EF\u52FE\u9009","slug":"\u53EF\u52FE\u9009"},{"level":3,"title":"\u9ED8\u8BA4\u72B6\u6001","slug":"\u9ED8\u8BA4\u72B6\u6001"},{"level":3,"title":"\u7981\u7528\u72B6\u6001","slug":"\u7981\u7528\u72B6\u6001"},{"level":3,"title":"\u81EA\u5B9A\u4E49\u56FE\u6807","slug":"\u81EA\u5B9A\u4E49\u56FE\u6807"},{"level":3,"title":"\u8282\u70B9\u5408\u5E76","slug":"\u8282\u70B9\u5408\u5E76"},{"level":3,"title":"\u64CD\u4F5C\u6309\u94AE","slug":"\u64CD\u4F5C\u6309\u94AE"},{"level":3,"title":"\u641C\u7D22\u8FC7\u6EE4","slug":"\u641C\u7D22\u8FC7\u6EE4"},{"level":3,"title":"\u865A\u62DF\u6EDA\u52A8","slug":"\u865A\u62DF\u6EDA\u52A8"},{"level":3,"title":"Tree \u53C2\u6570","slug":"tree-\u53C2\u6570"},{"level":3,"title":"Tree \u4E8B\u4EF6","slug":"tree-\u4E8B\u4EF6"},{"level":3,"title":"Tree \u63D2\u69FD","slug":"tree-\u63D2\u69FD"},{"level":3,"title":"TreeNode \u53C2\u6570","slug":"treenode-\u53C2\u6570"},{"level":3,"title":"Tree \u7C7B\u578B\u5B9A\u4E49","slug":"tree-\u7C7B\u578B\u5B9A\u4E49"},{"level":3,"title":"treeFactory","slug":"treefactory"}],"relativePath":"components/tree/index.md","lastUpdated":1658823255563}',M=q('<h1 id="tree-\u6811" tabindex="-1">Tree \u6811 <a class="header-anchor" href="#tree-\u6811" aria-hidden="true">#</a></h1><p>\u4E00\u79CD\u5448\u73B0\u5D4C\u5957\u7ED3\u6784\u7684\u7EC4\u4EF6\u3002</p><h4 id="\u4F55\u65F6\u4F7F\u7528" tabindex="-1">\u4F55\u65F6\u4F7F\u7528 <a class="header-anchor" href="#\u4F55\u65F6\u4F7F\u7528" aria-hidden="true">#</a></h4><p>\u6587\u4EF6\u5939\u3001\u7EC4\u7EC7\u67B6\u6784\u3001\u751F\u7269\u5206\u7C7B\u3001\u56FD\u5BB6\u5730\u533A\u7B49\u7B49\uFF0C\u4E16\u95F4\u4E07\u7269\u7684\u5927\u591A\u6570\u7ED3\u6784\u90FD\u662F\u6811\u5F62\u7ED3\u6784\u3002\u4F7F\u7528\u6811\u7EC4\u4EF6\u53EF\u4EE5\u5B8C\u6574\u5C55\u73B0\u5176\u4E2D\u7684\u5C42\u7EA7\u5173\u7CFB\uFF0C\u5E76\u5177\u6709\u5C55\u5F00/\u6536\u8D77\u3001\u9009\u62E9\u7B49\u4EA4\u4E92\u529F\u80FD\u3002</p><h3 id="\u57FA\u672C\u7528\u6CD5" tabindex="-1">\u57FA\u672C\u7528\u6CD5 <a class="header-anchor" href="#\u57FA\u672C\u7528\u6CD5" aria-hidden="true">#</a></h3>',5),Z=n("div",null,"\u5C55\u793A\u5D4C\u5957\u6811\u5F62\u7ED3\u6784\u7684\u5448\u73B0\u3001\u8FDE\u63A5\u7EBF\u3001\u5C55\u5F00/\u6536\u8D77\u3001\u70B9\u51FB\u9009\u62E9\u7B49\u529F\u80FD\u3002",-1),z=n("div",{class:"language-vue"},[n("pre",null,[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),a("template")]),n("span",{class:"token punctuation"},">")]),a(`
...
`),n("span",{class:"token punctuation"},"}"),n("span",{class:"token punctuation"},")"),n("span",{class:"token punctuation"},";"),a(`
`)])]),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"</"),a("script")]),n("span",{class:"token punctuation"},">")]),a(`
`)])])],-1),G=n("h3",{id:"\u9ED8\u8BA4\u72B6\u6001",tabindex:"-1"},[a("\u9ED8\u8BA4\u72B6\u6001 "),n("a",{class:"header-anchor",href:"#\u9ED8\u8BA4\u72B6\u6001","aria-hidden":"true"},"#")],-1),J=n("div",null,[a("\u901A\u8FC7"),n("code",null,"expanded"),a("/"),n("code",null,"selected"),a("/"),n("code",null,"checked"),a("\u5206\u522B\u8BBE\u7F6E\u9ED8\u8BA4\u5C55\u5F00/\u6536\u8D77\u3001\u70B9\u51FB\u9009\u62E9\u3001\u52FE\u9009\u72B6\u6001\u3002")],-1),Q=n("div",{class:"language-vue"},[n("pre",null,[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),a("template")]),n("span",{class:"token punctuation"},">")]),a(`
...
<span class="token punctuation">}</span>
</code></pre></div>`,20);function yn(p,s,c,i,h,d){const k=_("render-demo-0"),t=_("demo"),r=_("render-demo-1"),e=_("render-demo-2"),l=_("render-demo-3"),v=_("render-demo-4"),o=_("render-demo-5"),g=_("render-demo-6"),m=_("render-demo-7"),E=_("render-demo-8"),C=_("render-demo-9");return I(),P("div",null,[M,f(t,{sourceCode:`<template>
...
<\/script>
`},{description:u(()=>[Z]),highlight:u(()=>[z]),default:u(()=>[f(k)]),_:1}),j,f(t,{sourceCode:`<template>
...
<\/script>
`},{description:u(()=>[$]),highlight:u(()=>[K]),default:u(()=>[f(r)]),_:1}),O,f(t,{sourceCode:`<template>
...
<\/script>
`},{description:u(()=>[U]),highlight:u(()=>[H]),default:u(()=>[f(e)]),_:1}),G,f(t,{sourceCode:`<template>
...
<\/script>
`},{description:u(()=>[J]),highlight:u(()=>[Q]),default:u(()=>[f(l)]),_:1}),W,f(t,{sourceCode:`<template>
  <d-tree :data="data" check></d-tree>
</template>
...
<\/script>
`},{description:u(()=>[X]),highlight:u(()=>[Y]),default:u(()=>[f(v)]),_:1}),nn,f(t,{sourceCode:`<template>
  <d-tree :data="data">
...
<\/script>
`},{description:u(()=>[an]),highlight:u(()=>[sn]),default:u(()=>[f(o)]),_:1}),tn,f(t,{sourceCode:`<template>
...
<\/script>
`},{highlight:u(()=>[en]),default:u(()=>[f(g)]),_:1}),on,f(t,{sourceCode:`<template>
...
<\/script>
`},{description:u(()=>[pn]),highlight:u(()=>[cn]),default:u(()=>[f(m)]),_:1}),ln,f(t,{sourceCode:`<template>
...
`},{description:u(()=>[un]),highlight:u(()=>[rn]),default:u(()=>[f(E)]),_:1}),kn,f(t,{sourceCode:`<template>
  <d-search class="mb10" style="width: 300px" is-keyup-search placeholder="search your node..." :delay="1000" @search="onSearch"></d-search>
  <d-search
    class="mb10"
    style="width: 300px"
...
<\/script>
`},{description:u(()=>[dn]),highlight:u(()=>[hn]),default:u(()=>[f(C)]),_:1}),gn])}var En=T(R,[["render",yn]]);export{Fn as __pageData,En as default};
