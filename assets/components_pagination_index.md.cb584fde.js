...
</code></pre></div>`,9);function ua(s,o,k,g,m,z){const f=B("render-demo-0"),v=B("demo"),E=B("render-demo-1"),y=B("render-demo-2"),F=B("render-demo-3");return J(),X("div",null,[G,S(v,{sourceCode:`<template>
