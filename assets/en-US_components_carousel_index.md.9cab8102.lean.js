...
`),t("span",{class:"token punctuation"},"}"),n(`
`)])]),t("span",{class:"token tag"},[t("span",{class:"token tag"},[t("span",{class:"token punctuation"},"</"),n("style")]),t("span",{class:"token punctuation"},">")]),n(`
`)])])],-1),R=t("h3",{id:"custom-operations",tabindex:"-1"},[n("Custom-Operations "),t("a",{class:"header-anchor",href:"#custom-operations","aria-hidden":"true"},"#")],-1),W=t("div",{class:"language-vue"},[t("pre",null,[t("code",null,[t("span",{class:"token tag"},[t("span",{class:"token tag"},[t("span",{class:"token punctuation"},"<"),n("template")]),t("span",{class:"token punctuation"},">")]),n(`
...
`},{highlight:v(()=>[J]),default:v(()=>[x(p)]),_:1}),R,x(a,{sourceCode:`<template>
...
`},{highlight:v(()=>[W]),default:v(()=>[x(k)]),_:1}),z])}var Y=F(I,[["render",M]]);export{X as __pageData,Y as default};
