...
</code></pre></div>`,13);function lt(c,l,e,r,f,C){const h=x("render-demo-0"),u=x("demo"),k=x("render-demo-1"),g=x("render-demo-2"),v=x("render-demo-3"),E=x("render-demo-4"),d=x("render-demo-5"),i=x("render-demo-6"),s=x("render-demo-7"),o=x("render-demo-8");return S(),R("div",null,[N,y(u,{sourceCode:`<template>
