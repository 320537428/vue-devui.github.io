...
<span class="token punctuation">}</span>
</code></pre></div>`,11);function sn(s,e,a,u,o,h){const r=B("render-demo-0"),p=B("demo"),i=B("render-demo-1"),k=B("render-demo-2"),d=B("render-demo-3");return P(),Y("div",null,[M,y(p,{sourceCode:`<template>
