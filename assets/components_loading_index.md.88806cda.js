var M=Object.defineProperty;var P=Object.getOwnPropertySymbols;var $=Object.prototype.hasOwnProperty,z=Object.prototype.propertyIsEnumerable;var R=(a,e,s)=>e in a?M(a,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):a[e]=s,T=(a,e)=>{for(var s in e||(e={}))$.call(e,s)&&R(a,s,e[s]);if(P)for(var s of P(e))z.call(e,s)&&R(a,s,e[s]);return a};import{_ as j,V as E,r as S,c as O,b as F,w,a as I,d as n,e as t,o as Y}from"./app.7a28b7c1.js";const U={name:"component-doc",components:{"render-demo-0":function(){const{createTextVNode:a,resolveComponent:e,withCtx:s,createVNode:v,createElementVNode:o,renderList:l,Fragment:d,openBlock:c,createElementBlock:i,toDisplayString:f,resolveDirective:y,withDirectives:_}=E,C=a("click me!"),x={backdrop:!0,positionType:"relative",view:{top:"50%",left:"50%"},zIndex:100,style:{width:"100%","text-align":"left"}},A=o("thead",null,[o("tr",null,[o("th",null,"\u5E8F\u53F7"),o("th",null,"\u59D3\u540D"),o("th",null,"\u961F\u4F0D"),o("th",null,"\u64CD\u4F5C")])],-1),r=o("td",null,"\u5F20\u5BB6\u9F50",-1),g=o("td",null,"\u8DF3\u6C34",-1),m=o("td",null,"\u8DF3\u6C34\u961F",-1);function k(u,D){const L=e("d-button"),N=y("dLoading");return c(),i("div",null,[v(L,{onClick:u.fetchTableData,style:{"margin-top":"8px"}},{default:s(()=>[C]),_:1},8,["onClick"]),_((c(),i("table",x,[A,o("tbody",null,[(c(!0),i(d,null,l(u.datas,(q,V)=>(c(),i("tr",{key:V},[o("td",null,f(V),1),r,g,m]))),128))])])),[[N,u.loadingStatus]])])}const{defineComponent:h,ref:p,reactive:B}=E,b=h({setup(){const u=p(!1),D=B([]);return{datas:D,loadingStatus:u,fetchTableData:()=>{u.value=!0,setTimeout(()=>{D.push(1,2,3),u.value=!1},2e3)}}}});return T({render:k},b)}(),"render-demo-1":function(){const{createTextVNode:a,resolveComponent:e,withCtx:s,createVNode:v,resolveDirective:o,openBlock:l,createElementBlock:d,withDirectives:c}=E,i=a("click me!"),f={message:"One moment please...",style:{"margin-top":"20px",width:"100%",height:"80px",padding:"10px"}},_=[a(" loading will show here2 ")];function C(g,m){const k=e("d-button"),h=o("dLoading");return l(),d("div",null,[v(k,{onClick:g.fetchMutiplePromise,style:{"margin-top":"8px"}},{default:s(()=>[i]),_:1},8,["onClick"]),c((l(),d("div",f,_)),[[h,g.promises]])])}const{defineComponent:x,ref:A}=E,r=x({setup(){const g=A([]);return{promises:g,fetchMutiplePromise:()=>{let k=[];for(let h=0;h<3;h++)k.push(new Promise((p,B)=>{setTimeout(()=>{p(h)},(h+1)*1e3)}).then(p=>p));g.value=k}}}});return T({render:C},r)}(),"render-demo-2":function(){const{createTextVNode:a,resolveComponent:e,withCtx:s,createVNode:v,resolveDirective:o,openBlock:l,createBlock:d,withDirectives:c,createElementBlock:i}=E,f=a(" Loading Style 1 "),y=a(" Loading Style 2 "),_=a(" Loading Style 3 "),C=["loadingTemplateRef"],A=[a(" loading will show here1 ")];function r(p,B){const b=e("d-button"),u=o("dLoading");return l(),i("div",null,[v(b,{width:220,onClick:p.showLoading1,style:{"margin-right":"8px",display:"inline-block"}},{default:s(()=>[f]),_:1},8,["onClick"]),c((l(),d(b,{width:220,onClick:p.showLoading2,loadingTemplateRef:p.temp2,style:{"margin-right":"8px",display:"inline-block"}},{default:s(()=>[y]),_:1},8,["onClick","loadingTemplateRef"])),[[u,p.isShowLoading2]]),c((l(),d(b,{bsStyle:"text",width:220,loadingTemplateRef:p.temp3,style:{"margin-right":"8px",display:"inline-block"}},{default:s(()=>[_]),_:1},8,["loadingTemplateRef"])),[[u,!0]]),c((l(),i("div",{style:{height:"80px","line-height":"80px"},loadingTemplateRef:p.temp1},A,8,C)),[[u,p.isShowLoading1]])])}const{defineComponent:g,ref:m,h:k}=E,h=g({setup(){const p=k("div",{className:"devui-infinity-loading"},k("i",{className:"icon-refresh"})),B=k("div",{className:"devui-circle-loading-container-2"},k("i",{className:"icon-refresh"})),b=k("div",{className:"devui-circle-loading-container-3"},k("i",{className:"icon-refresh"})),u=m(!1),D=()=>{u.value=new Promise(q=>{setTimeout(()=>{q(!0)},1e3)})},L=m(!1);return{temp1:p,temp2:B,temp3:b,isShowLoading1:u,isShowLoading2:L,showLoading1:D,showLoading2:()=>{L.value=new Promise(q=>{setTimeout(()=>{q(!0)},1e3)})}}}});return T({render:r},h)}(),"render-demo-3":function(){const{createTextVNode:a,resolveComponent:e,withCtx:s,createVNode:v,openBlock:o,createBlock:l,createCommentVNode:d,createElementVNode:c,createElementBlock:i}=E,f=a(" click me show full screen loading! "),y=a(" click me show loading in target! "),_=a(" click me close loading in target! "),C=c("div",{id:"me",style:{"margin-top":"20px",width:"100%",height:"60px",padding:"10px"}}," loading will show here3 ",-1);function x(r,g){const m=e("d-button");return o(),i("div",null,[v(m,{width:220,onClick:r.serviceToBody,style:{"margin-right":"8px",display:"inline-block"}},{default:s(()=>[f]),_:1},8,["onClick"]),r.isShow?(o(),l(m,{key:0,width:200,onClick:r.openTargetLoading,style:{"margin-right":"8px",display:"inline-block"}},{default:s(()=>[y]),_:1},8,["onClick"])):(o(),l(m,{key:1,width:200,bsStyle:"common",onClick:r.closeTargetLoading,style:{"margin-right":"8px",display:"inline-block"}},{default:s(()=>[_]),_:1},8,["onClick"])),C])}return T({render:x},{data(){return{isShow:!0,resultTarget:null}},methods:{serviceToBody(){const r=this.$loadingService.open();setTimeout(()=>{r.loadingInstance.close()},2e3)},openTargetLoading(){this.resultTarget=this.$loadingService.open({target:document.querySelector("#me"),message:"One moment please...",positionType:"relative",zIndex:1}),this.isShow=!1},closeTargetLoading(){this.resultTarget.loadingInstance.close(),this.isShow=!0}}})}()}},pn='{"title":"Loading \u52A0\u8F7D\u63D0\u793A","description":"","frontmatter":{},"headers":[{"level":3,"title":"\u4F55\u65F6\u4F7F\u7528","slug":"\u4F55\u65F6\u4F7F\u7528"},{"level":3,"title":"\u57FA\u672C\u7528\u6CD5","slug":"\u57FA\u672C\u7528\u6CD5"},{"level":3,"title":"\u591A promise","slug":"\u591A-promise"},{"level":3,"title":"\u81EA\u5B9A\u4E49\u6837\u5F0F","slug":"\u81EA\u5B9A\u4E49\u6837\u5F0F"},{"level":3,"title":"\u670D\u52A1\u65B9\u5F0F\u8C03\u7528","slug":"\u670D\u52A1\u65B9\u5F0F\u8C03\u7528"},{"level":3,"title":"\u53C2\u6570","slug":"\u53C2\u6570"}],"relativePath":"components/loading/index.md","lastUpdated":1645614555480}',G=I('<h1 id="loading-\u52A0\u8F7D\u63D0\u793A" tabindex="-1">Loading \u52A0\u8F7D\u63D0\u793A <a class="header-anchor" href="#loading-\u52A0\u8F7D\u63D0\u793A" aria-hidden="true">#</a></h1><p>\u63D0\u793A\u7528\u6237\u9875\u9762\u6B63\u5728\u6267\u884C\u6307\u4EE4\uFF0C\u9700\u8981\u7B49\u5F85\u3002</p><h3 id="\u4F55\u65F6\u4F7F\u7528" tabindex="-1">\u4F55\u65F6\u4F7F\u7528 <a class="header-anchor" href="#\u4F55\u65F6\u4F7F\u7528" aria-hidden="true">#</a></h3><p>\u5F53\u6267\u884C\u6307\u4EE4\u65F6\u95F4\u8F83\u957F\uFF08\u9700\u8981\u6570\u79D2\u4EE5\u4E0A\uFF09\u65F6\uFF0C\u5411\u7528\u6237\u5C55\u793A\u6B63\u5728\u6267\u884C\u7684\u72B6\u6001\u3002</p><h3 id="\u57FA\u672C\u7528\u6CD5" tabindex="-1">\u57FA\u672C\u7528\u6CD5 <a class="header-anchor" href="#\u57FA\u672C\u7528\u6CD5" aria-hidden="true">#</a></h3><p>\u5C55\u793A\u52A0\u8F7D\u8868\u683C\u6570\u636E\u7684\u573A\u666F\u4E2D\u7684\u57FA\u672C\u4F7F\u7528\u65B9\u6CD5\u3002</p>',6),H=n("div",{class:"language-vue"},[n("pre",null,[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),t("template")]),n("span",{class:"token punctuation"},">")]),t(`
...
<\/script>
`},{highlight:w(()=>[sn]),default:w(()=>[F(y)]),_:1}),an])}var un=j(U,[["render",on]]);export{pn as __pageData,un as default};
