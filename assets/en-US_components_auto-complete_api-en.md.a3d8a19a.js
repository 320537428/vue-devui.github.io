...
</code></pre></div><p>item indicates a data item.</p>`,20);function M(l,u,d,m,g,y){const o=C("render-demo-0"),k=C("demo"),c=C("render-demo-1"),p=C("render-demo-2"),e=C("render-demo-3"),a=C("render-demo-4"),s=C("render-demo-5");return V(),E("div",null,[F,h(k,{sourceCode:`<template>
  <d-auto-complete
    :delay="1000"
    :source="source"
    v-model="value"
...
`},{highlight:v(()=>[G]),default:v(()=>[h(e)]),_:1}),A,O,h(k,{sourceCode:`<template>
  <d-auto-complete
    :source="source"
    v-model="value"
