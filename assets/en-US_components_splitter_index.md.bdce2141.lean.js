...
`)])]),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"</"),t("style")]),n("span",{class:"token punctuation"},">")]),t(`
`)])])],-1),W=n("h3",{id:"specifies-the-folding-direction",tabindex:"-1"},[t("Specifies the folding direction "),n("a",{class:"header-anchor",href:"#specifies-the-folding-direction","aria-hidden":"true"},"#")],-1),$=n("div",{class:"language-vue"},[n("pre",null,[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),t("template")]),n("span",{class:"token punctuation"},">")]),t(`
  `),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),t("section")]),n("span",{class:"token punctuation"},">")]),t(`
...
`},{highlight:z(()=>[$]),default:z(()=>[y(r)]),_:1}),I])}var K=S(q,[["render",J]]);export{H as __pageData,K as default};
