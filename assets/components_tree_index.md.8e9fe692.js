import{V as y}from"./framework.3495a366.js";import{_ as T,f as D,G as I,H as P,b as f,a1 as l,a3 as q,I as n,k as a}from"./plugin-vue_export-helper.ebedbb15.js";import"./framework.d333a127.js";const R={name:"component-doc",components:{"render-demo-0":function(){const{resolveComponent:t,createVNode:s,openBlock:o,createElementBlock:d}=y;function g(r,p){const u=t("d-tree");return o(),d("div",null,[s(u,{data:r.data},null,8,["data"])])}const{defineComponent:h,ref:k}=y,e=h({setup(){return{data:k([{label:"Parent node 1",children:[{label:"Parent node 1-1",children:[{label:"Leaf node 1-1-1"}]},{label:"Leaf node 1-2"}]},{label:"Leaf node 2"}])}}});return{render:g,...e}}(),"render-demo-1":function(){const{resolveComponent:t,createVNode:s,openBlock:o,createElementBlock:d}=y;function g(r,p){const u=t("d-tree");return o(),d("div",null,[s(u,{data:r.data,onLazyLoad:r.lazyLoad},null,8,["data","onLazyLoad"])])}const{defineComponent:h,ref:k}=y,e=h({setup(){return{data:k([{label:"Parent node 1",children:[{label:"Parent node 1-1 - dynamic loading",isLeaf:!1},{label:"Leaf node 1-2"}]},{label:"Leaf node 2 - dynamic loading",isLeaf:!1}]),lazyLoad:(u,m)=>{setTimeout(()=>{m({treeItems:[{label:"child node 1",expanded:!0,children:[{label:"child node 1-1"},{label:"child node 1-2"}]},{label:"child node 2",children:[{label:"child node 2-1"}]}],node:u})},500)}}}});return{render:g,...e}}(),"render-demo-2":function(){const{createElementVNode:t,resolveComponent:s,createVNode:o,renderList:d,Fragment:g,openBlock:h,createElementBlock:k,toDisplayString:e,createTextVNode:r,withCtx:p,createBlock:u,createCommentVNode:m}=y,c={class:"flex flex-row",style:{height:"28px"}},i={class:"flex items-center mr-xl"},F=t("span",{class:"inline-block mr-xs"},"\u5F00\u542F\u52FE\u9009",-1);function E(v,N){const S=s("d-switch"),L=s("d-radio"),A=s("d-radio-group"),V=s("d-tree");return h(),k("div",null,[t("div",c,[t("label",i,[F,o(S,{modelValue:v.openCheck,"onUpdate:modelValue":N[0]||(N[0]=w=>v.openCheck=w)},null,8,["modelValue"])]),v.openCheck?(h(),u(A,{key:0,modelValue:v.currentStrategy,"onUpdate:modelValue":N[1]||(N[1]=w=>v.currentStrategy=w),direction:"row"},{default:p(()=>[(h(!0),k(g,null,d(v.checkStrategy,w=>(h(),u(L,{key:w,value:w},{default:p(()=>[r(e(w),1)]),_:2},1032,["value"]))),128))]),_:1},8,["modelValue"])):m("v-if",!0)]),o(V,{data:v.data,check:v.currentStrategy,onToggleChange:v.toggleChange,onCheckChange:v.checkChange,onSelectChange:v.selectChange,onNodeClick:v.nodeClick},null,8,["data","check","onToggleChange","onCheckChange","onSelectChange","onNodeClick"])])}const{defineComponent:B,ref:C,watch:b}=y,_=B({setup(){const v=C(!0),N=C(["both","downward","upward","none"]),S=C("both"),L=C([{label:"Parent node 1",children:[{label:"Parent node 1-1",children:[{label:"Leaf node 1-1-1"},{label:"Leaf node 1-1-2"}]},{label:"Leaf node 1-2"}]},{label:"Leaf node 2"}]);return b(v,x=>{x===!1?S.value=!1:(S.value="both",L.value=[{label:"Parent node 1",children:[{label:"Parent node 1-1",children:[{label:"Leaf node 1-1-1"},{label:"Leaf node 1-1-2"}]},{label:"Leaf node 1-2"}]},{label:"Leaf node 2"}])}),{data:L,openCheck:v,checkStrategy:N,currentStrategy:S,toggleChange:x=>{console.log("toggleChange node:",x)},checkChange:x=>{console.log("checkChange node:",x)},selectChange:x=>{console.log("selectChange node:",x)},nodeClick:x=>{console.log("nodeClick node:",x)}}}});return{render:E,..._}}(),"render-demo-3":function(){const{resolveComponent:t,createVNode:s,openBlock:o,createElementBlock:d}=y;function g(r,p){const u=t("d-tree");return o(),d("div",null,[s(u,{data:r.data,check:""},null,8,["data"])])}const{defineComponent:h,ref:k}=y,e=h({setup(){return{data:k([{label:"Parent node 1",expanded:!0,children:[{label:"Parent node 1-1",children:[{label:"Leaf node 1-1-1"}]},{label:"Leaf node 1-2",checked:!0}]},{label:"Leaf node 2",selected:!0}])}}});return{render:g,...e}}(),"render-demo-4":function(){const{resolveComponent:t,createVNode:s,openBlock:o,createElementBlock:d}=y;function g(r,p){const u=t("d-tree");return o(),d("div",null,[s(u,{data:r.data,check:""},null,8,["data"])])}const{defineComponent:h,ref:k}=y,e=h({setup(){return{data:k([{label:"Parent node 1",expanded:!0,children:[{label:"Parent node 1-1",disableToggle:!0,disableSelect:!0,disableCheck:!0,children:[{label:"Leaf node 1-1-1"}]},{label:"Leaf node 1-2",disableCheck:!0}]},{label:"Leaf node 2",disableSelect:!0}])}}});return{render:g,...e}}(),"render-demo-5":function(){const{createElementVNode:t,openBlock:s,createElementBlock:o,toDisplayString:d,createTextVNode:g,createCommentVNode:h,normalizeStyle:k,resolveComponent:e,withCtx:r,createVNode:p}=y,u={style:{"margin-right":"8px"},viewBox:"0 0 16 16",width:"16",height:"16"},m=["d"],c={key:0,class:"devui-tree-node__indent"},i=["onClick"],E=[t("path",{d:"M204.58705 951.162088 204.58705 72.836889 819.41295 511.998977Z",fill:"#8a8e99"},null,-1)];function B(v,N){const S=e("d-tree");return s(),o("div",null,[p(S,{data:v.data},{content:r(({nodeData:L})=>[(s(),o("svg",u,[t("path",{d:`${L.isLeaf?"M13,6 L9,6 L9,5 L9,2 L3,2 L3,14 L13,14 L13,6 Z M12.5857864,5 L10,2.41421356 L10,5 L12.5857864,5 Z M2,1 L10,1 L14,5 L14,15 L2,15 L2,1 Z":L.expanded?"M16,6 L14,14 L2,14 L0,6 L16,6 Z M14.7192236,7 L1.28077641,7 L2.78077641,13 L13.2192236,13 L14.7192236,7 Z M6,1 L8,3 L15,3 L15,5 L14,5 L14,4 L7.58578644,4 L5.58578644,2 L2,2 L2,5 L1,5 L1,1 L6,1 Z":"M14,6 L14,5 L7.58578644,5 L5.58578644,3 L2,3 L2,6 L14,6 Z M14,7 L2,7 L2,13 L14,13 L14,7 Z M1,2 L6,2 L8,4 L15,4 L15,14 L1,14 L1,2 Z"}`,"stroke-width":"1",fill:"#8a8e99"},null,8,m)])),g(" "+d(L.label),1)]),icon:r(({nodeData:L,toggleNode:A})=>[L.isLeaf?(s(),o("span",c)):(s(),o("span",{key:1,onClick:V=>{V.stopPropagation(),A(L)}},[(s(),o("svg",{style:k({transform:L.expanded?"rotate(90deg)":"",marginLeft:"-2.5px",marginRight:"14.5px",cursor:"pointer"}),viewBox:"0 0 1024 1024",width:"12",height:"12"},E,4))],8,i))]),_:1},8,["data"])])}const{defineComponent:C,ref:b}=y,_=C({setup(){return{data:b([{label:"Parent node 1",children:[{label:"Parent node 1-1",children:[{label:"Leaf node 1-1-1"}]},{label:"Leaf node 1-2"}]},{label:"Leaf node 2"}])}}});return{render:B,..._}}(),"render-demo-6":function(){const{resolveComponent:t,createVNode:s,openBlock:o,createElementBlock:d}=y;function g(p,u){const m=t("d-tree");return o(),d("div",null,[s(m,{data:p.data,ref:"treeRef"},null,8,["data"])])}const{defineComponent:h,ref:k,onMounted:e}=y,r=h({setup(){const p=k(null),u=k([{label:"Parent node 1",children:[{label:"Parent node 1-1",children:[{label:"Parent node 1-1-1",children:[{label:"Parent node 1-1-1-1"}]}]}]},{label:"Parent node 2",children:[{label:"Parent node 2-1",children:[{label:"Leaf node 2-1-1"},{label:"Leaf node 2-1-2"}]}]},{label:"Parent node 3",children:[{label:"Leaf node 3-1",children:[{label:"Leaf node 3-1-1",children:[{label:"Leaf node 3-1-1-1"}]}]},{label:"Leaf node 3-2"}]}]);return e(()=>{p.value.treeFactory.mergeTreeNodes(),p.value.treeFactory.expandAllNodes()}),{data:u,treeRef:p}}});return{render:g,...r}}(),"render-demo-7":function(){const{resolveComponent:t,createVNode:s,createTextVNode:o,withCtx:d,openBlock:g,createElementBlock:h}=y,k=o("Add"),e=o("Delete");function r(c,i){const F=t("d-tree"),E=t("d-button");return g(),h("div",null,[s(F,{data:c.data,ref:"treeRef",operate:"",onSelectChange:c.selectChange},null,8,["data","onSelectChange"]),s(E,{variant:"solid",size:"sm",onClick:c.addNode},{default:d(()=>[k]),_:1},8,["onClick"]),s(E,{size:"sm",class:"ml-xs",onClick:c.deleteNode},{default:d(()=>[e]),_:1},8,["onClick"])])}const{defineComponent:p,ref:u}=y,m=p({setup(){const c=u(),i=u(),F=u([{label:"Parent node 1",id:"node-1",children:[{label:"Leaf node 1-1",id:"node-1-1",children:[{label:"Leaf node 1-1-1",id:"node-1-1-1"}]},{label:"Leaf node 1-2",id:"node-1-2"}]},{label:"Parent node 2",id:"node-2"}]);return{treeRef:c,data:F,addNode:()=>{if(!i.value)return;const b=c.value.treeFactory.getChildren(i.value);let _="new node";!b||b.length===0?_=i.value.label+"-1":b.length>0&&(_=i.value.label+`-${b.length+1}`),_.startsWith("Parent")&&(_=_.replace("Parent","Leaf")),c.value.treeFactory.insertBefore(i.value,{label:_})},deleteNode:()=>{!i.value||c.value.treeFactory.removeNode(i.value)},selectChange:b=>{i.value=b}}}});return{render:r,...m}}(),"render-demo-8":function(){const{resolveComponent:t,createVNode:s,withCtx:o,createElementVNode:d,openBlock:g,createElementBlock:h}=y,k={class:"ml8"},e={class:"ml8"};function r(c,i){const F=t("d-search"),E=t("d-icon"),B=t("d-tooltip"),C=t("d-row"),b=t("d-tree");return g(),h("div",null,[s(F,{class:"mb10",style:{width:"300px"},"is-keyup-search":"",placeholder:"search your node...",delay:1e3,onSearch:c.onSearch},null,8,["onSearch"]),s(F,{class:"mb10",style:{width:"300px"},"is-keyup-search":"",placeholder:"filter your node...",delay:1e3,onSearch:c.onSearch1},null,8,["onSearch"]),s(C,{class:"mb10",align:"middle"},{default:o(()=>[s(F,{style:{width:"300px"},"is-keyup-search":"",placeholder:"filter your node by custom key...",delay:1e3,onSearch:c.onSearch2},null,8,["onSearch"]),d("span",k,[s(B,{position:"top",content:"\u4F7F\u7528\u81EA\u5B9A\u4E49\u7684\u5C5E\u6027\u641C\u7D22\u5339\u914D\u6811\u8282\u70B9"},{default:o(()=>[s(E,{name:"help"})]),_:1})])]),_:1}),s(C,{class:"mb10",align:"middle"},{default:o(()=>[s(F,{style:{width:"300px"},"is-keyup-search":"",placeholder:"filter your node by Regex...",delay:1e3,onSearch:c.onSearch3},null,8,["onSearch"]),d("span",e,[s(B,{position:"top",content:"\u4F7F\u7528\u6B63\u5219\u8868\u8FBE\u5F0F\u9650\u5B9A\u641C\u7D22\u8303\u56F4"},{default:o(()=>[s(E,{name:"help"})]),_:1})])]),_:1}),s(b,{ref:"treeRef",data:c.data},null,8,["data"])])}const{defineComponent:p,ref:u}=y,m=p({setup(){const c=u(),i=u([{label:"parent node 1",customSearchValue:"a"},{label:"parent node 2",customSearchValue:"b",children:[{label:"child node 2-1",customSearchValue:"c",children:[{label:"child node 2-1-1",customSearchValue:"d"},{label:"child node 2-1-2",customSearchValue:"e"}]},{label:"child node 2-2",customSearchValue:"f",children:[{label:"child node 2-2-1",customSearchValue:"g"},{label:"child node 2-2-2",customSearchValue:"h"}]}]},{label:"parent node 3",customSearchValue:"i",children:[{label:"child node 3-1",customSearchValue:"j"},{label:"child node 3-2",customSearchValue:"k"}]},{label:"parent node 4",customSearchValue:"l",children:[{label:"child node 4-1",customSearchValue:"m"},{label:"child node 4-2",customSearchValue:"n"}]},{label:"parent node 5",customSearchValue:"o",children:[{label:"child node 5-1",customSearchValue:"p"},{label:"child node 5-2",customSearchValue:"q"}]}]);return{treeRef:c,data:i,onSearch:b=>{c.value.treeFactory.searchTree(b,{isFilter:!1})},onSearch1:b=>{c.value.treeFactory.searchTree(b,{isFilter:!0})},onSearch2:b=>{c.value.treeFactory.searchTree(b,{isFilter:!0,matchKey:"customSearchValue"})},onSearch3:b=>{const _=new RegExp("^"+b+"[sS]*");c.value.treeFactory.searchTree(b,{isFilter:!0,pattern:_})}}}});return{render:r,...m}}(),"render-demo-9":function(){const{resolveComponent:t,createVNode:s,openBlock:o,createElementBlock:d}=y;function g(p,u){const m=t("d-search"),c=t("d-tree");return o(),d("div",null,[s(m,{class:"mb10",style:{width:"300px"},"is-keyup-search":"",placeholder:"search your node...",delay:1e3,onSearch:p.onSearch},null,8,["onSearch"]),s(m,{class:"mb10",style:{width:"300px"},"is-keyup-search":"",placeholder:"filter your node...",delay:1e3,onSearch:p.onSearch1},null,8,["onSearch"]),s(c,{data:p.data,height:300,ref:"treeRef"},null,8,["data"])])}const{defineComponent:h,ref:k,onMounted:e}=y,r=h({setup(){const p=k(null),u=k([...Array.from({length:100}).map((i,F)=>({label:"Parent node "+F,children:F%2===0?Array.from({length:10}).map((E,B)=>({label:"Leaf node "+F+"-"+B})):void 0}))]);return e(()=>{p.value.treeFactory.expandAllNodes()}),{data:u,treeRef:p,onSearch:i=>{p.value.treeFactory.searchTree(i,{isFilter:!1})},onSearch1:i=>{p.value.treeFactory.searchTree(i,{isFilter:!0})}}}});return{render:g,...r}}(),"render-demo-10":function(){const{createElementVNode:t,resolveComponent:s,createVNode:o,openBlock:d,createElementBlock:g}=y,h=t("h6",null,[t("p",null,"Default")],-1),k=t("h6",null,[t("p",null,"Sortable")],-1);function e(m,c){const i=s("d-tree");return d(),g("div",null,[h,o(i,{data:m.data,draggable:""},null,8,["data"]),k,o(i,{data:m.data,draggable:{dropPrev:!0,dropNext:!0,dropInner:!0}},null,8,["data"])])}const{defineComponent:r,ref:p}=y,u=r({setup(){return{data:p([{label:"parent node 1"},{label:"parent node 2",expanded:!0,children:[{label:"leaf node 2-1",expanded:!0,children:[{label:"leaf node 2-1-1"},{label:"leaf node 2-1-2"}]},{label:"leaf node 2-2",children:[{label:"leaf node 2-2-1"},{label:"leaf node 2-2-2"}]}]},{label:"parent node 3",expanded:!0,children:[{label:"leaf node 3-1"},{label:"leaf node 3-2"}]},{label:"parent node 4",expanded:!0,children:[{label:"leaf node 4-1"},{label:"leaf node 4-2"}]},{label:"parent node 5",expanded:!0,children:[{label:"leaf node 5-1"},{label:"leaf node 5-2"}]}])}}});return{render:e,...u}}()}},Bn='{"title":"Tree \u6811","description":"","frontmatter":{},"headers":[{"level":3,"title":"\u57FA\u672C\u7528\u6CD5","slug":"\u57FA\u672C\u7528\u6CD5"},{"level":3,"title":"\u8282\u70B9\u61D2\u52A0\u8F7D","slug":"\u8282\u70B9\u61D2\u52A0\u8F7D"},{"level":3,"title":"\u53EF\u52FE\u9009","slug":"\u53EF\u52FE\u9009"},{"level":3,"title":"\u9ED8\u8BA4\u72B6\u6001","slug":"\u9ED8\u8BA4\u72B6\u6001"},{"level":3,"title":"\u7981\u7528\u72B6\u6001","slug":"\u7981\u7528\u72B6\u6001"},{"level":3,"title":"\u81EA\u5B9A\u4E49\u56FE\u6807","slug":"\u81EA\u5B9A\u4E49\u56FE\u6807"},{"level":3,"title":"\u8282\u70B9\u5408\u5E76","slug":"\u8282\u70B9\u5408\u5E76"},{"level":3,"title":"\u64CD\u4F5C\u6309\u94AE","slug":"\u64CD\u4F5C\u6309\u94AE"},{"level":3,"title":"\u641C\u7D22\u8FC7\u6EE4","slug":"\u641C\u7D22\u8FC7\u6EE4"},{"level":3,"title":"\u865A\u62DF\u6EDA\u52A8","slug":"\u865A\u62DF\u6EDA\u52A8"},{"level":3,"title":"\u53EF\u62D6\u62FD\u6811","slug":"\u53EF\u62D6\u62FD\u6811"},{"level":3,"title":"Tree \u53C2\u6570","slug":"tree-\u53C2\u6570"},{"level":3,"title":"Tree \u4E8B\u4EF6","slug":"tree-\u4E8B\u4EF6"},{"level":3,"title":"Tree \u63D2\u69FD","slug":"tree-\u63D2\u69FD"},{"level":3,"title":"TreeNode \u53C2\u6570","slug":"treenode-\u53C2\u6570"},{"level":3,"title":"Tree \u7C7B\u578B\u5B9A\u4E49","slug":"tree-\u7C7B\u578B\u5B9A\u4E49"},{"level":3,"title":"treeFactory","slug":"treefactory"}],"relativePath":"components/tree/index.md","lastUpdated":1659337634631}',M=q('<h1 id="tree-\u6811" tabindex="-1">Tree \u6811 <a class="header-anchor" href="#tree-\u6811" aria-hidden="true">#</a></h1><p>\u4E00\u79CD\u5448\u73B0\u5D4C\u5957\u7ED3\u6784\u7684\u7EC4\u4EF6\u3002</p><h4 id="\u4F55\u65F6\u4F7F\u7528" tabindex="-1">\u4F55\u65F6\u4F7F\u7528 <a class="header-anchor" href="#\u4F55\u65F6\u4F7F\u7528" aria-hidden="true">#</a></h4><p>\u6587\u4EF6\u5939\u3001\u7EC4\u7EC7\u67B6\u6784\u3001\u751F\u7269\u5206\u7C7B\u3001\u56FD\u5BB6\u5730\u533A\u7B49\u7B49\uFF0C\u4E16\u95F4\u4E07\u7269\u7684\u5927\u591A\u6570\u7ED3\u6784\u90FD\u662F\u6811\u5F62\u7ED3\u6784\u3002\u4F7F\u7528\u6811\u7EC4\u4EF6\u53EF\u4EE5\u5B8C\u6574\u5C55\u73B0\u5176\u4E2D\u7684\u5C42\u7EA7\u5173\u7CFB\uFF0C\u5E76\u5177\u6709\u5C55\u5F00/\u6536\u8D77\u3001\u9009\u62E9\u7B49\u4EA4\u4E92\u529F\u80FD\u3002</p><h3 id="\u57FA\u672C\u7528\u6CD5" tabindex="-1">\u57FA\u672C\u7528\u6CD5 <a class="header-anchor" href="#\u57FA\u672C\u7528\u6CD5" aria-hidden="true">#</a></h3>',5),Z=n("div",null,"\u5C55\u793A\u5D4C\u5957\u6811\u5F62\u7ED3\u6784\u7684\u5448\u73B0\u3001\u8FDE\u63A5\u7EBF\u3001\u5C55\u5F00/\u6536\u8D77\u3001\u70B9\u51FB\u9009\u62E9\u7B49\u529F\u80FD\u3002",-1),z=n("div",{class:"language-vue"},[n("pre",null,[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),a("template")]),n("span",{class:"token punctuation"},">")]),a(`
...
`)])])],-1),j=n("h3",{id:"\u8282\u70B9\u61D2\u52A0\u8F7D",tabindex:"-1"},[a("\u8282\u70B9\u61D2\u52A0\u8F7D "),n("a",{class:"header-anchor",href:"#\u8282\u70B9\u61D2\u52A0\u8F7D","aria-hidden":"true"},"#")],-1),$=n("div",null,[a("\u901A\u8FC7\u8BBE\u7F6E\u8BE5\u8282\u70B9 "),n("code",null,"isLeaf"),a(" \u53C2\u6570\u4E3A "),n("code",null,"false"),a(", \u7EC4\u4EF6\u56DE\u8C03 "),n("code",null,"lazyLoad"),a(" \u65B9\u6CD5\u5B9E\u73B0\u8282\u70B9\u61D2\u52A0\u8F7D\u3002")],-1),O=n("div",{class:"language-vue"},[n("pre",null,[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),a("template")]),n("span",{class:"token punctuation"},">")]),a(`
...
`),n("span",{class:"token punctuation"},"}"),n("span",{class:"token punctuation"},")"),n("span",{class:"token punctuation"},";"),a(`
`)])]),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"</"),a("script")]),n("span",{class:"token punctuation"},">")]),a(`
`)])])],-1),K=n("h3",{id:"\u53EF\u52FE\u9009",tabindex:"-1"},[a("\u53EF\u52FE\u9009 "),n("a",{class:"header-anchor",href:"#\u53EF\u52FE\u9009","aria-hidden":"true"},"#")],-1),U=n("div",null,[a("\u901A\u8FC7"),n("code",null,"check"),a("\u5F00\u542F\u52FE\u9009\u529F\u80FD\u3002")],-1),W=n("div",{class:"language-vue"},[n("pre",null,[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),a("template")]),n("span",{class:"token punctuation"},">")]),a(`
...
`),n("span",{class:"token punctuation"},"}"),n("span",{class:"token punctuation"},")"),n("span",{class:"token punctuation"},";"),a(`
`)])]),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"</"),a("script")]),n("span",{class:"token punctuation"},">")]),a(`
`)])])],-1),H=n("h3",{id:"\u9ED8\u8BA4\u72B6\u6001",tabindex:"-1"},[a("\u9ED8\u8BA4\u72B6\u6001 "),n("a",{class:"header-anchor",href:"#\u9ED8\u8BA4\u72B6\u6001","aria-hidden":"true"},"#")],-1),G=n("div",null,[a("\u901A\u8FC7"),n("code",null,"expanded"),a("/"),n("code",null,"selected"),a("/"),n("code",null,"checked"),a("\u5206\u522B\u8BBE\u7F6E\u9ED8\u8BA4\u5C55\u5F00/\u6536\u8D77\u3001\u70B9\u51FB\u9009\u62E9\u3001\u52FE\u9009\u72B6\u6001\u3002")],-1),J=n("div",{class:"language-vue"},[n("pre",null,[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),a("template")]),n("span",{class:"token punctuation"},">")]),a(`
...
`),n("span",{class:"token punctuation"},"}"),n("span",{class:"token punctuation"},")"),n("span",{class:"token punctuation"},";"),a(`
`)])]),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"</"),a("script")]),n("span",{class:"token punctuation"},">")]),a(`
`)])])],-1),Q=n("h3",{id:"\u7981\u7528\u72B6\u6001",tabindex:"-1"},[a("\u7981\u7528\u72B6\u6001 "),n("a",{class:"header-anchor",href:"#\u7981\u7528\u72B6\u6001","aria-hidden":"true"},"#")],-1),X=n("div",null,[a("\u901A\u8FC7"),n("code",null,"disableToggle"),a("/"),n("code",null,"disableSelect"),a("/"),n("code",null,"disableCheck"),a("\u5206\u522B\u7981\u7528\u5C55\u5F00/\u6536\u8D77\u3001\u70B9\u51FB\u9009\u62E9\u3001\u52FE\u9009\u72B6\u6001\u3002")],-1),Y=n("div",{class:"language-vue"},[n("pre",null,[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),a("template")]),n("span",{class:"token punctuation"},">")]),a(`
  `),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),a("d-tree")]),a(),n("span",{class:"token attr-name"},":data"),n("span",{class:"token attr-value"},[n("span",{class:"token punctuation attr-equals"},"="),n("span",{class:"token punctuation"},'"'),a("data"),n("span",{class:"token punctuation"},'"')]),a(),n("span",{class:"token attr-name"},"check"),n("span",{class:"token punctuation"},">")]),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"</"),a("d-tree")]),n("span",{class:"token punctuation"},">")]),a(`
`),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"</"),a("template")]),n("span",{class:"token punctuation"},">")]),a(`
...
`),n("span",{class:"token punctuation"},"}"),n("span",{class:"token punctuation"},")"),n("span",{class:"token punctuation"},";"),a(`
`)])]),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"</"),a("script")]),n("span",{class:"token punctuation"},">")]),a(`
`)])])],-1),nn=n("h3",{id:"\u81EA\u5B9A\u4E49\u56FE\u6807",tabindex:"-1"},[a("\u81EA\u5B9A\u4E49\u56FE\u6807 "),n("a",{class:"header-anchor",href:"#\u81EA\u5B9A\u4E49\u56FE\u6807","aria-hidden":"true"},"#")],-1),an=n("div",null,[a("\u901A\u8FC7"),n("code",null,"content"),a("\u63D2\u69FD\u53EF\u4EE5\u81EA\u5B9A\u4E49\u8282\u70B9\u5185\u5BB9\uFF0C\u6BD4\u5982\u5728\u8282\u70B9\u5185\u5BB9\u524D\u9762\u589E\u52A0\u4E00\u4E2A\u56FE\u6807\uFF1B\u901A\u8FC7"),n("code",null,"icon"),a("\u63D2\u69FD\u53EF\u4EE5\u81EA\u5B9A\u4E49\u5C55\u5F00/\u6536\u8D77\u7684\u56FE\u6807\u3002")],-1),sn=n("div",{class:"language-vue"},[n("pre",null,[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),a("template")]),n("span",{class:"token punctuation"},">")]),a(`
...
`),n("span",{class:"token punctuation"},"}"),n("span",{class:"token punctuation"},")"),n("span",{class:"token punctuation"},";"),a(`
`)])]),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"</"),a("script")]),n("span",{class:"token punctuation"},">")]),a(`
`)])])],-1),tn=n("h3",{id:"\u8282\u70B9\u5408\u5E76",tabindex:"-1"},[a("\u8282\u70B9\u5408\u5E76 "),n("a",{class:"header-anchor",href:"#\u8282\u70B9\u5408\u5E76","aria-hidden":"true"},"#")],-1),en=n("div",{class:"language-vue"},[n("pre",null,[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),a("template")]),n("span",{class:"token punctuation"},">")]),a(`
...
`),n("span",{class:"token punctuation"},"}"),n("span",{class:"token punctuation"},")"),n("span",{class:"token punctuation"},";"),a(`
`)])]),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"</"),a("script")]),n("span",{class:"token punctuation"},">")]),a(`
`)])])],-1),gn=n("h3",{id:"\u53EF\u62D6\u62FD\u6811",tabindex:"-1"},[a("\u53EF\u62D6\u62FD\u6811 "),n("a",{class:"header-anchor",href:"#\u53EF\u62D6\u62FD\u6811","aria-hidden":"true"},"#")],-1),yn=n("div",null,"\u901A\u8FC7OperableTree\u7684 draggable \u5C5E\u6027\u914D\u7F6E\u8282\u70B9\u7684\u62D6\u62FD\u529F\u80FD\uFF0C\u5E76\u652F\u6301\u5916\u90E8\u5143\u7D20\u62D6\u62FD\u5165\u6811\u3002",-1),fn=n("div",{class:"language-vue"},[n("pre",null,[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),a("template")]),n("span",{class:"token punctuation"},">")]),a(`
  ...
  `),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),a("d-tree")]),a(),n("span",{class:"token attr-name"},":data"),n("span",{class:"token attr-value"},[n("span",{class:"token punctuation attr-equals"},"="),n("span",{class:"token punctuation"},'"'),a("data"),n("span",{class:"token punctuation"},'"')]),a(),n("span",{class:"token attr-name"},"draggable"),a(),n("span",{class:"token punctuation"},">")]),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"</"),a("d-tree")]),n("span",{class:"token punctuation"},">")]),a(`
  ...
  `),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),a("d-tree")]),a(),n("span",{class:"token attr-name"},":data"),n("span",{class:"token attr-value"},[n("span",{class:"token punctuation attr-equals"},"="),n("span",{class:"token punctuation"},'"'),a("data"),n("span",{class:"token punctuation"},'"')]),a(),n("span",{class:"token attr-name"},":draggable"),n("span",{class:"token attr-value"},[n("span",{class:"token punctuation attr-equals"},"="),n("span",{class:"token punctuation"},'"'),a("{ dropPrev: true, dropNext: true, dropInner: true }"),n("span",{class:"token punctuation"},'"')]),n("span",{class:"token punctuation"},">")]),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"</"),a("d-tree")]),n("span",{class:"token punctuation"},">")]),a(`
`),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"</"),a("template")]),n("span",{class:"token punctuation"},">")]),a(`
...
</code></pre></div><h4 id="idragdrop" tabindex="-1">IDragdrop <a class="header-anchor" href="#idragdrop" aria-hidden="true">#</a></h4><div class="language-ts"><pre><code><span class="token keyword">type</span> <span class="token class-name">IDragdrop</span> <span class="token operator">=</span> <span class="token builtin">boolean</span> <span class="token operator">|</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre></div>`,22);function bn(t,s,o,d,g,h){const k=D("render-demo-0"),e=D("demo"),r=D("render-demo-1"),p=D("render-demo-2"),u=D("render-demo-3"),m=D("render-demo-4"),c=D("render-demo-5"),i=D("render-demo-6"),F=D("render-demo-7"),E=D("render-demo-8"),B=D("render-demo-9"),C=D("render-demo-10");return I(),P("div",null,[M,f(e,{sourceCode:`<template>
...
<\/script>
`},{description:l(()=>[Z]),highlight:l(()=>[z]),default:l(()=>[f(k)]),_:1}),j,f(e,{sourceCode:`<template>
...
<\/script>
`},{description:l(()=>[$]),highlight:l(()=>[O]),default:l(()=>[f(r)]),_:1}),K,f(e,{sourceCode:`<template>
...
<\/script>
`},{description:l(()=>[U]),highlight:l(()=>[W]),default:l(()=>[f(p)]),_:1}),H,f(e,{sourceCode:`<template>
...
<\/script>
`},{description:l(()=>[G]),highlight:l(()=>[J]),default:l(()=>[f(u)]),_:1}),Q,f(e,{sourceCode:`<template>
  <d-tree :data="data" check></d-tree>
</template>
...
<\/script>
`},{description:l(()=>[X]),highlight:l(()=>[Y]),default:l(()=>[f(m)]),_:1}),nn,f(e,{sourceCode:`<template>
  <d-tree :data="data">
...
<\/script>
`},{description:l(()=>[an]),highlight:l(()=>[sn]),default:l(()=>[f(c)]),_:1}),tn,f(e,{sourceCode:`<template>
...
<\/script>
`},{highlight:l(()=>[en]),default:l(()=>[f(i)]),_:1}),on,f(e,{sourceCode:`<template>
...
<\/script>
`},{description:l(()=>[pn]),highlight:l(()=>[cn]),default:l(()=>[f(F)]),_:1}),ln,f(e,{sourceCode:`<template>
...
`},{description:l(()=>[un]),highlight:l(()=>[rn]),default:l(()=>[f(E)]),_:1}),kn,f(e,{sourceCode:`<template>
  <d-search class="mb10" style="width: 300px" is-keyup-search placeholder="search your node..." :delay="1000" @search="onSearch"></d-search>
  <d-search
    class="mb10"
    style="width: 300px"
...
<\/script>
`},{description:l(()=>[dn]),highlight:l(()=>[hn]),default:l(()=>[f(B)]),_:1}),gn,f(e,{sourceCode:`<template>
  <h6><p>Default</p></h6>
...
<\/script>
`},{description:l(()=>[yn]),highlight:l(()=>[fn]),default:l(()=>[f(C)]),_:1}),mn])}var _n=T(R,[["render",bn]]);export{Bn as __pageData,_n as default};
