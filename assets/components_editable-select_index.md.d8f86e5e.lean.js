...
</code></pre></div>`,11);function W(l,a,e,k,d,f){const g=B("render-demo-0"),c=B("demo"),m=B("render-demo-1"),u=B("render-demo-2"),o=B("render-demo-3"),i=B("render-demo-4");return M(),I("div",null,[$,v(c,{sourceCode:`<template>
