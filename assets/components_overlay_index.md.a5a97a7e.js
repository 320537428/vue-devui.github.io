...
</code></pre></div>`,7);function T(o,i,u,l,r,k){const d=B("render-demo-0"),p=B("demo"),g=B("render-demo-1");return V(),w("div",null,[q,v(p,{sourceCode:`<template>
...
`},{description:f(()=>[H]),highlight:f(()=>[I]),default:f(()=>[v(g)]),_:1}),O])}var M=D(N,[["render",T]]);export{L as __pageData,M as default};
