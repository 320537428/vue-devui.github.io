...
</code></pre></div>`,4);function an(a,e,s,i,o,h){const r=x("render-demo-0"),p=x("demo"),u=x("render-demo-1"),k=x("render-demo-2"),d=x("render-demo-3");return H(),z("div",null,[M,y(p,{sourceCode:`<template>
