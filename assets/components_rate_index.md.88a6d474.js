...
</code></pre></div>`,7);function S(r,c,p,i,k,d){const l=F("render-demo-0"),u=F("demo"),e=F("render-demo-1"),s=F("render-demo-2"),a=F("render-demo-3"),o=F("render-demo-4");return B(),y("div",null,[_,f(u,{sourceCode:`<template>
...
<\/script>
`},{highlight:v(()=>[H]),default:v(()=>[f(o)]),_:1}),U])}var P=A(C,[["render",S]]);export{I as __pageData,P as default};
