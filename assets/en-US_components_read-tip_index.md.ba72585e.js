var J=Object.defineProperty;var N=Object.getOwnPropertySymbols;var P=Object.prototype.hasOwnProperty,F=Object.prototype.propertyIsEnumerable;var R=(a,e,s)=>e in a?J(a,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):a[e]=s,w=(a,e)=>{for(var s in e||(e={}))P.call(e,s)&&R(a,s,e[s]);if(N)for(var s of N(e))F.call(e,s)&&R(a,s,e[s]);return a};import{_ as Y,r as x,o as z,c as H,a as y,w as _,b as I,d as n,e as t,V as O}from"./app.d8dfdb43.js";const L={name:"component-doc",components:{"render-demo-0":function(){const{createElementVNode:a,resolveComponent:e,withCtx:s,createVNode:i,openBlock:o,createElementBlock:h}=O,r=a("h1",null,"Let's see how to use ReadTip",-1),p=a("p",{class:"readtip-content"},"Set selector to display readtip",-1),u=a("p",null,"The following is the target you want to show readtip",-1),k=a("span",{class:"readtip-target"},"@Jack",-1);function d(g,m){const c=e("d-read-tip");return o(),h("div",null,[i(c,{readTipOptions:g.readTipOptions},{default:s(()=>[r,p,u,k]),_:1},8,["readTipOptions"])])}return w({render:d},{setup(g,{expose:m}){m();const l={readTipOptions:{trigger:"hover",rules:{trigger:"hover",position:"top",selector:".readtip-target",title:"Name: Jack",content:"This is Jack's profile"}}};return Object.defineProperty(l,"__isScriptSetup",{enumerable:!1,value:!0}),l}})}(),"render-demo-1":function(){const{createElementVNode:a,resolveComponent:e,withCtx:s,createVNode:i,openBlock:o,createElementBlock:h}=O,r=a("h1",null,"Multiple Readtips",-1),p=a("h2",{class:"introduction"},"You can pass in multiple rules to display different readtips",-1),u=a("p",{class:"first-content"},"Click here to display first content",-1),k=a("p",{class:"second-content"},"Click here to display second content",-1),d=a("h3",{class:"third-content"},"Hover here to display third content",-1),b=a("h3",{class:"third-content"},"Hover here to display third content",-1);function g(c,l){const f=e("d-read-tip");return o(),h("div",null,[i(f,{readTipOptions:c.readTipOptions},{default:s(()=>[r,p,u,k,d,b]),_:1},8,["readTipOptions"])])}return w({render:g},{setup(c,{expose:l}){l();const T={readTipOptions:{trigger:"click",showAnimate:!1,mouseenterTime:100,mouseleaveTime:100,position:"top",overlayClassName:"read-tip-container",appendToBody:!1,rules:[{selector:".first-content",position:"top",title:"This Is the First Title",content:"Lorem ipsum dolor sit amet, consectetur ad.",overlayClassName:"red"},{selector:".second-content",position:"left",title:"This Is the Second Title",content:"Class aptent taciti sociosqu ad litora torquent per conubia nostra",overlayClassName:"red"},{trigger:"hover",selector:".third-content",position:"bottom",title:"This Is the Third Title",content:"Aenean libero urna, scelerisque tincidunt"},{trigger:"hover",selector:".four-content",position:"right",title:"This Is the Third Title",content:"Aenean libero urna, scelerisque tincidunt"}]}};return Object.defineProperty(T,"__isScriptSetup",{enumerable:!1,value:!0}),T}})}(),"render-demo-2":function(){const{createElementVNode:a,resolveComponent:e,createVNode:s,createTextVNode:i,withCtx:o,openBlock:h,createElementBlock:r}=O,p=a("h1",null,"You can also pass in template",-1),u=a("p",{class:"readtip-content"},"Write your own template",-1),k=a("p",null,"The following is the target you want to show readtip",-1),d=a("h3",{class:"readtip-target2"},"DEVUI Course",-1),b=a("h3",{class:"readtip-target2"},"Another DEVUI Course with same class name",-1),g=i(" DEVUI Course "),m=a("span",null,"DevUI",-1),c=i(" DEVUI is a free open-source and common solution for the front end of enterprise mid- and back-end products. Its design values are basedon... "),l={class:"card-block"},f=a("span",null,"12",-1),T={class:"card-block"},C=a("span",null,"8",-1),V={class:"card-block"},B=a("span",null,"8",-1);function U(D,q){const E=e("d-avatar"),v=e("d-icon"),S=e("d-card"),A=e("d-read-tip");return h(),r("div",null,[s(A,{readTipOptions:D.readTipOptions},{contentTemplate:o(()=>[s(S,{class:"d-card"},{cardAvatar:o(()=>[s(E,{name:"DevUI"})]),cardTitle:o(()=>[g]),cardSubtitle:o(()=>[s(v,{name:"company-member"}),m]),cardContent:o(()=>[c]),cardActions:o(()=>[a("div",l,[s(v,{name:"like"}),f]),a("div",T,[s(v,{name:"star-o"}),C]),a("div",V,[s(v,{name:"message"}),B])]),_:1})]),default:o(()=>[p,u,k,d,b]),_:1},8,["readTipOptions"])])}return w({render:U},{setup(D,{expose:q}){q();const v={readTipOptions:{trigger:"click",rules:{trigger:"click",position:"top",selector:".readtip-target2",title:"Name: Jack",content:"This is Jack's profile"}}};return Object.defineProperty(v,"__isScriptSetup",{enumerable:!1,value:!0}),v}})}(),"render-demo-3":function(){const{createElementVNode:a,resolveComponent:e,withCtx:s,createVNode:i,openBlock:o,createElementBlock:h}=O,r=a("h1",null,"You can pass data asynchronously",-1),p=a("p",{class:"readtip-content"},"Using function fullElement to pass data",-1),u=a("p",null,"The following is the target you want to show readtip",-1),k=a("h4",{class:"readtip-target"},"Display readtip",-1);function d(g,m){const c=e("d-read-tip");return o(),h("div",null,[i(c,{readTipOptions:g.readTipOptions},{default:s(()=>[r,p,u,k]),_:1},8,["readTipOptions"])])}return w({render:d},{setup(g,{expose:m}){m();const c={trigger:"click",rules:{selector:"h4",trigger:"click",dataFn:l,key:"GetData"}};function l({element:T,rule:C}){return{content:T.innerHTML,title:C.key}}const f={readTipOptions:c,getDataFromDB:l};return Object.defineProperty(f,"__isScriptSetup",{enumerable:!1,value:!0}),f}})}()}},pn='{"title":"ReadTip reading tips","description":"","frontmatter":{},"headers":[{"level":3,"title":"When To Use","slug":"when-to-use"},{"level":3,"title":"Basic Usage","slug":"basic-usage"},{"level":3,"title":"Include Multiple Readtip","slug":"include-multiple-readtip"},{"level":3,"title":"Display Content with Template","slug":"display-content-with-template"},{"level":3,"title":"Get Data Asynchronous","slug":"get-data-asynchronous"},{"level":3,"title":"d-read-tip","slug":"d-read-tip"}],"relativePath":"en-US/components/read-tip/index.md","lastUpdated":1671032868323}',M=I('<h1 id="readtip-reading-tips" tabindex="-1">ReadTip reading tips <a class="header-anchor" href="#readtip-reading-tips" aria-hidden="true">#</a></h1><p>Reading notification component.</p><h3 id="when-to-use" tabindex="-1">When To Use <a class="header-anchor" href="#when-to-use" aria-hidden="true">#</a></h3><p>When you need to prompt for specific content in the html document.</p><h3 id="basic-usage" tabindex="-1">Basic Usage <a class="header-anchor" href="#basic-usage" aria-hidden="true">#</a></h3><p>Set selector to select the element to be displayed in the readtip, and transfer title and content to set the content to be displayed.</p>',6),j=n("div",{class:"language-vue"},[n("pre",null,[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),t("template")]),n("span",{class:"token punctuation"},">")]),t(`
...
</code></pre></div>`,4);function an(a,e,s,i,o,h){const r=x("render-demo-0"),p=x("demo"),u=x("render-demo-1"),k=x("render-demo-2"),d=x("render-demo-3");return z(),H("div",null,[M,y(p,{sourceCode:`<template>
...
`},{highlight:_(()=>[j]),default:_(()=>[y(r)]),_:1}),W,G,y(p,{sourceCode:`<template>
  <d-read-tip :readTipOptions="readTipOptions" >
...
`},{highlight:_(()=>[$]),default:_(()=>[y(u)]),_:1}),K,Q,y(p,{sourceCode:`<template>
  <d-read-tip :readTipOptions="readTipOptions" >
...
`},{highlight:_(()=>[X]),default:_(()=>[y(k)]),_:1}),Z,y(p,{sourceCode:`<template>
  <d-read-tip :readTipOptions="readTipOptions" >
...
`},{highlight:_(()=>[nn]),default:_(()=>[y(d)]),_:1}),tn])}var cn=Y(L,[["render",an]]);export{pn as __pageData,cn as default};
