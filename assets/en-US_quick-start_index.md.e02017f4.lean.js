import{_ as n}from"./plugin-vue_export-helper.21dcd24c.js";import{G as s,H as a,a4 as e}from"./framework.db4da0f6.js";const g='{"title":"Quick Start","description":"","frontmatter":{},"headers":[{"level":3,"title":"Vue version","slug":"vue-version"},{"level":3,"title":"1. Create a project","slug":"_1-create-a-project"},{"level":3,"title":"2. Install","slug":"_2-install"},{"level":3,"title":"3. Import modules and styles","slug":"_3-import-modules-and-styles"},{"level":3,"title":"4. Start development and debugging","slug":"_4-start-development-and-debugging"}],"relativePath":"en-US/quick-start/index.md","lastUpdated":1716730064662}',t={},o=e(`__VP_STATIC_START__<h1 id="quick-start" tabindex="-1">Quick Start <a class="header-anchor" href="#quick-start" aria-hidden="true">#</a></h1><p>Guide you how to use DevUI in your project.</p><h3 id="vue-version" tabindex="-1">Vue version <a class="header-anchor" href="#vue-version" aria-hidden="true">#</a></h3><p>Vue version currently supported ^3.0.0.</p><h3 id="_1-create-a-project" tabindex="-1">1. Create a project <a class="header-anchor" href="#_1-create-a-project" aria-hidden="true">#</a></h3><p>It is recommended to use @vite/cli to create your project.</p><div class="language-shell"><pre><code><span class="token function">yarn</span> create vite my-vue-app <span class="token parameter variable">--template</span> vue-ts
...
</code></pre></div>__VP_STATIC_END__`,16),p=[o];function c(l,i,r,u,d,m){return s(),a("div",null,p)}var h=n(t,[["render",c]]);export{g as __pageData,h as default};
