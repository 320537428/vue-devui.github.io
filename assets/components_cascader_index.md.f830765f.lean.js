...
</code></pre></div>`,10);function z(o,k,p,d,y,b){const r=C("render-demo-0"),c=C("demo"),i=C("render-demo-1");return D(),A("div",null,[w,h(c,{sourceCode:`<template>
  <h4>hover mode</h4>
...
<\/script>
`},{highlight:m(()=>[N]),default:m(()=>[h(i)]),_:1}),P])}var U=x(_,[["render",z]]);export{$ as __pageData,U as default};
